<?php
  ...
  $backPage = "biaya_askep_detail_view.php?biaya_id=".$_POST["biaya_id"]."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"];
          ...
          <div class="">
            ...
            <div class="form-group">
             ...
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tgl Awal Tarif Tindakan  <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <input type="text" name="biaya_tarif_tgl_awal" data-inputmask="'mask': '99-99-9999'" value="<?php echo format_date($_POST["biaya_tarif_tgl_awal"]); ?>" class="form-control">
						</div>
					  </div>
            <div class="form-group">
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tgl Akhir Tarif Tindakan  <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <input type="text" name="biaya_tarif_tgl_akhir" data-inputmask="'mask': '99-99-9999'" value="<?php echo format_date($_POST["biaya_tarif_tgl_akhir"]); ?>" class="form-control">
						</div>
					  </div>
            <div class="form-group">
             ...
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Jasa Pelayanan  <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <?php echo $view->RenderTextBox("biaya_split_jaspel","biaya_split_jaspel","85","100",currency_format($_POST["biaya_split_jaspel"]),"inputField", "readonly",false);?>
            ...
            <div class="form-group">
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Jasa Sarana  <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <?php echo $view->RenderTextBox("biaya_split_sarana","biaya_split_sarana","85","100",currency_format($_POST["biaya_split_sarana"]),"inputField", "readonly",false);?>
					        <font color="red">Otomatis berubah jika biaya total berubah setelah klik simpan</font
          	</div>
					  </div>
            <!--
