<?php
     ...
     $addPage  = "biaya_askep_edit.php";
     $editPage = "biaya_askep_edit.php";
     $detailPage = "biaya_askep_detail_view.php";
     $thisPage = "biaya_askep_view.php";     
     
      $sql_where[] = "1=1";
      
      $sql= "select * from klinik.klinik_biaya where biaya_jenis_sem = 'AS'";      
         ...
         $counter++;
          ...
          $counter++; 
              ...
              /* $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'?id='.$enc->Encode($dataTable[$i]["biaya_id"]).'&id_kelas='.$dataTable[$i]["id_kelas"].'&id_kamar='.$dataTable[$i]["id_kamar"].'"><img hspace="2" width="32" height="32" src="'.$ROOT.'gambar/icon/edit.png" alt="Edit" title="Edit" border="0"></a>';               
               ...
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'?del=1&id='.$enc->Encode($dataTable[$i]["biaya_askep_id"]).'&id_kelas='.$dataTable[$i]["id_kelas"].'&id_kamar='.$dataTable[$i]["id_kamar"].'"><img hspace="2" width="32" height="32" src="'.$ROOT.'gambar/icon/hapus.png" alt="Hapus" title="Hapus" border="0" onclick="javascript: return hapus();"></a>';               
               $tbContent[$i][$counter][TABLE_ALIGN] = "center";
               $counter++;*/
          /* 
          if($isAllowedUpdate) {
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
						<? if  (!$dataTable) { ?><input type="button" name="Tambah" value="Tambah"  class="col-md-3 col-sm-3 col-xs-3 btn btn-primary" onClick="document.location.href='<?php echo $addPage;?>'"> <? } ?>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
