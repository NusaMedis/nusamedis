...
if(e && e.which){
 ...
 <title>KIRIM BERKAS POLI KE RM</title>
      <body>
      <div id="header">
      <table border="0" width="100%" valign="top">
      <tr>
      <td width="50%" align="left" valign="top">
      <!-- <a href="http://sikita.net" target="_blank"><img src="<?php echo $fotoName ;?>" height="75"></a> -->
      <img src="<?php echo $fotoName ;?>" height="75">
      </td>
      <td width="50%" valign="top" align="right">
      <a href="#" target="_blank"><font size="6">KIRIM BERKAS KE RM</font></a>&nbsp;&nbsp;
      </td>
      </tr>
      </table>
      </div>
        ...
        <tr>                                         
         <table width="100%" border="1" cellpadding="1" cellspacing="1">                                        
              <tr class="subheader">
                      ...
                      <td align="left" width="5%" > Kirim Berkas</td>
                </tr>
