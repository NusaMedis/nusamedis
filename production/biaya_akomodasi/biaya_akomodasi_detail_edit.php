<?php
  ...
  $backPage = "biaya_akomodasi_detail_view.php?biaya_id=".$_POST["biaya_id"]."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"];
...
//       var_dump($dataDbLog);
 ...
 // Data Kategori Tindakan Header Instalasi//
     ...
     $tableHeader = "Manajemen - Edit Biaya Akomodasi";
