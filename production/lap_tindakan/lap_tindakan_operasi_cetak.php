...
for ($i = 0, $counter = 0, $n = count($dataTable); $i < $n; $i++, $counter = 0) {
 ...
 $sql = "select usr_name, fol_pelaksana_tipe from klinik.klinik_folio_pelaksana b 
  ...
  $tbContent[$i][$counter][TABLE_ISI] = $pelaksana[$indPerawat]["usr_name"];
  $tbContent[$i][$counter][TABLE_ALIGN] = "left";
  $counter++;

  $tbContent[$i][$counter][TABLE_ISI] = $pelaksana[$indDokter]["usr_name"];
  $tbContent[$i][$counter][TABLE_ALIGN] = "left";
  $counter++;

  $tbContent[$i][$counter][TABLE_ISI] = $pelaksana[$indInstruk]["usr_name"];
  $tbContent[$i][$counter][TABLE_ALIGN] = "left";
  $counter++;
