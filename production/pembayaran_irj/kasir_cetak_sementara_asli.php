...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse"> 
  <tr>
    ...
    <td align="left" width="10%">Klinik yang dituju</td>  
    <td align="center" width="1%">:</td>  
...
<!--         <td align="left">&nbsp;</td>     -->
         ...
         <td align="right"><?php echo currency_format($dataFolio[$i]["fol_nominal"]);?></td>
          ...
          <? } else {?>
          <td width="10%" align='right'><?php if (($_POST["reg_jenis_pasien"]=='5' || $dataPasien["reg_jenis_pasien"]=="26") && $dataFolio[$i]["id_poli"]<>$op["poli_id"]) { echo "0"; } else echo currency_format($dataFolio[$i]["fol_dijamin"])?></td>
 ...
 <!--   <td align="center">&nbsp;</td>    -->
    ...
    <? } else {?>
    <td align="right"><?php if (($_POST["reg_jenis_pasien"]=='5' || $dataPasien["reg_jenis_pasien"]=="26") && $dataFolio[$i]["id_poli"]<>$op["poli_id"]) { echo "0"; } else echo currency_format($totalDijamin);?></td>
  ...
  <tr>
    ...
    <?php } ?>
    <td align="center">&nbsp;</td>
    <td align="left" colspan='2'><?php if(($dataPasien["reg_jenis_pasien"]=="5" || $dataPasien["reg_jenis_pasien"]=="26") && ($_POST["reg_tipe_jkn"]=="1" || $_POST["reg_tipe_layanan"]=="1")) { echo "TOTAL SUBSIDI : ".currency_format($totalHarga); } else echo "TOTAL HRS BAYAR : ".currency_format($totalHrsBayar);?></td>
