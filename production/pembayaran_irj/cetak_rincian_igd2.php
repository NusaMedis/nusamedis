...
//echo $sql;
    $sql = "select a.*
        from klinik.klinik_folio a
        where a.id_dep=".QuoteValue(DPE_CHAR,$depId)." 
        and a.fol_nama <> '' and a.id_biaya = '9999999' and id_pembayaran =".QuoteValue(DPE_CHAR,$_POST["id_pembayaran"]);
...
//echo $sql;
    ...
    left join apotik.apotik_penjualan_detail b on b.id_penjualan = a.penjualan_id where penjualan_grandtotal != 0 and a.id_pembayaran = ".QuoteValue(DPE_CHAR,$_GET["pembayaran_id"]);
