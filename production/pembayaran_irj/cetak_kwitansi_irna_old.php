...
<!--   <tr>
  ...
  <?php } ?> -->
    ...
    <?php
      ...
      $pembayaranNominal = $_GET["dibayar"];
    ?>
  <tr>
    <td width="5%"></td>
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="15%"></td>
    <td align="left" width="85%" ><hr width="25%" align="left"><b><i>Jumlah Rp. </i></b><?php echo currency_format($_GET["dibayar"]);?><hr width="25%" align="left"></td>
  </tr>
  <tr>
    <td width="15%"></td>
