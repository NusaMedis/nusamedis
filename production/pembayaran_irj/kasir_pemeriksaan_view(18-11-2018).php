...
//     }
     ...
     if(!empty($_POST["id_poli"]))  $sql_where[] = "c.id_poli =".QuoteValue(DPE_CHAR,$_POST["id_poli"]);
         ...
         $poliOP = $dtaccess->Fetch($rs);
            ...
            {  //Jika Rawat Inap
               $sql = "select a.pembayaran_id,a.pembayaran_total,a.pembayaran_flag, 
                   ...
                   where c.id_poli = c.id_poli_asal and c.reg_jenis_pasien=".TIPE_PASIEN_UMUM."
    ...
    if($_POST["btnExcel"])
    {
          ...
          if($dataTable[$i]["reg_tipe_rawat"]=='I' || $dataTable[$i]["reg_tipe_rawat"]=='G') {
            ...
            $cetakRinciPage = "cetak_rincian_irj.php?id_reg=".$dataTable[$i]["reg_id"]."&pembayaran_id=".$dataTable[$i]["pembayaran_id"];
          }
          ...
          <div class="">
				  ...
				  <form name="frmEdit" action="<?php echo $_SERVER["PHP_SELF"]?>" method="POST" class="">
				    ...
				    <div class="col-md-4 col-sm-6 col-xs-12">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12">Tipe Rawat *</label>
        					...
        					<option value="--" <?php if('--'==$_POST["reg_tipe_rawat"]) echo "selected"; ?> disabled="disabled" ><?php echo "Pilih Tipe Rawat";?> </option>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              ...
              <select name="id_poli" class="select2_single form-control" id="id_poli"> 
                <?php foreach ($dataPoli  as $rs) { ?>
                  <option value="">Semua Poli</option>
                  <option value="<?php echo $rs['poli_id']; ?>" <?php if($rs['poli_id']==$_POST["id_poli"]) echo "selected"; ?> ><?php echo $rs['poli_nama'];?></option>
                <?php } ?>
              </select>
            </div>
