...
//echo $sql;
    $sql = "select a.penjualan_nomor,b.* from apotik.apotik_penjualan a left join apotik.apotik_penjualan_detail b on b.id_penjualan = a.penjualan_id where a.id_reg = ".QuoteValue(DPE_CHAR,$dataRegFarmasi["id_reg"]);
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse">
    ...
    <tr>
        ...
        <?php
            ...
            $hargaSatuan += $dataFarmasi[$i]["penjualan_detail_harga_jual"]+$dataFarmasi[$i]["penjualan_detail_tuslag"]+$ppn;
            $subTotalFarmasi += $dataFarmasi[$i]["penjualan_detail_total"];
        ?>
        <td align="right">
            <?php echo currency_format($hargaSatuan); ?>
        </td>
        <td align="right">
