         ...
         $poliOP = $dtaccess->Fetch($rs);
          ...
          //  {  //Jika Rawat Inap
               $sql = "select a.pembayaran_id,a.pembayaran_total,a.pembayaran_flag,a.pembayaran_yg_dibayar, 
                   ...
                   d.poli_nama, f.jenis_nama,h.fol_nominal
                   from 
              ...
              $sql .= " and b.cust_usr_kode <> '100'  and c.id_poli<>".QuoteValue(DPE_CHAR,$_POST["poli_tipe"]);
    ...
    <div class="container body">
      ...
      <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              <label class="control-label col-md-12 col-sm-12 col-xs-12">Lunas</label>
                <select name="fol_lunas" class="select2_single form-control" id="fol_lunas" onKeyDown="return tabOnEnter(this, event);">   
                <option value=""></option> 
                <option value="y" <?php if ($_POST["fol_lunas"]=='y') echo "selected"; ?>>Lunas</option> 
                <option value="n" <?php if ($_POST["fol_lunas"]=='n') echo "selected"; ?>>Belum Lunas</option> 
                </select>
            </div> 
            <div class="col-md-4 col-sm-6 col-xs-12">
