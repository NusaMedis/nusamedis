...
<!--   <tr>
  ...
  <tr>
    ...
    <?php } else { ?>
    <td  align="left" width="20%" bgcolor="#CCCCCC">&nbsp;<?php echo terbilang($_GET["total"] - $_GET["dis"]);?> Rupiah</td>  
    <?php } ?>
  </tr>
  <tr>
    <td width="5%"></td>
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="15%"></td>
    <td align="left" width="85%" ><hr width="25%" align="left"><b><i>Jumlah Rp. </i></b><?php echo currency_format($_GET["total"] - $_GET["dis"]);?><hr width="25%" align="left"></td>
  </tr>
  <?php } ?>
  <tr>
    <td width="5%"></td>
