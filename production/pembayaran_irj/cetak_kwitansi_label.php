<?php
    ...
    || $_GET["pembul"] || $_GET["total"]) {
        $sql = "select b.cust_usr_nama,b.cust_usr_kode,b.cust_usr_no_hp,b.cust_usr_jenis_kelamin, a.reg_status,
            ...
            a.reg_when_update, c.usr_name,e.jenis_nama,a.reg_kode_trans, a.reg_tipe_paket, f.perusahaan_plafon, f.perusahaan_diskon , a.reg_keterangan           
...
<!--   <tr> 
  ...
  <tr>
    ...
    <?php } elseif ($dataPasien['reg_keterangan'] != '') { ?>
    <td align="left" width="20%">&nbsp;<?php echo $dataPasien["reg_keterangan"];?></td>  
    <?php } else {?>
    ...
    <?php
      ...
      if ($_GET['pembul'] > 0) {
        $pembulatan = $_GET['pembul'];
      }else{
        $pembulatan = '0';
      }
      $bayar = ($_GET["dibayar"] + $_GET["dibayar2"] + $_GET["dibayar3"] + $_GET["dis"] + $_GET["deposit_awal"] + $pembulatan);
      $diskonNominal = $_GET["dis"];
      $kurangBayar = $_GET["total"] > $bayar;
      $kurangBayarNominal = $_GET["total"] - ($_GET["dibayar"] + $_GET['dibayar2'] + $_GET['dibayar3']) - $_GET["dis"];
      ...
      $pembayaranNominal = $_GET["dibayar"]+$_GET['dibayar2']+$_GET['dibayar3']+$pembulatan;
    ?>
  <tr>
    <td width="5%"></td>
    ...
    <td width = "1%">:</td> 
    <td  align="center" width="1%"></td>  
    <?php if ($kurangBayar>1) {  ?>
    <td  align="left" width="20%" bgcolor="#CCCCCC">&nbsp;<?php echo terbilang($_GET["dibayar"]+$_GET['dibayar2']+$_GET['dibayar3']+$pembulatan);?> Rupiah</td>  
...
<table width="100%" border="0">
  <tr>
    <td width="5%"></td>
    <td  align="center" width="95%" style="padding-left:400px">Jombang <?php //echo $konfigurasi["dep_kota"];?> <?php echo date("d M Y");?></td>
  </tr>
  <?php
  ...
  <tr>
    <td width="15%"></td>
    <td align="left" width="85%" ><hr width="25%" align="left"><b><i>Jumlah Rp. </i></b><?php echo currency_format($pembayaranNominal);?><hr width="25%" align="left"></td>
  </tr>
  <tr>
    <td width="15%"></td>
  ...
  <tr>
    <td width="15%"></td>
    <td align="left" width="85%" ><hr width="25%" align="left"><b><i>Jumlah Rp. 0 <hr width="25%" align="left"></td>
  </tr>
  <?php } else {?>
  <tr>
    <td width="15%"></td>
  ...
  <tr>
    <td width="15%"></td>
    <td align="left" width="85%" >Diskon : Rp. <?php echo currency_format($diskonNominal); ?></td>
  </tr>
  <? } ?>
  <? if ($depositNominal>0) { ?>
  <tr>
