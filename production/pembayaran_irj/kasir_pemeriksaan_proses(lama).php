...
/*
    ...
    if(StripCurrency($_POST["txtDibayar"][0]) < StripCurrency($_POST["txtTotalDibayar"])){
      ...
      if(($_POST["reg_jenis_pasien"]=="5" && $pembayaranDijamin==0.00 && $_POST["id_poli"]<>$_POST["op"]) || $_POST["reg_jenis_pasien"]=="7" || $_POST["reg_jenis_pasien"]=="18"){
      $sql = "update klinik.klinik_pembayaran set pembayaran_flag = 'n', 
              pembayaran_total =".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_biaya"])).", 
              pembayaran_yg_dibayar = '0', pembayaran_hrs_bayar =".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_biaya"])).",
              pembayaran_dijamin=".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_dijamin"]))." 
              where pembayaran_id = ".QuoteValue(DPE_CHAR,$_POST["pembayaran_id"]);
              //echo $sql; die();
      } elseif($_POST["reg_jenis_pasien"]=="5" && $pembayaranDijamin > 0.00 && $_POST["id_poli"]==$_POST["op"]){
			...
			} elseif($_POST["reg_jenis_pasien"]=="5" && $pembayaranDijamin >= 0.00 && $pembayaranDijamin >= $_POST["total_biaya"] && $_POST["id_poli"]<>$_POST["op"]){
        if($_POST["reg_tipe_jkn"]=="1" || $_POST["reg_tipe_layanan"]=="1"){
        $sql = "update klinik.klinik_pembayaran set pembayaran_flag = 'n', 
                pembayaran_total =".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_biaya"])).", 
                pembayaran_yg_dibayar = '0', pembayaran_subsidi=".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_harga"])).", 
                pembayaran_hrs_bayar = '0', pembayaran_selisih_positif = ".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_harga"])).", 
                pembayaran_selisih_negatif = '0' where pembayaran_id = ".QuoteValue(DPE_CHAR,$_POST["pembayaran_id"]);
                //echo $pembayaranHrsBayar."1".$sql; die();
        }else{
        $sql = "update klinik.klinik_pembayaran set pembayaran_flag = 'n', 
                pembayaran_total =".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_biaya"])).", 
                pembayaran_yg_dibayar = ".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_harga"])).", 
                pembayaran_hrs_bayar =".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranHrsBayar)).", 
                pembayaran_selisih_positif = ".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranHrsBayar)).", 
                pembayaran_selisih_negatif = '0' where pembayaran_id = ".QuoteValue(DPE_CHAR,$_POST["pembayaran_id"]);
                //echo "2".$sql; die();
        }
      } elseif ($_POST["reg_jenis_pasien"]=="5" && $pembayaranDijamin >= 0.00 && $pembayaranDijamin <= $_POST["total_biaya"] && $_POST["id_poli"]<>$_POST["op"]){
        ...
        $sql = "update klinik.klinik_pembayaran set pembayaran_flag = 'n', 
                pembayaran_total =".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_biaya"])).", 
                pembayaran_yg_dibayar = '0', pembayaran_subsidi=".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_harga"])).", 
                pembayaran_hrs_bayar = '0', pembayaran_selisih_negatif = ".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranHrsBayar)).", 
                pembayaran_selisih_positif = '0' where pembayaran_id = ".QuoteValue(DPE_CHAR,$_POST["pembayaran_id"]);
                //echo $_POST["reg_tipe_jkn"]."dan".$_POST["reg_tipe_layanan"]."HRSBYAR = ".$pembayaranHrsBayar."sat".$sql; die();
        }else{
        $sql = "update klinik.klinik_pembayaran set pembayaran_flag = 'n', 
                pembayaran_total =".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_biaya"])).", 
                pembayaran_yg_dibayar = ".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_harga"])).", 
                pembayaran_hrs_bayar =".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranHrsBayar)).", 
                pembayaran_selisih_negatif = ".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranHrsBayar)).", 
                pembayaran_selisih_positif = '0' where pembayaran_id = ".QuoteValue(DPE_CHAR,$_POST["pembayaran_id"]);
                //echo "dua".$sql; die();
        }
      } else {
    ...
    if(StripCurrency($_POST["txtDibayar"][0]) < StripCurrency($_POST["total_harga"])){
      ...
      $sql = "update klinik.klinik_pembayaran set pembayaran_flag = 'n', 
        ...
        $sql = "update klinik.klinik_pembayaran set pembayaran_flag = 'n', 
                ...
                pembayaran_yg_dibayar = ".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_harga"])).", 
                pembayaran_hrs_bayar =".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranHrsBayar)).", 
                pembayaran_selisih_positif = ".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranSelisih)).", 
                pembayaran_selisih_negatif = '0' where pembayaran_id = ".QuoteValue(DPE_CHAR,$_POST["pembayaran_id"]);
                //echo "2".$sql; die();
        }
      } elseif ($_POST["reg_jenis_pasien"]=="5" && $pembayaranDijamin >= 0.00 && $pembayaranDijamin <= $_POST["total_biaya"] && $_POST["id_poli"]<>$_POST["op"]){
        ...
        $sql = "update klinik.klinik_pembayaran set pembayaran_flag = 'n', 
                pembayaran_total =".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_biaya"])).", 
                pembayaran_yg_dibayar = '0', pembayaran_subsidi=".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_harga"])).", 
                pembayaran_hrs_bayar = '0', pembayaran_selisih_negatif = ".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranSelisih)).", 
                pembayaran_selisih_positif = '0' where pembayaran_id = ".QuoteValue(DPE_CHAR,$_POST["pembayaran_id"]);
                //echo $_POST["reg_tipe_jkn"]."dan".$_POST["reg_tipe_layanan"]."HRSBYAR = ".$pembayaranHrsBayar."sat".$sql; die();
        }else{
        $sql = "update klinik.klinik_pembayaran set pembayaran_flag = 'n', 
                ...
                pembayaran_yg_dibayar = ".QuoteValue(DPE_NUMERIC,StripCurrency($_POST["total_harga"])).", 
                pembayaran_hrs_bayar =".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranHrsBayar)).", 
                pembayaran_selisih_negatif = ".QuoteValue(DPE_NUMERIC,StripCurrency($pembayaranSelisih)).", 
                pembayaran_selisih_positif = '0' where pembayaran_id = ".QuoteValue(DPE_CHAR,$_POST["pembayaran_id"]);
                //echo "dua".$sql; die();
        }
      } else {
    ...
    $dbTable = "klinik.klinik_pembayaran_multipayment";
              ...
              //$MaksUrut = "1";
                   ...
                   $sql = "select * from klinik.klinik_pembayaran_multipayment 
                          where id_pembayaran =".QuoteValue(DPE_CHAR,$_POST["pembayaran_id"]);
                   $rs = $dtaccess->Execute($sql);
                   $PembayaranDetz = $dtaccess->FetchAll($rs);
                    ...
                    for($ii=0,$nn=count($PembayaranDetz);$ii<$nn;$ii++) {
                     if($PembayaranDetz[$ii]["pembayaran_multipayment_total"]=='0.0000') {
                        $sql = "delete from klinik.klinik_pembayaran_multipayment 
                                where pembayaran_multipayment_id = ".QuoteValue(DPE_CHAR,$PembayaranDetz[$ii]["pembayaran_multipayment_id"]);
                        $dtaccess->Execute($sql,DB_SCHEMA_KLINIK);
                      }
                    }
...
//          print_r($dbValue);   die();
      ...
      $dbTable = "gl.gl_buffer_transaksidetil";
          ...
          $dbValue[4] = QuoteValue(DPE_CHAR,$_POST["job_id"]);
          $dbValue[5] = QuoteValue(DPE_CHAR,$depId);  
          $dbValue[6] = QuoteValue(DPE_NUMERIC,StripCurrency($_POST["retur"]));
//          print_r($dbValue);   die();
          $dbKey[0] = 0; // -- set key buat clause wherenya , valuenya = index array buat field / value
          $dtmodel = new DataModel($dbTable,$dbField,$dbValue,$dbKey,DB_SCHEMA_GL);
...
//print_r($dbValue); 
  ...
  //          print_r($dbValue);   die();
      ...
      //INSERT PIUTANG DAN SELISIH
       //JIKA PBI NAIK KELAS DAN SELISIHNYA NEGATIF
      elseif ($dataPas["reg_jenis_pasien"]=="5" && $dataPas["reg_tipe_jkn"]=="1"  && $dataPas["id_poli"]<>$_POST["op"] &&
          $dataPas["reg_tipe_layanan"]=="2" &&  
          $dataPembayaranPas["pembayaran_dijamin"]<=$dataPembayaranPas["pembayaran_total"]) //jika selisih negatif
    {
       $sql = "select id_prk_piutang_debet, id_prk_piutang_kredit, id_prk_tambahan_debet, id_prk_tambahan_kredit 
              from klinik.klinik_biaya_prk where id_jenis_pasien = ".QuoteValue(DPE_NUMERIC,$dataFolioPas[$i]["fol_jenis_pasien"]);
          if ($_POST["dep_posting_poli"]=="y") $sql .= " and id_poli = ".QuoteValue(DPE_CHAR,$dataFolioPas[$i]["id_poli"]);         
      ...
      $dbTable = "gl.gl_buffer_transaksidetil";
          ...
          $dbValue[4] = QuoteValue(DPE_CHAR,$_POST["job_id"]);
          $dbValue[5] = QuoteValue(DPE_CHAR,$depId);  
          $dbValue[6] = QuoteValue(DPE_NUMERIC,StripCurrency($dataPembayaranPas["pembayaran_dijamin"]));
//          print_r($dbValue);   die();
          $dbKey[0] = 0; // -- set key buat clause wherenya , valuenya = index array buat field / value
          $dtmodel = new DataModel($dbTable,$dbField,$dbValue,$dbKey,DB_SCHEMA_GL);
...
//print_r($dbValue); 
  ...
  //          print_r($dbValue);   die();
    ...
    } // end jika selisih negatif  

// non pbi selisih negatif
if($dataPas["reg_jenis_pasien"]=="5" && $dataPas["reg_tipe_jkn"]=="2"  && $dataPas["id_poli"]<>$_POST["op"] &&
   $dataPas["reg_tipe_layanan"]=="2" && $dataPembayaranPas["pembayaran_dijamin"]<=$dataPembayaranPas["pembayaran_total"] ) {
      ...
      $dbTable = "gl.gl_buffer_transaksidetil";
          ...
          $dbValue[0] = QuoteValue(DPE_CHAR,$transaksiDetailId);
          $dbValue[1] = QuoteValue(DPE_CHAR,$transaksiId);
          $dbValue[2] = QuoteValue(DPE_CHAR,'010103010602');
          $dbValue[3] = QuoteValue(DPE_CHAR,$keterangan);
          $dbValue[4] = QuoteValue(DPE_CHAR,$_POST["job_id"]);
          $dbValue[5] = QuoteValue(DPE_CHAR,$depId);  
          $dbValue[6] = QuoteValue(DPE_NUMERIC,StripCurrency($dataPembayaranPas["pembayaran_dijamin"]));
//          echo "aaaa";print_r($dbValue);    die();
          $dbKey[0] = 0; // -- set key buat clause wherenya , valuenya = index array buat field / value
          $dtmodel = new DataModel($dbTable,$dbField,$dbValue,$dbKey,DB_SCHEMA_GL);
...
//print_r($dbValue); 
  ...
  //          print_r($dbValue);   die();
    ...
    // JKN PBI selisih positif
if($dataPas["reg_jenis_pasien"]=="5" && $dataPas["reg_tipe_jkn"]=="1"  && $dataPas["id_poli"]<>$_POST["op"] && 
 $dataPas["reg_tipe_layanan"]=="2" && $dataPembayaranPas["pembayaran_dijamin"]>=$dataPembayaranPas["pembayaran_total"] ) {
...
//INSERT PIUTANG DAN SELISIH
       //JIKA PBI SESUAI HAK DAN SELISIHNYA NEGATIF
      elseif ($dataPas["reg_jenis_pasien"]=="5" && $dataPas["reg_tipe_jkn"]=="1"  && $dataPas["id_poli"]<>$_POST["op"] && 
          $dataPas["reg_tipe_layanan"]=="1" && 
          $dataPembayaranPas["pembayaran_dijamin"]<=$dataPembayaranPas["pembayaran_total"]) //jika selisih negatif
       {
...
// non pbi selisih negatif
if($dataPas["reg_jenis_pasien"]=="5" && $dataPas["reg_tipe_jkn"]=="2" && $dataPas["id_poli"]<>$_POST["op"] &&
   $dataPas["reg_tipe_layanan"]=="1" && $dataPembayaranPas["pembayaran_dijamin"]<=$dataPembayaranPas["pembayaran_total"] ) {
...
<?php  echo $view->RenderBody("ipad_depans.css",true,"KASIR PEMBAYARAN TUNAI"); ?>
...
<a href=""><font size="6">KASIR PEMBAYARAN TUNAI</font></a>
</td>
</tr>
</table>
</div>
