...
if ($_POST['btnDiskon']) {
  ...
  $dbValue[2] = QuoteValue(DPE_CHAR, str_replace(',', '', $_POST['txtdiskon1']));
...
$grandTotalHargax = $totalHarga - $uangmuka["total"] + $serviceCharge - $_POST["deposit_nominal"];
  ...
  <script>
    ...
    $('#btnBayar').on('click', function() {
      ...
      if (jumlah > 0) {
        ...
        var resl = confirm("apakah anda yakin ingin memasukkan pasien ini ke piutang umum?");
        if (resl == true) {
          $('#demo-form2').append(input);
          $('#demo-form2').submit();
        } else {
