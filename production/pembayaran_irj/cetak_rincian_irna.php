<?php
  ...
  if($_GET["id_reg"] ) {
    ...
    $sql = "select a.id_pembayaran,a.id_poli,a.id_cust_usr, a.reg_tanggal, a.reg_tanggal_pulang, g.pembayaran_diskon, a.reg_jenis_pasien , a.reg_when_update, a.reg_kode_trans,a.reg_tanggal, 
      ...
      where a.reg_id = ".QuoteValue(DPE_CHAR,$_GET['id_reg'])." and a.id_pembayaran = ".QuoteValue(DPE_CHAR,$_GET["pembayaran_id"]);
      ...
      <?php
        ...
        <?php
          ...
          for($a = 0, $s = count($dataFolio); $a < $s; $a++){
            $sql = "select * from klinik.klinik_folio_pelaksana a left join klinik.klinik_folio_posisi b on b.fol_posisi_id = a.fol_pelaksana_tipe left join global.global_auth_user c on c.usr_id = a.id_usr where id_fol = ".QuoteValue(DPE_CHAR,$dataFolio[$a]['fol_id'])." and (fol_pelaksana_tipe = '10' or b.fol_posisi_nama = 'Dokter Konsultasi')";
