<?php
     ...
     $viewPage = "perkawinan_view.php";
     $editPage = "perkawinan_edit.php";

     if (!$_POST["klinik"]) $_POST["klinik"]=$depId;
     $back = "perkawinan_view.php?kembali=".$_POST["klinik"];
     
	if($_POST["x_mode"]) $_x_mode = & $_POST["x_mode"];
	else $_x_mode = "New";
   
	if($_POST["status_perkawinan_id"])  $statusPerkawinanId = & $_POST["status_perkawinan_id"];
     ...
     if ($_GET["id"]) {
          if ($_POST["btnDelete"]) { 
               ...
               $_x_mode = "Edit";
               $statusPerkawinanId = $enc->Decode($_GET["id"]);
          }
         
          $sql = "select a.* from global.global_status_perkawinan a 
				          where status_perkawinan_id = ".QuoteValue(DPE_CHAR,$statusPerkawinanId);
          $rs_edit = $dtaccess->Execute($sql);
          $row_edit = $dtaccess->Fetch($rs_edit);
          $dtaccess->Clear($rs_edit);
     
          $_POST["status_perkawinan_nama"] = $row_edit["status_perkawinan_nama"];
          $_POST["klinik"] = $depId;
          $back = "perkawinan_view.php?kembali=".$_POST["klinik"];
     }
	...
	elseif($_x_mode=="Edit") $privMode = PRIV_UPDATE;
     ...
     if ($_POST["btnSave"] || $_POST["btnUpdate"]) {          
          if($_POST["btnUpdate"]){
               $statusPerkawinanId = & $_POST["status_perkawinan_id"];
               $_x_mode = "Edit";
          }
               
               $dbTable = "  global.global_status_perkawinan";
               
               $dbField[0] = "status_perkawinan_id";   // PK
               $dbField[1] = "status_perkawinan_nama";
               $dbField[2] = "id_dep";
			
               if(!$statusPerkawinanId) $statusPerkawinanId = $dtaccess->GetTransID();   
               $dbValue[0] = QuoteValue(DPE_CHAR,$statusPerkawinanId);
               $dbValue[1] = QuoteValue(DPE_CHAR,$_POST["status_perkawinan_nama"]);
    ...
    if ($_GET["del"]) {
          $statusPerkawinanId = $enc->Decode($_GET["id"]);
           ...
           $sql = "delete from global.global_status_perkawinan where status_perkawinan_id = ".QuoteValue(DPE_CHAR,$statusPerkawinanId);
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Master Status Perkawinan</h2>
                  ...
                  <div class="x_content">
					<form id="demo-form2" method="POST" class="form-horizontal form-label-left" action="<?php echo $_SERVER["PHP_SELF"]?>">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Status Perkawinan</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <?php echo $view->RenderTextBox("status_perkawinan_nama","status_perkawinan_nama","50","100",$_POST["status_perkawinan_nama"],"inputField", null,false);?>
                        </div>
                      </div>                    
                    ...
                    <script>document.frmEdit.status_perkawinan_nama.focus();</script>
					<? if (($_x_mode == "Edit") || ($_x_mode == "Delete")) { ?>
					<?php echo $view->RenderHidden("status_perkawinan_id","status_perkawinan_id",$statusPerkawinanId);?>
...
{ 
     if(!frm.status_perkawinan_nama.value){
		alert('Nama Jenis pegawai Harus Diisi');
		frm.status_perkawinan_nama.focus();
          return false;
	}
