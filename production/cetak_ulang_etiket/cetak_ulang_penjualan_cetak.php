<?php
	...
	if($_GET["id"]) {
		$sql = "select a.penjualan_detail_ket,a.id_item,a.penjualan_detail_create, a.penjualan_detail_jumlah, b.* ,c.item_nama , c.item_tipe_jenis,d.cust_usr_kode_tampilan,d.cust_usr_tanggal_lahir,
            e.jenis_nama, f.poli_nama,g.petunjuk_nama,d.cust_usr_ibu,h.batch_tgl_jatuh_tempo, m.jam_aturan_pakai_nama,
            i.dep_nama,i.dep_kop_surat_1,j.aturan_minum_nama,k.aturan_pakai_nama, c.item_racikan
            ...
            left join apotik.apotik_jam_aturan_pakai m on m.jam_aturan_pakai_id = a.id_jam_aturan_pakai
...
<td align="center" >:</td>
<td align="left" height="30"><?php echo implode(' ~ ',$data);?></td>
</tr>
<?php } else { ?>
<tr style="font-size: 9" valign="top">
<td align="left">Nama Obat</td>
<td align="center" >:</td>
<td align="left" height="30"><?php echo $dataTable[$i]["item_nama"];?></td>
</tr>
<?php } ?>
...
<td align="center"  >:</td>
<td align="left" style="font-size: 10"><?php echo $dataTable[$i]["penjualan_detail_ket"];?></td>
</tr>
