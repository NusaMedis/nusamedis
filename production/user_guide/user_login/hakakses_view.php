<?php
    ...
    $enc = new TextEncrypt();     
     ...
     // function _path($ttd)
     //  {
     //    return '../gambar/asset_ttd/' . $ttd . '.jpg';
     //  }
...
//     echo $sql;
     ...
     $tbHeader[0][$counterHeader][TABLE_ISI] = "Nama Pengguna";
     $tbHeader[0][$counterHeader][TABLE_WIDTH] = "25%";
     $counterHeader++;    
          
     $tbHeader[0][$counterHeader][TABLE_ISI] = "Nama Login";
     $tbHeader[0][$counterHeader][TABLE_WIDTH] = "25%";
     $counterHeader++;
...
/*		  $lokasi = $ROOT."gambar/foto_pegawai";
          ...
          $tbContent[$i][$counter][TABLE_ALIGN] = "left";
            ...
            if (file_exists('../gambar/asset_ttd/' . $dataTable[$i]["usr_id"] . '.jpg')) {
              # code...
              $stt_ttd="Sudah TTD";
            }
            else{
          ...
          $counter++;
            ...
            $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$ttd.'id='.$enc->Encode($dataTable[$i]["usr_id"]).'"><img hspace="2" width="30" height="30" src="'.$ROOT.'gambar/icon/ttd.png" alt="Tanda Tangan" title="Tanda Tangan" border="0"></a>'."<br/>".$stt_ttd
          ;
          $tbContent[$i][$counter][TABLE_ALIGN] = "center";
          $counter++;
          

          $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'&reset=1&id='.$enc->Encode($dataTable[$i]["usr_id"]).'"><img hspace="2" width="30" height="30" src="'.$ROOT.'gambar/icon/pulang.png" alt="Edit" title="Edit" border="0" onclick="javascript: return Reset();"></a>';
          $tbContent[$i][$counter][TABLE_ALIGN] = "center";
          $counter++;
			...
			<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<?php $counter = -1;
					...
					unset($spacer); 
					$length = (strlen($dataSatker[$i]["struk_tree"])/TREE_LENGTH)-1; 
				...
				<?php } ?>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12">Nama Login</label>
