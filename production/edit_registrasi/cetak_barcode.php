	...
	<table style="margin:29px auto">
			...
			<tr>
				...
				<?php //for ($j = 1; $j <= 2; $j++) { ?>
					...
					<td rowspan="3" style="width: 145px; float: left; text-align:left; padding-right:25px; margin-bottom: 0px;padding-top: 5px; padding-bottom: 5px;">
						...
						<?php
							if ($obj) {
								if ($check_error) {
									...
									<span style="font-size:8px;font-family:sans-serif;font-weight:bold;text-align: center;"><?php echo substr($nm_akhir[0], 0, 20) . ", " . $nm_akhir[1] .", " . $nm_akhir[2] . ' (' . $dataPasien["cust_usr_jenis_kelamin"] . ')'.' - '. $dataPasien['cust_usr_kode']; ?></span>

									<img class="img" src="<?php echo $ROOT; ?>lib/barcode2/barcode.php?text=<?php echo $dataPasien['reg_kode_trans'] ?>&print=true&size=30>">
								<?php }
							} 
						?>
				...
				<td rowspan="3" style="width: 145px; float: left; text-align:left; padding-left:25px; margin-bottom: 0px;padding-top: 5px; padding-bottom: 5px;">
