          ...
          else     //Rehab Medik
          {
            ...
            if(!$dataPerawat){
              ...
              $sql = "select a.*,b.*,c.*  from  klinik.klinik_biaya_pemeriksaan a 
                      ...
                      left join klinik.klinik_biaya_tarif c on b.biaya_id = c.id_biaya and a.id_tahun_tarif=c.id_tahun_tarif
                      where a.id_tipe_biaya=".QuoteValue(DPE_CHAR,$_POST["layanan"])." and 
                      a.id_shift=".QuoteValue(DPE_CHAR,$_POST["reg_shift"])."
                      and a.id_tahun_tarif=".QuoteValue(DPE_CHAR,$tahunTarif)."
