<?php
  ...
  c.poli_nama, d.jkn_nama,e.jenis_nama,f.usr_name,h.dep_kota, i.poli_tipe_nama,a.reg_tipe_rawat,reg_no_antrian,
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse"> 
  ...
  <td width="10%">No. Registrasi </td>
    <td align="left" width="70%">: <?php echo $kode_transaksis[3];?></td> 
  </tr>
  <tr>
  <td width="10%">No. RM </td>
    <td align="left" width="70%">: <?php echo $dataPasien["cust_usr_kode_tampilan"];?></td>  
  </tr>
  <tr>
  ...
  <td width="10%">Tanggal Lahir </td>
    <td align="left" width="70%">: <?php echo format_date($dataPasien["cust_usr_tanggal_lahir"]);?>
  ...
  <td width="10%">Cara Bayar  </td>
    ...
    <td align="left" width="70%">: <?php echo $dataPasien["jenis_nama"]." - ".$dataPasien["jkn_nama"];?></td>
    <?php } else { ?>
    <td align="left" width="70%">: <?php echo $dataPasien["jenis_nama"];?></td>
    <?php } ?>  
  </tr>
   <tr>
  <td width="10%">Klinik/Departemen </td>
    <td align="left" width="70%">: <?php echo $dataPasien["poli_nama"];?></td>  
  </tr>
  <tr>

  <td width="10%">Nama Dokter </td>
    <td align="left" width="70%">: <?php echo $dataPasien["usr_name"];?></td>  
  </tr>
  <tr>

  <td width="10%">Petugas Pendaftaran</td>
    <td align="left" width="70%">: <?php echo $dataPasien['reg_who_update'];?></td>  
  </tr>
