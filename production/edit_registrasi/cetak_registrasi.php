...
<body onload="window.print()">
  <table class="b1" width="30%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse">
    ...
    <tr>
      <td align="center"><b><?php  echo substr($dataPasien["reg_no_antrian"], 2) ; ?></b></td>
    </tr>
    <tr>
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse">
    ...
    <tr>
      ...
      <td align="left" width="85%">: <?php echo $dataPasien["reg_kode_trans"]; ?></td>
    </tr>
    <tr>
      <td width="10%">No. RM </td>
      <td align="left" width="85%">: <?php  echo $dataPasien["cust_usr_kode"]; ?></td>
    </tr>
    <tr>

      <td width="10%">Nama Pasien </td>
      <td align="left" width="85%">: <?php echo str_replace("*", "'",  $dataPasien["cust_usr_nama"]); ?></td>
    </tr>
    <tr>
  ...
  <?php if ($dataPasien["poli_tipe_id"] == 'J') { ?>
    <table border="0" width="100%">
      ...
      <tr>
        <td width="5%">&nbsp;</td>
        <td width="5%" style="font-size: 14px;">9.</td>
        <td width="50%" style="font-size: 14px;" colspan="2">DPJP / Rujuk Balik</td>
        <td width="5%"><img src="<?php echo $gbr; ?>" width='20' height='20'></td>
        <td width="35%"></td>
      </tr>
