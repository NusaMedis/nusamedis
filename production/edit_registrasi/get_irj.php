...
// ini_set('display_errors', 1);
	...
	if(isset($_GET['reg_id'])){
		$sql = "select j.pendidikan_nama, b.id_pendidikan, a.*,b.id_kelurahan as kelurahan,b.id_kecamatan as kecamatan,b.id_kota as kota,b.*,c.poli_nama,c.poli_id,d.id_kategori_kamar,d.id_kamar,d.id_bed,e.id_gedung_rawat, a.id_perusahaan, a.id_dokter
		from klinik.klinik_registrasi a 
		left join global.global_customer_user b on a.id_cust_usr = b.cust_usr_id left join
		...
		left join global.global_pendidikan j on j.pendidikan_id = b.id_pendidikan
		where  a.reg_id = '$_GET[reg_id]' and a.id_dep='$depId'";
		...
		//}else {
				$kondisi = "a.reg_tanggal ='$tglSekarang'";
		//}  
		
		$sql = "select j.pendidikan_nama, b.id_pendidikan,a.reg_id,a.reg_tanggal,a.reg_kode_trans,a.reg_status,a.id_cust_usr,a.reg_waktu,b.cust_usr_kode,b.cust_usr_kode_tampilan,b.cust_usr_nama,b.cust_usr_tanggal_lahir,b.cust_usr_alamat,c.poli_nama,c.poli_id,d.jkn_nama,f.jenis_nama, perusahaan_nama,h.poli_nama as poli_asal, usr_name,a.id_dokter,a.id_dep from 
		...
		left join global.global_pendidikan j on j.pendidikan_id = b.id_pendidikan where a.id_dep='$depId'";
		$sql .= "and ".$kondisi;
		$sql .= "  and  a.reg_status <>' ' and id_pembayaran notnull and reg_status != 'I9'  and cust_usr_kode != '100'";
	    ...
	    for($i=0; $i < count($dataTable); $i++){    
	      ...
	      array_push($data, [
	          ...
	          'pendidikan_nama'   => $dataTable[$i]['pendidikan_nama'],
	          'id_pendidikan'   => $dataTable[$i]['id_pendidikan'],
