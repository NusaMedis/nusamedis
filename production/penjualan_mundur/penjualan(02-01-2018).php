				  ...
				  <?php if ($_x_mode=='New') { ?>
					<form name="frmFind" id="demo-form2" method="POST" class="form-horizontal form-label-left" action="<?php echo $_SERVER["PHP_SELF"]?>">
                     ...
                     <?php echo $view->RenderHidden("tombol_f2","tombol_f2",$_POST["tombol_f2"]); ?>                 
						<?php if ($_x_mode!='Edit') { ?>   
						<tr>                     
						<td colspan="4" class="tablecontent"><input type="submit" id="btnTambah" name="btnDaftar" value="Tambahkan" class="btn btn-Primary" onClick="javascript:return CekDataTambah();"/></td>
