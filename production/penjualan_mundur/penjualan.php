...
$findPage = "pasien_find.php?tgl=".$_GET['tgl'];
...
$sql = "select j.id_poli as poli_utama,a.*,f.*, c.reg_jenis_pasien , c.reg_status , c.reg_tanggal, c.reg_id, c.id_poli, d.rawat_terapi, c.id_dokter,g.jenis_nama, h.jkn_nama, i.perusahaan_nama,
...
left join klinik.klinik_registrasi j on j.reg_id = c.reg_utama
where c.reg_id =".QuoteValue(DPE_CHAR,$_POST["id_reg"])." order by c.reg_tanggal desc,c.reg_waktu desc";
...
$_POST["poli"] = $dataPasien["poli_utama"];
...
$dbValue[7] = QuoteValue(DPE_DATE,$_POST['tgl'].' '.date("H:i:s"));
...
$sql = "select * from global.global_auth_poli order by poli_tree asc ";
$rs = $dtaccess->Execute($sql);
...
document.getElementById('txtIsiTotale').innerHTML = formatCurrency((duit*jumlah)+(tuslag*jumlah));
document.getElementById('txtHargaTotal').value = formatCurrency((duit*jumlah)+(tuslag*jumlah));
    ...
    <div class="main_container">
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Penjualan Obat Pasien Mundur</h2>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <?php if ($_x_mode=='New') { ?>
            ...
            <div class="form-group">
              <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Nama Dokter <span class="required">*</span>
            </label>
            <div class="col-md-4 col-sm-4 col-xs-12">
      ...
      <table id="datatable-responsive"  class="table table-striped table-bordered dt-responsive nowrap"  cellspacing="0" width="100%">
        <tr>
          ...
          <td align="left" width="9%">Nama Obat</td>
