...
//     $poli = $auth->GetPoli();
   ...
   if(!$auth->IsAllowed("man_ganti_password",PRIV_CREATE)){
     ...
     $sql = "select a.*, b.cust_usr_kode, b.cust_usr_tanggal_lahir, c.jenis_nama, d.id_pembayaran,e.poli_nama from apotik.apotik_penjualan a
             ...
             where a.is_terima!='y' and cust_usr_id <> '100' and penjualan_flag<>'R' and d.reg_jenis_pasien = '2' and a.id_dep =".QuoteValue(DPE_CHAR,$depId)." 
...
if($_POST["btnTambah"]){
  $addPage = "penjualan.php?tgl=".date_db($_POST["tanggal_awal"]);
      ...
      <div class="row">
          ...
          <form  name="frmFind" action="<?php echo $_SERVER["PHP_SELF"]?>" method="POST" >
            <div class="col-md-4 col-sm-6 col-xs-12">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12">Tanggal Transaksi (DD-MM-YYYY)</label>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <input type="submit" name="btnTambah" value="Tambah Penjualan Mundur" class="pull-right col-md-12 col-sm-12 col-xs-12 btn btn-primary" />
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12">&nbsp;</label>
