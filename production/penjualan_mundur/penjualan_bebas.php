...
<?php } ?>
 ...
 <table id="datatable-responsive"  class="table table-striped table-bordered dt-responsive nowrap"  cellspacing="0" width="100%">
        ...
        // echo $sql;
        $editRacikan = "racikan_new_bebas.php?q=".$batchId."&item=".$dataTable[$i]["id_item"]."&kode=".$enc->Encode($_POST["cust_usr_kode"])."&transaksi=".$enc->Encode($penjualanId)."&id_reg=".$enc->Encode($_POST["id_reg"])."&id_pembayaran=".$_POST["id_pembayaran"]."&jenis_id=".$_POST['reg_jenis_pasien']."&id_penjualan_detail=".$dataTable[$i]['penjualan_detail_id'];
