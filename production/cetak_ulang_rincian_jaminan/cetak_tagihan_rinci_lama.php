<?php
	...
	if($_GET["id_reg"] || $_GET["jenis"]  || $_GET["ket"] || $_GET["dis"] || $_GET["disper"] || $_GET["pembul"] || $_GET["total"]) {
		$sql = "select l.jkn_nama,b.cust_usr_nama,b.cust_usr_kode,b.cust_usr_no_hp,b.cust_usr_jenis_kelamin,
            ...
            c.usr_name,e.jenis_nama,a.reg_kode_trans,a.reg_tanggal,g.*,h.*
    ...
    $_POST["id_pembayaran"] = $_GET["id_pembayaran"];
    ...
    $sql .= " order by tindakan_tanggal,tindakan_waktu asc";
...
<!--    <td width="5%" align="center">KELAS</td>    -->
	...
	<?php } elseif($_POST["reg_jenis_pasien"]=='5')  {?>
  ...
  <tr>
    ...
    //menampilkan split folio pelayanan
    $sql = "select a.* from klinik.klinik_biaya_split a
            ...
            order by split_urut asc";
    $rs = $dtaccess->Execute($sql);
    $dataFolioSplit = $dtaccess->FetchAll($rs);
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse; font-size:8px;">                                   
  ...
  <tr>
    <td width="35%" align="left" colspan='8'>TOTAL TAGIHAN : <b><?php echo currency_format($totalBiaya);?></b></td>
