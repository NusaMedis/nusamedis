<?php
     ...
     $fotoName = $lokasi."/default.jpg"; 
	  ...
	  if($_GET["id_reg"]) 
    {
		$sql = "select a.reg_no_sep, a.reg_kelas, a.id_pembayaran,a.id_poli,a.id_cust_usr ,a.reg_jenis_pasien , a.reg_when_update, a.reg_diagnosa_inap, 
            a.reg_kode_trans,a.id_poli,b.cust_usr_jkn, a.hak_kelas_inap,
            b.cust_usr_nama,b.cust_usr_kode,b.cust_usr_no_hp,b.cust_usr_jenis_kelamin, b.cust_usr_alamat,b.cust_usr_no_jaminan,b.cust_usr_no_identitas,
            ((current_date - b.cust_usr_tanggal_lahir)/365) as umur, 
            c.usr_name,
            d.poli_nama,  
            e.jenis_nama,
            f.kelas_nama,
            g.rawatinap_tanggal_keluar,g.rawatinap_tanggal_masuk, 
            h.kamar_nama,k.jkn_nama, 
            l.perusahaan_nama, m.fol_keterangan,m.id_reg 
            ...
            left join klinik.klinik_folio m on m.id_reg = a.reg_id          
...
elseif($_POST["reg_jenis_pasien"]=="24"){
   ...
   if(($_POST["hak_kelas_inap"]=="3" && $_POST["reg_kelas"]=="3") || 
   ($_POST["hak_kelas_inap"]=="2" && $_POST["reg_kelas"]=="2") || 
   ($_POST["hak_kelas_inap"]=="3" && $_POST["reg_kelas"]=="2"))
   {
...
<title>Tagihan Rincian Rawat Inap</title>
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse">
  <tr>
  <td></td> 
  <td align="center" width="100%">&nbsp;<font size="2">BIAYA PERAWATAN RAWAT INAP<font size="2"></td>  
  </tr>
</table>
<br><br>
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse"> 
 ...
 <!-- <tr> 
	...
	?>
        ...
        <tr> 
               ...
               <td align="center"><?php echo round($dataFolio[$i]["fol_jumlah"]);?> ITEM</td>
		...
		<?php for($x=0; $x<count($dataFarmasidetail); $x++) { ?>
			  <tr  style="border-collapse:collapse; font-size:9px;">
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse">
  ...
  { ?>
  <?if((($_POST["hak_kelas_inap"]=="1" || $_POST["hak_kelas_inap"]=="2" || 
         $_POST["hak_kelas_inap"]=="3") && $_POST["reg_kelas"]=="1")){  ?> 
