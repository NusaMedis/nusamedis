<?php
	...
	if($_GET["id_reg"]) 
  {
          ...
          $sql = "select a.*, b.biaya_paket from klinik.klinik_folio a left join klinik.klinik_biaya b on b.biaya_id=a.id_biaya where
            a.id_pembayaran= ".QuoteValue(DPE_CHAR,$_POST["id_pembayaran"])." 
...
<?php } else {?>
<title>Cetak Rincian Pembayaran IRJ</title>
<?php } ?>
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse">
 ...
 <table border="0" cellpadding="2" cellspacing="0"  align="center" width="100%">     
    <tr>
      <td style="text-align:center;font-size:15px;font-family:sans-serif;font-weight:bold;" class="tablecontent"><u>RINCIAN TINDAKAN RAWAT JALAN</u></td>
    </tr>
  </table>
<br>
