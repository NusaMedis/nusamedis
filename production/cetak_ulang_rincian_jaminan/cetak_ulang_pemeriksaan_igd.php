...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse">
  <tr>
  <td></td> 
  <td align="center" width="100%">&nbsp;<font size="2">RINGKASAN BIAYA PERAWATAN RAWAT DARURAT</font></td>  
  </tr>
</table>
<br><br>
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse"> 
  ...
  <tr>
    <td align="left" width="7%">Tgl Registrasi</td>  
    <td align="center" width="1%">:</td>  
    <td align="left" width="20%">&nbsp;<?php echo "&nbsp;".format_date($dataPasien["reg_tanggal"]);?></td>  
    <td align="center" width="5%">&nbsp;</td>
  ...
  <tr>
    ...
    <td align="center" width="5%">&nbsp;</td>
    <td align="left" width="10%">Poli Klinik</td>
    <td align="center" width="1%">:</td>  
...
//      && ($dataFolio[$i]["fol_jenis"]!='O' || $dataFolio[$i]["fol_jenis"]!='OI' || $dataFolio[$i]["fol_jenis"]!='OA' || $dataFolio[$i]["fol_jenis"]!='OG' || $dataFolio[$i]["fol_jenis"]!='RI' || $dataFolio[$i]["fol_jenis"]!='RA' || $dataFolio[$i]["fol_jenis"]!='RG')) 
 ...
 <!-- <tr> 
  ...
  <tr>
    ...
    <td width="10%"align="right">&nbsp;</td>
    <td align="right">TOTAL TAGIHAN : <?php if($dataPasien["reg_jenis_pasien"]=="5") {
