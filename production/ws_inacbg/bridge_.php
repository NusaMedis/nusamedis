...
// $sql = "update ar_ap.ar_trans set ar_trans_jumlah = '$cbgtarifresponsegrouper', ar_trans_sisa = '$cbgtarifresponsegrouper' where id_reg = '$regId'";
// $result = pg_query($connect, $sql);


// }elseif ($datainacbg["inacbg_id"]) {
...
// $sql1 = "update ar_ap.ar_trans set ar_trans_jumlah = '$cbgtarifresponsegrouper', ar_trans_sisa = '$cbgtarifresponsegrouper' where id_reg = '$regId'";
