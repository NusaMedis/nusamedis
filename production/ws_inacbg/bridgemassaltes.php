...
//$regId = $_GET["id_reg"];
$regId = '029c3ebf8af6cc349bf8b6ced68a9869';
...
$nama = $dataReg["inacbg_pasien_nama"];
$koderm = $dataReg["cust_usr_kode"];
$tgllahir = $dataReg["inacbg_tanggal_lahir"];
$gender = $dataReg["inacbg_jenis_kelamin"];    // 1 untuk laki-laki dan 2 untuk perempuan
$tiperawat =$dataReg["inacbg_jenis_pasien"];      //1 untuk IRNA 2 untuk IRJ
...
$query = " INSERT INTO klinik.klinik_inacbg(inacbg_id, id_reg, inacbg_kode, inacbg_no_sep, inacbg_dijamin)
    VALUES ('$inacbgID','$regId', '$cbgcoderesponsegrouper','$sep', '$cbgtarifresponsegrouper' )";
