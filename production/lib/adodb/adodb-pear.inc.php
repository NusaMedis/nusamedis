 ...
 * and Tomas V.V.Cox <cox@idecnet.com>.	Portions (c)1997-2002 The logistik.php Group.
 */
...
class DB
{
	...
	function &connect($dsn, $options = false)
	{
		...
		if (is_array($options) && isset($options["debug"]) &&
			$options["debug"] >= 2) {
			// expose logistik.php errors with sufficient debug level
	 ...
	 *
	 *  logistik.phptype: Database backend used in logistik.php (mysql, odbc etc.)
	 ...
	 *
	 *  logistik.phptype(dbsyntax)://username:password@protocol+hostspec/database
	 *
	 * Most variations are allowed:
	 *
	 *  logistik.phptype://username:password@protocol+hostspec:110//usr/db_file.db
	 *  logistik.phptype://username:password@hostspec/database_name
	 *  logistik.phptype://username:password@hostspec
	 *  logistik.phptype://username@hostspec
	 *  logistik.phptype://hostspec/database
	 *  logistik.phptype://hostspec
	 *  logistik.phptype(dbsyntax)
	 *  logistik.phptype
	 *
	...
	function parseDSN($dsn)
	{
		...
		// Find logistik.phptype and dbsyntax
		...
		// Get logistik.phptype and dbsyntax
		// $str => logistik.phptype(dbsyntax)
	...
	/**
	 * Load a logistik.php database extension if it is not loaded already.
	 *
	 * @access public
	 *
