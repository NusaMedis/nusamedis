...
// Not required for logistik.php 4.2.0 and above.
...
order by constraint_name, referenced_table_name, keyno";
	...
	function PrepareSP($sql)
	{
		if (!$this->_has_mssql_init) {
			ADOConnection::outp( "PrepareSP: mssql_init only available since logistik.php 4.1.0");
			return $sql;
		}
	...
	Usage:
		...
		@param $var logistik.php variable to bind to. Can set to null (for isNull support).
		@param $name Name of stored procedure variable name to bind to.
		@param [$isOutput] Indicates direction of parameter 0/false=IN  1=OUT  2= IN/OUT. This is ignored in oci8.
		@param [$maxLen] Holds an maximum length of the variable.
		@param [$type] The data type of $var. Legal values depend on driver.
		
		See mssql_bind documentation at logistik.php.net.
	*/
	function Parameter(&$stmt, &$var, $name, $isOutput=false, $maxLen=4000, $type=false)
	{
		if (!$this->_has_mssql_init) {
			ADOConnection::outp( "Parameter: mssql_bind only available since logistik.php 4.1.0");
			return $sql;
		}

		$isNull = is_null($var); // logistik.php 4.0.4 and above...
		...
		/*
			...
			RETVAL is HARD CODED into logistik.php_mssql extension:
			...
			see how it works. - type: one of this new supported logistik.php constants. 
	...
	/* 
		...
		Remember to set in logistik.php.ini the following...
...
class ADORecordset_mssql extends ADORecordSet {	
	...
	// get next resultset - requires logistik.php 4.0.5 or later
	...
	function MoveNext() 
	{
		...
		if ($this->fetchMode & ADODB_FETCH_ASSOC) {
			if ($this->fetchMode & ADODB_FETCH_NUM) {
				...
				if ($this->hasFetchAssoc) {// only for logistik.php 4.2.0 or later
