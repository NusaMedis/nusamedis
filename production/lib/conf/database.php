...
DEFINE("PELAKSANA_TIPE_DPJP","1");
DEFINE("PELAKSANA_TIPE_PELAKSANA","2");
DEFINE("PELAKSANA_TIPE_DOKTER_ANASTESI","3");
DEFINE("PELAKSANA_TIPE_ASISTEN_ANASTESI","4");
DEFINE("PELAKSANA_TIPE_PELAKSANA_2","5");
DEFINE("PELAKSANA_TIPE_PELAKSANA_3","6");
DEFINE("PELAKSANA_TIPE_DOKTER_INSTRUKSI","7");
DEFINE("PELAKSANA_TIPE_DOKTER_KONSULTASI","8");
DEFINE("PELAKSANA_TIPE_DOKTER_JAGA","9");
DEFINE("PELAKSANA_TIPE_DOKTER_OPERATOR","10");


DEFINE("PASIEN_BAYAR_ASKES","1");
DEFINE("PASIEN_BAYAR_UMUM","2");
DEFINE("PASIEN_BAYAR_JAMKESNAS_PUSAT","3");
DEFINE("PASIEN_BAYAR_JAMKESNAS_DAERAH","4");
DEFINE("PASIEN_BAYAR_BPJS","5");
...
DEFINE("STS_JAB_IPJ","IP");
DEFINE("STS_JAB_BIDAN","B");
...
$roleJabatan[STS_JAB_IPJ] = "Petugas IPJ";
$roleJabatan[STS_JAB_BIDAN] = "Bidan";
