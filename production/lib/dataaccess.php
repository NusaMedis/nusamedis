    ...
    */
    ...
    function Execute($in_sql,$in_schema=DB_SCHEMA_GLOBAL)
    {
        ...
        if(isset($loginData["id"])){
            ...
            $in_sql2 = str_replace('\'', '^', $in_sql);
            //echo $in_sql;
               $sql = "insert into global.global_dblog(log_data,log_who,log_tipe,log_ip,log_when,log_id,log_where,log_id_sikita) values ( ".
                        QuoteValue(DPE_CHAR,$in_sql2).",". 
