<?PHP
#########################################
# logistik.phpLiveX Library						#
# (C) Copyright 2006 Arda Beyazoðlu		#
# Version: 2.3							#
# Home Page: logistik.phplivex.sourceforge.net	#
...
function CreateJS(){
	...
	function logistik.phpLiveX(type, target, mode, preload, method, onFinish, onUpdate, interval, hideContent, myPreload){
		this.TYPE = type;
		this.MODE = mode;
		this.TARGET = target;
	...
	PHPLiveX.prototype.Callback = function(funcName, funcArgs){
		...
		var PLX = new logistik.phpLiveX(plxType, plxTarget, plxMode, plxPreload, plxMethod, plxOnFinish, plxOnUpdate, plxInterval, plxHideContent, plxMyPreload);
