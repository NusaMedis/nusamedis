...
<html>
    ...
    <body>';
        ...
        public function getNav() {
            $html = '
        <div style="width=100%;color:#fff; background-color: rgba(255, 255, 255, 0.3); margin: auto; padding: 0.5% 6% 1.3% 6%;font-size: 17px;">
                     <strong>'. $this->getTitle() .' </strong>
					<div style="float:right !important;">
						  <strong>'. $this->getUser() .'</strong> || <a href="#" style="text-decoration:none; color:#fff;" onClick="javascript: return Logout();">Logout</a>
					</div>
        </div>
