...
* in different versions of logistik.php
...
/**
* This routine will check whether the register_globals of logistik.php is on or off.
* If it is off, all GET,POST, and COOKIE variables will be explicitely 'globalized' here
* Note: this uses the $$ variable which will not work in logistik.php3
*/
