<?php
      ...
      if ((!$myFile = @fopen(stripslashes($csvFile), "r")) || $err==true) {
        ...
        while ($data = fgetcsv($myFile, 500000, $delimiter))  {
          if($data[0]) {
            ...
            $dbTable = "temp.global_auth_sub_instalasi";

            $dbField[] = "sub_instalasi_id";   // PK
            $dbField[] = "sub_instalasi_nama";
            $dbField[] = "sub_instalasi_kode";
            $dbField[] = "id_instalasi";
            $dbField[] = "id_dep";
            $dbField[] = "sub_instalasi_urut";
            ...
            $dbValue[] = QuoteValue(DPE_CHAR, $dtaccess->GetNewID("global.global_auth_sub_instalasi","sub_instalasi_urut",DB_SCHEMA_GLOBAL));
        ...
        $sql = "SELECT * FROM temp.global_auth_sub_instalasi a LEFT JOIN global.global_auth_instalasi b ON a.id_instalasi = b.instalasi_id ORDER BY sub_instalasi_nama ASC";
  ...
  /* KLIK APPROVE */
    if(isset($_POST["btnApprove"])){
      $sql = "INSERT INTO global.global_auth_sub_instalasi SELECT * FROM temp.global_auth_sub_instalasi WHERE UPPER(sub_instalasi_nama) NOT IN (SELECT UPPER(sub_instalasi_nama) FROM global.global_auth_sub_instalasi)";
      $dtaccess->Execute($sql);

      $sql = "DELETE FROM temp.global_auth_sub_instalasi";
      $dtaccess->Execute($sql);

      header("Location: sub_instalasi_view.php");
      exit();
    }
  /* KLIK APPROVE */
?>
                      ...
                      <div class="x_content">
                            ...
                            <table class="table table-bordered">
                              ...
                              <tr>
                                <td colspan="2" align="right">
                                  ...
                                  <a href="sub_instalasi_view.php" class="btn btn-danger">Kembali</a>
                                </td>
                              </tr>
                            </table>
                          </form>
                        ...
                        <!-- Syarat Import -->
                          <font size="2" color="red">
                            ...
                            &nbsp;&nbsp;Kolom 2 &nbsp;&nbsp;: Kode Sub Instalasi <br />
                            &nbsp;&nbsp;Kolom 3 &nbsp;&nbsp;: Nama Sub Instalasi <br />
                            &nbsp;&nbsp;Untuk Contoh data silahkan klik 
                            <a href="import_sub_instalasi.csv">disini</a> <br>
                          </font>
                        <!-- Syarat Import -->
                      </div>
                    <!-- Sebelum Import -->
                          ...
                          <?php if($dataTable) : ?>
                            <?php foreach($dataTable as $key => $value) : ?>
                              <tr>
                                ...
                                <td><?= $value['sub_instalasi_kode'] ?></td>
