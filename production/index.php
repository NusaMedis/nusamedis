<?php 
  ...
  //     echo"<script>window.parent.document.location.href='../login/login.php?msg=Session Expired'</script>";
  //     exit(1);
  // }

  $sql = "SELECT a.id_app, a.id_usr FROM global.global_auth_user_app a
		LEFT JOIN global.global_app b ON b.app_id = a.id_app 
		WHERE b.app_kode LIKE '%MANAGEMENT%' AND a.id_usr = ".QuoteValue(DPE_CHAR,$userId);
