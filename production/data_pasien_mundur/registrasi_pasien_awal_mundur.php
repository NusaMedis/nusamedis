<?php    
    ...
    //INISIALISASI AWAL
	$nextPage = "registrasi_pasien_mundur.php?usr_id="; 	
					...
					<table id="tata" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
						...
						<tr>
						  ...
						  <td>
							<a class="col-xs-12 btn btn-xs btn-primary" href="registrasi_pasien_mundur.php?usr_id=<?php echo $row[$i]['cust_usr_id']; ?>&status_pasien=L"> Registrasi <i class="fa fa-arrow-right"></i><a>
						  </td>
						</tr>
						<?php } ?>
						<?php if (count($row) == 0) { ?>
