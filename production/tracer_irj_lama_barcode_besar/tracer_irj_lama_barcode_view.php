<?php 
    ...
    /*  if(!$auth->IsAllowed("man_ganti_password",PRIV_READ)){
          ...
          exit(1);
     } else if($auth->IsAllowed("man_ganti_password",PRIV_READ)===1){
	 ...
	 {
      global  $dtaccess; 
      $sql = "select reg_id, id_cust_usr, reg_tracer_barcode_besar from klinik.klinik_registrasi";
	  $sql .=" where (reg_tracer_barcode_besar is null or reg_tracer_barcode_besar='n') and ( reg_utama is null or reg_utama = '' ) ";
	  //$sql .=" and reg_status_pasien='B' ";
       ...
       // -- end paging config ---//      
        ...
        $sql_where[] = "DATE(reg_tanggal) <= ".QuoteValue(DPE_DATE,date_db($in_tglakh));
          ...
          $sql = "select b.cust_usr_nama,b.cust_usr_kode,b.cust_usr_tempat_lahir,b.cust_usr_tanggal_lahir,
                  ...
                  where a.reg_status_pasien='B' and b.cust_usr_kode<>'500' and 
                  (a.reg_status='M0' or a.reg_status='E0' or 
                  a.reg_status='E1' or a.reg_status='E2' or a.reg_status='F0') 
                  and a.id_dep like '".$depId."' and (reg_tracer_barcode_besar is null or reg_tracer_barcode_besar='n') 
...
?>
<head>
<TITLE>TRACER BARCODE BESAR</TITLE>
