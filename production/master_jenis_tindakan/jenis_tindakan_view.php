<?php
     ...
     $thisPage = "jenis_tindakan_view.php";
     ...
     $sql = "select * from klinik.klinik_jenis_tindakan order by jenis_tindakan_urut ";
    ...
    $tableHeader = "&nbsp;Master Jenis Tindakan";
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
         $tbContent[$i][$counter][TABLE_ISI] = "&nbsp;&nbsp;".$dataTable[$i]["jenis_tindakan_urut"];               
         $tbContent[$i][$counter][TABLE_ALIGN] = "right";
         $counter++;
     
          $tbContent[$i][$counter][TABLE_ISI] = "&nbsp;&nbsp;".$dataTable[$i]["jenis_tindakan_kode"];
          ...
          $tbContent[$i][$counter][TABLE_ISI] = "&nbsp;&nbsp;".$dataTable[$i]["jenis_tindakan_label"];
          $tbContent[$i][$counter][TABLE_ALIGN] = "left";
          $counter++; 
          
          $tbContent[$i][$counter][TABLE_ISI] = "&nbsp;&nbsp;".$statusTindakan[$dataTable[$i]["jenis_tindakan_flag"]];
          $tbContent[$i][$counter][TABLE_ALIGN] = "left";
          $counter++; 

               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'?id='.$enc->Encode($dataTable[$i]["jenis_tindakan_id"]).'"><img hspace="2" width="30" height="30" src="'.$ROOT.'gambar/icon/edit.png" alt="Edit" title="Edit" border="0"></a>';               
