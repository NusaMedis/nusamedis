...
if (
  ...
  $sql = "update klinik.klinik_pembayaran_det set 
    ...
    " where id_pembayaran = " . QuoteValue(DPE_CHAR, $_GET["pembayaran_id"]);
  //echo $sql;
...
<body onload="window.print();">
  ...
  <?php } ?> -->
    ...
    if ($_GET['pembul'] > 0) {
      ...
      $pembulatan = str_replace('-', '', $_GET['pembul']);
    }
    $bayar = ($_GET["dibayar"] + $_GET["dis"]);
    $kurangBayar = $_GET["total"] > $bayar + $pembulatan;
    //echo $_POST["total"] - $_GET["dis"];
    ?>
    <tr>
      <td width="5%"></td>
      ...
      <?php } else { ?>
        <td align="left" width="20%" bgcolor="#CCCCCC">&nbsp;<?php echo terbilang($_GET["total"] - $_GET["dis"] - $pembulatan); ?> Rupiah</td>
      <?php } ?>
    </tr>
    <tr>
      <td width="5%"></td>
      ...
      <td width="1%">:</td>
      <td align="center" width="1%"></td>
      <td align="left" width="20%"><?php echo $_GET["catatan"]; ?></td>
    </tr>
  </table>
  <br>
  ...
  <table width="100%" border="0">
    ...
    ?>
      ...
      <tr>
        <td width="15%"></td>
        <td align="left" width="85%">Kekurangan bayar : Rp. <?php echo $_GET["total"] - $_GET["dibayar"] - $_GET["dis"]; ?></td>
      </tr>
    <?php } else { ?>
      <tr>
        <td width="15%"></td>
        <td align="left" width="85%">Diskon : </td>
      </tr>
      <? if (count($dataRincianDiskon) > 0) {
        $diskonNominal = 0; ?>
        <?php foreach ($dataRincianDiskon as $drd) :
          $diskonNominal = $diskonNominal + $drd['diskon_nominal']; ?>
          <tr>
            <td width="15%"></td>
        ...
        <!-- <tr>
          <td width="15%"></td>
          <td align="left" width="85%">Total Diskon : Rp. <?php //echo currency_format($diskonNominal); 
                                                          ?></td>
        </tr> -->
      <? } ?>
      ...
      <tr>
        <td width="15%"></td>
        <td align="left" width="85%">
          <hr width="25%" align="left"><b><i>Jumlah Rp. </i></b><?php echo currency_format($_GET["total"] - $_GET["dis"] - $pembulatan); ?>
          <hr width="25%" align="left">
        </td>
      </tr>
    <?php } ?>
