...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse"> 
  <tr>
	<td width="5%"></td>
    <td align="left" width="10%">No. Kwitansi</td>
    <td align="center" width="1%">:</td>  
    <td align="left" width="20%">&nbsp;<?php echo $_POST["kwitansi_nomor"];?></td>  
  </tr>
  <tr>
	<td width="5%"></td>
    <td align="left" width="7%">Nama Pembayar</td>  
    <td align="center" width="1%">:</td>  
	<?php 
  ...
  <?php } ?>
    <tr>
      ...
      <td  align="center" width="1%">:</td>  
      <td  align="left" width="20%"> &nbsp;Rp. <?php echo currency_format($grandTotalHarga);?></td>
    </tr>
    <?php if($dataDijamin["pembayaran_total"]>$dataDijamin["pembayaran_yg_dibayar"]) {?>
    <tr>
	  <td width="5%"></td>
	  <td  align="left" width="7%">Jumlah Yang Dibayar</td>  
      <td  align="center" width="1%">:</td>  
      <td  align="left" width="20%"> &nbsp;Rp. <?php echo currency_format($_POST["dibayar"]);?></td>
    </tr>
    <tr>
	  <td width="5%"></td>
	  <td  align="left" width="7%">Kurang Bayar</td>  
      <td  align="center" width="1%">:</td>  
      <td  align="left" width="20%"> &nbsp;Rp. <?php echo currency_format($grandTotalHarga-$_POST["dibayar"]);?></td>
    </tr>
    <?php } ?>
  <tr>
	<td width="5%"></td>
    ...
    <td  align="center" width="1%">:</td>  
    <td  align="left" width="20%">&nbsp;<?php if($dataDijamin["pembayaran_total"]>$dataDijamin["pembayaran_yg_dibayar"]) {echo terbilang($_POST["dibayar"]);} else echo terbilang($grandTotalHarga);?> Rupiah</td>  
  </tr>
</table>
<br>
