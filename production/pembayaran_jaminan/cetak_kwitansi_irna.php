  ...
  <?php } ?> -->
    ...
    <tr>
      ...
      <?php } else if ($depositNominalAwal > $totalTagihan) { ?>
        <td align="left" width="20%" bgcolor="#CCCCCC">&nbsp;Nol Rupiah</td>
      <?php } else { ?>
    ...
    <tr>
      ...
      <td width="1%">:</td>
      <td align="center" width="1%"></td>
      <td align="left" width="20%"><?php echo $dataDiskon["pembayaran_catatan"]; ?></td>
    </tr>
  </table>
  <br>
  ...
  <table width="100%" border="0">
    ...
    <?php } else if ($depositNominalAwal > $totalTagihan) { ?>
      <tr>
        <td width="15%"></td>
        <td align="left" width="85%">
          <hr width="25%" align="left"><b><i>Jumlah Rp. 0
              <hr width="25%" align="left">
        </td>
      </tr>
    <?php } else { ?>
