  ...
  //  if($_POST["id_jamkesda_kota"]){
   ...
   if($_POST["kondisi_akhir"]){
    ...
    $sql_where[] = " a.id_dokter = ".QuoteValue(DPE_CHAR,$_POST["id_usr"]);
     ...
     $sql.= "where and reg_tipe_rawat='I' and reg_status != 'I9' and (c.poli_nama='Ranap Nifas' or c.poli_nama='Ranap Neo' or c.poli_nama='Ranap Anak' or c.poli_nama='Ranap RGT')  and cust_usr_kode<>'100' and (a.reg_batal is null or reg_batal='n') ";
   ...
   //  var_dump($dataTable[0]); die();
     ...
     left join global.global_auth_poli c on c.poli_id = a.id_poli";
     $sql .=" where ".implode(" and ",$sql_where);
    $sql.= " and cust_usr_jenis_kelamin = 'L' AND a.reg_status != 'I9' and (c.poli_nama='Ranap Nifas' or c.poli_nama='Ranap Neo' or c.poli_nama='Ranap Anak' or c.poli_nama='Ranap RGT')  and cust_usr_kode<>'100' and (a.reg_batal is null or reg_batal='n')";
     ...
     left join global.global_auth_poli c on c.poli_id = a.id_poli";
     $sql .=" where ".implode(" and ",$sql_where);
    $sql.= "and cust_usr_jenis_kelamin = 'P'AND a.reg_status != 'I9' and (c.poli_nama='Ranap Nifas' or c.poli_nama='Ranap Neo' or c.poli_nama='Ranap Anak' or c.poli_nama='Ranap RGT')  and cust_usr_kode<>'100' and (a.reg_batal is null or reg_batal='n')";
     ...
     left join global.global_auth_poli c on c.poli_id = a.id_poli";
     $sql .=" where ".implode(" and ",$sql_where);
    $sql.= "and reg_status_pasien = 'L' AND a.reg_status != 'I9' and (c.poli_nama='Ranap Nifas' or c.poli_nama='Ranap Neo' or c.poli_nama='Ranap Anak' or c.poli_nama='Ranap RGT')  and cust_usr_kode<>'100' and (a.reg_batal is null or reg_batal='n')";
