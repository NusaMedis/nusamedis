    ...
    $sql_where[] = " a.id_dokter = ".QuoteValue(DPE_CHAR,$_POST["id_usr"]);
     ...
     if($_POST["btnLanjut"] || $_POST["btnCetak"]){
      $sql = "select b.id_lokasi, b.cust_usr_penanggung_jawab, b.id_kecamatan, b.id_kelurahan, b.id_kota, b.id_prop,b.id_pendidikan,pendidikan_nama,a.reg_kode_trans,b.cust_usr_kode, b.cust_usr_nama, b.cust_usr_alamat,  b.cust_usr_tanggal_lahir,b.cust_usr_agama,m.agm_nama as agama,b.cust_usr_pekerjaan, b.cust_usr_jenis_kelamin, f.dep_nama,
        ...
        a.reg_icd, k.rawat_diagnosa_utama, k.rawat_who_insert_icd,l.kondisi_akhir_pasien_nama,o.pembayaran_flag,b.cust_usr_dusun, p.prosedur_masuk_nama,y.*,z.*
   ...
   //  var_dump($dataTable[0]); die();
    ...
    /* $tbHeader[0][$counterHeader][TABLE_ISI] = "Tipe Layanan";
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
      ...
      // $sqlKec .= " and lokasi_kecamatan like '%".QuoteValue(DPE_CHAR,$dataTable[$i]["id_kecamatan"])."%' ";
      // $sqlKec .= " and lokasi_nama like '%".QuoteValue(DPE_CHAR,$dataTable[$i]["id_kota"])."%' ";
    
      // if( strlen($dataTable[$i]["id_kecamatan"])>2){
       
      //     if( $dataTable[$i]["id_kecamatan"] != "- Pilih Kecamatan -"){


      //       // $dataKecamatan["lokasi_kecamatan"]=$dataTable[$i]["id_kecamatan"];
  
      //       // $sqlKec .= " or lokasi_kabupatenkota like '%".QuoteValue(DPE_CHAR,$dataTable[$i]["id_kota"])."%' ";
      //       $sqlKec .= " and lokasi_kecamatan like '%".QuoteValue(DPE_CHAR,$dataTable[$i]["id_kecamatan"])."%' ";
      ...
      // }
      // elseif( strlen($dataTable[$i]["id_kota"])>2){
      //   if($dataTable[$i]["id_kota"] != "- Pilih Kota / Kabupaten -"){

      //     $sqlKec .= " or lokasi_nama like '%".QuoteValue(DPE_CHAR,$dataTable[$i]["id_kota"])."%' ";
      ...
      // if(strlen($dataTable[$i]["id_kota"])>2 && strlen($dataTable[$i]["id_kecamatan"])>2){

      //   if($dataTable[$i]["id_kota"] != "- Pilih Kota / Kabupaten -" && $dataTable[$i]["id_kecamatan"] != "- Pilih Kecamatan -" && $dataTable[$i]["id_kecamatan"] != "- Pilih Kecamatan -"){
    ...
    <div class="container body">
      ...
      <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Laporan Registrasi Rawat Jalan</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
