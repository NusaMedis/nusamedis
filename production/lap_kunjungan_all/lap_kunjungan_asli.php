...
<?php echo $view->RenderBody("ipad_depans.css",true,"LAPORAN KUNJUNGAN IRJ"); ?>
<?php } ?>
...
<?php if($_x_mode=="cetak"){ ?>	
  window.open('report_pasien_cetak.php?klinik=<?php echo $_POST["klinik"];?>&tgl_awal=<?php echo $_POST["tgl_awal"];?>&tgl_akhir=<?php echo $_POST["tgl_akhir"];?>&shift=<?php echo $_POST["shift"];?>&dokter=<?php echo $_POST["id_dokter"];?>', '_blank');
<?php } ?>
...
<a href=""><font size="6">LAPORAN KUNJUNGAN PASIEN IRJ</font></a>
</td>
</tr>
</table></div>
<div id="bodyku">
...
<?php if($_POST["btnExcel"]) {?>
     ...
     <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr class="tableheader">
               ...
               <strong>LAPORAN KUNJUNGAN PASIEN IRJ<br />
