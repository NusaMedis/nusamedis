...
*/     
  ...
  //  if($_POST["id_jamkesda_kota"]){
    ...
    $sql_where[] = " a.id_dokter = ".QuoteValue(DPE_CHAR,$_POST["id_usr"]);
     ...
     if($_POST["btnLanjut"] || $_POST["btnCetak"]){
      $sql = "select b.id_lokasi, b.cust_usr_penanggung_jawab, b.id_kecamatan, b.id_kelurahan, b.id_kota, b.id_prop,b.id_pendidikan,pendidikan_nama,a.reg_kode_trans,b.cust_usr_kode, b.cust_usr_nama, b.cust_usr_alamat,  b.cust_usr_tanggal_lahir,b.cust_usr_agama,m.agm_nama as agama,b.cust_usr_pekerjaan, b.cust_usr_jenis_kelamin, f.dep_nama,
        ...
        a.reg_icd, k.rawat_diagnosa_utama, k.rawat_who_insert_icd,l.kondisi_akhir_pasien_nama,o.pembayaran_flag ,y.*,z.*
     ...
     $sql.= " and  cust_usr_kode<>'500' and (a.reg_status = 'G2' or a.reg_status='G3') and cust_usr_kode<>'100' and (a.reg_batal is null or reg_batal='n') and (a.reg_status_kondisi='1' or a.reg_status_kondisi='2')";
   ...
   //  var_dump($dataTable[0]); die();
     ...
     $sql .=" where ".implode(" and ",$sql_where);
     $sql.= " and cust_usr_jenis_kelamin = 'L' and cust_usr_kode<>'500' and (a.reg_status = 'G2' or a.reg_status='G3') and cust_usr_kode<>'100' and (a.reg_batal is null or reg_batal='n') and (a.reg_status_kondisi='1' or a.reg_status_kondisi='2') ";
     ...
     $sql .=" where ".implode(" and ",$sql_where);
     $sql.= " and cust_usr_jenis_kelamin = 'P' and cust_usr_kode<>'500' and(a.reg_status = 'G2' or a.reg_status='G3') and cust_usr_kode<>'100' and (a.reg_batal is null or reg_batal='n') and (a.reg_status_kondisi='1' or a.reg_status_kondisi='2')";
     ...
     $sql .=" where ".implode(" and ",$sql_where);
     $sql.= " and reg_status_pasien = 'L' and cust_usr_kode<>'500' and(a.reg_status = 'G2' or a.reg_status='G3') and cust_usr_kode<>'100' and (a.reg_batal is null or reg_batal='n') and (a.reg_status_kondisi='1' or a.reg_status_kondisi='2')";
     ...
     $sql .=" where ".implode(" and ",$sql_where);
     $sql.= " and reg_status_pasien = 'B' and cust_usr_kode<>'500' and  (a.reg_status = 'G2' or a.reg_status='G3') and cust_usr_kode<>'100' and (a.reg_batal is null or reg_batal='n') and (a.reg_status_kondisi='1' or a.reg_status_kondisi='2') ";
     $dataBaru = $dtaccess->Fetch($sql);
    }

     $tableHeader = "&nbsp;Laporan Kunjungan Pasien Rawat IGD";
    ...
    //  $counterHeader++;
     ...
     $tbHeader[0][$counterHeader][TABLE_ISI] = "Kelurahan";
...
//  $dataPoli = $dtaccess->FetchAll($rs_edit);
  ...
  $sql = "select a.poli_nama, a.poli_id from global.global_auth_poli a join global.global_auth_user_poli b on a.poli_id = b.id_poli 
          where a.poli_tipe='J' and b.id_usr =".QuoteValue(DPE_CHAR,$userId); 
...
<?php if($_x_mode=="cetak"){ ?> 
  window.open('report_pasien_cetak_igd.php?tipe=<?php echo $_POST["reg_tipe_rawat"];?>&kode=<?php echo $_POST["cust_usr_kode"];?>&klinik=<?php echo $_POST["klinik"];?>&tgl_awal=<?php echo $_POST["tgl_awal"];?>&tgl_akhir=<?php echo $_POST["tgl_akhir"];?>&shift=<?php echo $_POST["shift"];?>&dokter=<?php echo $_POST["id_usr"];?>&id_poli=<?php echo $_POST["id_poli"];?>&jenis=<?php echo $_POST["reg_jenis_pasien"];?>&kondisi_akhir=<?php echo $_POST["kondisi_akhir"];?>&cetak=y', '_blank');
<?php } ?>

<?php if($_x_mode=="excel"){ ?> 
  window.open('report_pasien_cetak_igd.php?tipe=<?php echo $_POST["reg_tipe_rawat"];?>&kode=<?php echo $_POST["cust_usr_kode"];?>&klinik=<?php echo $_POST["klinik"];?>&tgl_awal=<?php echo $_POST["tgl_awal"];?>&tgl_akhir=<?php echo $_POST["tgl_akhir"];?>&shift=<?php echo $_POST["shift"];?>&dokter=<?php echo $_POST["id_usr"];?>&id_poli=<?php echo $_POST["id_poli"];?>&jenis=<?php echo $_POST["reg_jenis_pasien"];?>&kondisi_akhir=<?php echo $_POST["kondisi_akhir"];?>&excel=y', '_blank');
<?php } ?>
