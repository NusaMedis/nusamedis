<?php
   ...
   //  var_dump($dataTable[0]); die();
     ...
     $tableHeader = "&nbsp;Laporan Kunjungan Pasien IGD";
    ...
    //  $counterHeader++;
     ...
     $tbHeader[0][$counterHeader][TABLE_ISI] = "Cara Kunjungan";
     $tbHeader[0][$counterHeader][TABLE_WIDTH] = "8%";     
     $counterHeader++;
...
<table width="100%" border="1" cellpadding="1" cellspacing="0" style="border-collapse:collapse">
 ...
 <?php   # code...
          ...
          header('Content-Disposition: attachment; filename=laporan_kunjungan_pasien_igd.xls');?>
