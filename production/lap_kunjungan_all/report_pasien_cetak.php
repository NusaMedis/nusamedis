<?php
   ...
   if($_GET["tipe"]&& $_GET["tipe"]!="--"){
     $sql_where[] = " reg_tipe_rawat = ".QuoteValue(DPE_CHAR,$_GET["tipe"]);   
   ...
   $sql = "select a.reg_kode_trans, b.cust_usr_kode, b.cust_usr_nama,b.cust_usr_penanggung_jawab,b.cust_usr_dusun, b.cust_usr_alamat, b.cust_usr_tanggal_lahir, b.cust_usr_jenis_kelamin,f.dep_nama, 
...
g.perusahaan_nama, h.jamkesda_kota_nama, i.jkn_nama, a.reg_who_update, a.reg_tipe_layanan, j.tipe_biaya_nama, a.id_pembayaran,m.agm_nama as agama,q.pekerjaan_nama,
   a.reg_icd, k.rawat_diagnosa_utama, k.rawat_who_insert_icd,l.kondisi_akhir_pasien_nama, b.id_kecamatan, b.id_kelurahan, b.id_kota, b.id_prop,b.id_pendidikan,n.pendidikan_nama
...
$sql.= " and cust_usr_kode<>'500' and cust_usr_kode<>'100' and reg_utama is null and (a.reg_batal is null or reg_batal='n') ";
...
$sql = "select count(reg_id) as laki from klinik.klinik_registrasi a 
left join global.global_customer_user b on b.cust_usr_id = a.id_cust_usr
left join global.global_auth_poli c on c.poli_id = a.id_poli";
$sql .=" where ".implode(" and ",$sql_where);
$sql.= " and cust_usr_jenis_kelamin = 'L' and cust_usr_kode<>'500' and cust_usr_kode<>'100'
and reg_utama is null and  (a.reg_batal is null or reg_batal='n')";
$dataLaki = $dtaccess->Fetch($sql);

$sql = "select count(reg_id) as perempuan from klinik.klinik_registrasi a 
left join global.global_customer_user b on b.cust_usr_id = a.id_cust_usr
left join global.global_auth_poli c on c.poli_id = a.id_poli";
$sql .=" where ".implode(" and ",$sql_where);
$sql.= " and cust_usr_jenis_kelamin = 'P' and cust_usr_kode<>'500' and cust_usr_kode<>'100'
and reg_utama is null and  (a.reg_batal is null or reg_batal='n')";
$dataPerempuan = $dtaccess->Fetch($sql);

$sql = "select count(reg_id) as lama from klinik.klinik_registrasi a 
left join global.global_customer_user b on b.cust_usr_id = a.id_cust_usr
left join global.global_auth_poli c on c.poli_id = a.id_poli";
$sql .=" where ".implode(" and ",$sql_where);
$sql.= " and reg_status_pasien = 'L' and cust_usr_kode<>'500' and cust_usr_kode<>'100'and reg_utama is null and  (a.reg_batal is null or reg_batal='n')";
...
left join global.global_auth_poli c on c.poli_id = a.id_poli";
$sql .=" where ".implode(" and ",$sql_where);
$sql.= " and reg_status_pasien = 'B' and cust_usr_kode<>'500' and cust_usr_kode<>'100' and reg_utama is null and  (a.reg_batal is null or reg_batal='n')";
$dataBaru = $dtaccess->Fetch($sql);
     // echo $sql;
   //  var_dump($dataTable[0]); die();
     

     $tableHeader = "&nbsp;Laporan Registrasi Pasien";
