<?php
     ...
     $editPage = "satuan_edit.php";
	   ...
	   $plx = new expAJAX("CheckDataCustomerTipe,GetComboSatuanBeli");
  ...
  function GetComboSatuanBeli() {
          ...
          { 
            ...
            $opt_satuan[$i] = $view->RenderOption($dataSatuanBeli[$i-1]["satuan_id"],$dataSatuanBeli[$i-1]["satuan_nama"],$show);
          }
     ...
     if ($_POST["btnSave"] || $_POST["btnUpdate"]) {          
          ...
          if ($err_code == 0) {
               ...
               $dbValue[1] = QuoteValue(DPE_CHAR,$_POST["satuan_nama"]); 
			         ...
			         $dbValue[3] = QuoteValue(DPE_CHAR,'B');
...
?>
<?php// echo $view->RenderBody("ipad_depans.css",true,"SATUAN OBAT"); ?>
...
<?php if($simpan==1){ ?>
     self.parent.getComboSatuanBeli();
