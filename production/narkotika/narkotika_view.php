...
$userName = $auth->GetUserName();
     ...
     if ($_POST["btnEdit"]){
     $editPage = "narkotika_view.php?edit=1"; 
     $thisPage = "narkotika_view.php?edit=1"; }
     else {
     $editPage = "narkotika_view.php?edit=1";
     $thisPage = "narkotika_view.php";
     }
  ...
  /*if(!$auth->IsAllowed("apo_setup_generik",PRIV_READ)){
    ...
    /* if($_GET["id_jenis"]){
     ...
     if($sql_where) $sql .= " where a.item_flag ='M' and a.item_aktif='y' and item_narkotika='y' and ".$sql_where;
