...
function sendValue(nama,no,id,urut) {
	self.parent.document.getElementById('prk_nama_bpjs').value = nama;
  self.parent.document.getElementById('prk_no_bpjs').value = no;
	self.parent.document.getElementById('id_prk_bpjs').value = id;
