...
function sendValue(nama,no,id,urut) {
	self.parent.document.getElementById('prk_nama_asuransi').value = nama;
  self.parent.document.getElementById('prk_no_asuransi').value = no;
	self.parent.document.getElementById('id_prk_asuransi').value = id;
