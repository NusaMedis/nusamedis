<?php
    ...
    $ketCito["E"] = "Non CITO";
     ...
     $addPage = "tindakan_detail_add.php?biaya_id=".$_POST["biaya_id"]."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"]."&tambah=1";
     ...
     $editPage = "tindakan_detail_edit.php?biaya_id=".$_POST["biaya_id"]."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"];
     $thisPage = "tindakan_view.php";
     $detailPage = "tindakan_split_detail_view.php?biaya_id=".$_POST["biaya_id"];
     ...
     $tombolKembali = '<input type="button" name="btnKembali" value="Kembali" class="pull-right col-md-12 col-sm-12 col-xs-12 btn btn-primary" onClick="document.location.href=\''.$kembaliPage.'\'"></button>';
      ...
      if($biayaId && $biayaId!="--") $sql_where[] = "a.id_biaya = ".QuoteValue(DPE_CHAR,$biayaId);    
...
//              left join gl.gl_perkiraan f on f.id_prk = a.id_prk_beban
   	  ...
   	  $sql = "select a.*,item_nama,biaya_nama from klinik.klinik_biaya_detil a 
     ...
     $tbHeader[0][$counterHeader][TABLE_ISI] = "Bahan Habis Pakai";
...
//     $counterHeader++; 
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
           ...
           $tbContent[$i][$counter][TABLE_ISI] = $dataTable[$i]["biaya_detil_jumlah"];
           $tbContent[$i][$counter][TABLE_ALIGN] = "left";
           $counter++;
...
//	          $counter++;   
	  ...
	  //        $counter++;
       ...
       // } else {
        ...
        if($isAllowedUpdate)
        {
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'&id='.$enc->Encode($dataTable[$i]["biaya_detil_id"]).'"><img hspace="2" width="25" height="25" src="'.$ROOT.'gambar/icon/edit.png" alt="Edit" title="Edit" border="0"></a>';
        } else {
               $tbContent[$i][$counter][TABLE_ISI] = '&nbsp;';                
        }
               $tbContent[$i][$counter][TABLE_ALIGN] = "center";
          ...
          if($isAllowedDel){
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'&id_del='.$dataTable[$i]["biaya_detil_id"].'&del=1"><img hspace="2" width="25" height="25" src="'.$ROOT.'gambar/icon/hapus.png" alt="Hapus" title="Hapus" border="0" onclick="javascript: return Hapus();"></a>';
               $tbContent[$i][$counter][TABLE_ALIGN] = "center";
               $counter++;
          }			    
    }
     ...
     $sql = "select biaya_nama from klinik.klinik_biaya where biaya_id = ".QuoteValue(DPE_CHAR,$biayaId);
     $TindakanNama = $dtaccess->Fetch($sql);
          ...
          <div class="">
			...
			<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Nama Tindakan : <?php echo $TindakanNama["biaya_nama"];?></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
