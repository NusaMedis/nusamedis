	...
	elseif($_x_mode=="Edit") $privMode = PRIV_UPDATE;
     ...
     { 
          ...
          if($_POST["btnUpdate"])
          {
               ...
               {
                 $dbField[7] = "id_prk";
                 $dbField[8] = "biaya_paket";
                 $dbField[9] = "id_prk_beban";
               }
               ...
               {
                 $dbValue[7] = QuoteValue(DPE_CHAR,$_POST["id_prk"]);
                 $dbValue[8] = QuoteValue(DPE_CHAR,$_POST["biaya_paket"]);
                 $dbValue[9] = QuoteValue(DPE_CHAR,$_POST["id_prk_beban"]);
               }              
                //print_r($dbValue);
                //die();
