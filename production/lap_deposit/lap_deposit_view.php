...
//if($_POST["btnLanjut"])   
//{   
$sql = "select a.*,b.*,c.*,jbayar_nama, jenis_nama from klinik.klinik_deposit_history a
                      ...
                      <tbody>
                        ...
                        <?php 
                          for ($i=0; $i < count($dataTable); $i++) { 
                            ...
                            if ($TglKredit['deposit_history_tgl'] <= date_db($_POST['tgl_akhir']) && $TglKredit['deposit_history_tgl']) {
