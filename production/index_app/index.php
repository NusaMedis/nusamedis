...
// ini_set('display_errors', 1);
     ...
     $sql = "select count(cust_usr_id) as jumlah from global.global_customer_user 
            where cust_usr_id in (select id_cust_usr from klinik.klinik_registrasi where reg_tanggal = '$tgl' and reg_tipe_rawat != 'I')and id_dep ='$depId'";
     $pengunjung = $dtaccess->Fetch($sql);

     // echo $sql ;

     $sql = "select count(cust_usr_id) as jumlah from global.global_customer_user 
            where cust_usr_id in (select id_cust_usr from klinik.klinik_registrasi where reg_tanggal = '$tgl' and reg_tipe_rawat != 'I' and reg_jenis_pasien = '2')and id_dep ='$depId'";
     ...
     $sql = "select count(cust_usr_id) as jumlah from global.global_customer_user 
            where cust_usr_id in (select id_cust_usr from klinik.klinik_registrasi where reg_tanggal = '$tgl' and reg_tipe_rawat != 'I' and reg_status != 'A0' and reg_status_pasien = 'L')and id_dep ='$depId'";
     $pengunjung_lama = $dtaccess->Fetch($sql);

     $sql = "select count(cust_usr_id) as jumlah from global.global_customer_user 
            where cust_usr_id in (select id_cust_usr from klinik.klinik_registrasi where reg_tanggal = '$tgl' and reg_tipe_rawat != 'I' and reg_status != 'A0' and reg_status_pasien = 'B')and id_dep ='$depId'";
     $pengunjung_baru = $dtaccess->Fetch($sql);



     $sql = "select avg(klinik_waktu_tunggu_durasi_detik) as waktu_tunggu from klinik.klinik_waktu_tunggu a
     LEFT JOIN global.global_auth_poli b on b.poli_id = a.id_poli
     where klinik_waktu_tunggu_when_create  >= '$tgl 00:00:00' and klinik_waktu_tunggu_when_create  <= '$tgl 23:59:59' and id_dep ='$depId'";
     ...
     and a.reg_tanggal = '$tgl' and a.reg_jenis_pasien = '2' and a.reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     and a.reg_jenis_pasien = '5' and a.reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     and a.reg_jenis_pasien = '7' and a.reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     where a.reg_batal is null and poli_nama not ilike '%Apotek%' 
     and poli_nama <> 'Laboratorium' and a.reg_tanggal = '$tgl' 
     and a.reg_jenis_pasien = '20' and a.reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     where a.reg_batal is null and poli_nama not ilike '%Apotek%' 
     and poli_nama <> 'Laboratorium' and a.reg_tanggal = '$tgl' 
     and a.reg_jenis_pasien = '2' and a.reg_tipe_rawat = 'I' and b.id_dep ='$depId'";
     ...
     left join global.global_auth_poli b on b.poli_id = a.id_poli 
     where a.reg_batal is null and poli_nama not ilike '%Apotek%' and a.reg_tanggal = '$tgl' and b.id_dep ='$depId'
     ...
     left join global.global_auth_poli b on b.poli_id = a.id_poli
      ...
      and cust_usr_kode<>'500' and cust_usr_kode<>'100' and reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     left join global.global_auth_poli b on b.poli_id = a.id_poli
      ...
      poli_nama <> 'Laboratorium' and a.reg_tanggal >= '$tgl' and a.reg_tanggal <= '$tgl'
      and (a.reg_utama is null or a.reg_utama ='' or a.id_poli = a.id_poli_asal) 
      and cust_usr_kode<>'500' and cust_usr_kode<>'100' and a.reg_status_pasien = 'L' and reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     left join global.global_auth_poli b on b.poli_id = a.id_poli
      ...
      poli_nama <> 'Laboratorium' and a.reg_tanggal >= '$tgl' and a.reg_tanggal <= '$tgl'
      and (a.reg_utama is null or a.reg_utama ='' or a.id_poli = a.id_poli_asal) 
      and cust_usr_kode<>'500' and cust_usr_kode<>'100' and a.reg_status_pasien = 'B' and reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     left join global.global_auth_poli b on b.poli_id = a.id_poli
      ...
      poli_nama <> 'Laboratorium' and a.reg_tanggal >= '$tgl' and a.reg_tanggal <= '$tgl'
      and (a.reg_utama is null or a.reg_utama ='' or a.id_poli = a.id_poli_asal) 
      and cust_usr_kode<>'500' and cust_usr_kode<>'100' and a.reg_jenis_pasien = '2' and reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     left join global.global_auth_poli b on b.poli_id = a.id_poli
      ...
      poli_nama <> 'Laboratorium' and a.reg_tanggal >= '$tgl' and a.reg_tanggal <= '$tgl'
      and (a.reg_utama is null or a.reg_utama ='' or a.id_poli = a.id_poli_asal) 
      and cust_usr_kode<>'500' and cust_usr_kode<>'100' and a.reg_jenis_pasien = '7' and reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     left join global.global_auth_poli b on b.poli_id = a.id_poli
      ...
      poli_nama <> 'Laboratorium' and a.reg_tanggal >= '$tgl' and a.reg_tanggal <= '$tgl'
      and (a.reg_utama is null or a.reg_utama ='' or a.id_poli = a.id_poli_asal) 
      and cust_usr_kode<>'500' and cust_usr_kode<>'100' and a.reg_jenis_pasien = '20' and reg_tipe_rawat != 'I' and b.id_dep ='$depId'";
     ...
     left join global.global_auth_poli b on b.poli_id = a.id_poli
      ...
      poli_nama <> 'Laboratorium' and a.reg_tanggal >= '$tgl' and a.reg_tanggal <= '$tgl'
      and (a.reg_utama is null or a.reg_utama ='' or a.id_poli = a.id_poli_asal) 
      and cust_usr_kode<>'500' and cust_usr_kode<>'100' and a.reg_jenis_pasien = '5' and reg_tipe_rawat != 'I'and b.id_dep ='$depId'";
     ...
     and (a.reg_utama is null or a.reg_utama ='' or a.id_poli = a.id_poli_asal) 
     and cust_usr_kode<>'500' and cust_usr_kode<>'100'and b.id_dep ='$depId'";
