<?php
  ...
  $backPage = "hasil_lab_view.php?id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"];
...
*/  
  ...
  if ($_GET["del"]) 
  {
          ...
          else
          {
            ...
            echo "<script>document.location.href='hasil_lab_view.php?klinik=".$_GET["id_dep"]."&id_kategori_tindakan_header=".$_GET["id_kategori_tindakan_header"]."&id_poli=".$_POST["id_poli"]."&dep_lowest=".$_POST["dep_lowest"]."&id_tahun_tarif=".$_GET["id_tahun_tarif"]."';</script>";
          }
