...
$addPage = "hasil_lab_edit.php?id_kategori_tindakan_header_instalasi=" . $_POST["id_kategori_tindakan_header_instalasi"] . "&id_kategori_tindakan_header=" . $_POST["id_kategori_tindakan_header"] . "&biaya_kategori=" . $_POST["biaya_kategori"] . "&tambah=1";
$editPage = "hasil_lab_edit.php?id_kategori_tindakan_header_instalasi=" . $_POST["id_kategori_tindakan_header_instalasi"] . "&id_kategori_tindakan_header=" . $_POST["id_kategori_tindakan_header"] . "&biaya_kategori=" . $_POST["biaya_kategori"];
$editPage1 = "tindakan_edit.php";
...
$tbHeader[0][$counterHeader][TABLE_ISI] = "Tindakan Lab Urut";
$tbHeader[0][$counterHeader][TABLE_WIDTH] = "5%";
$counterHeader++;
...
$tbHeader[0][$counterHeader][TABLE_ISI] = "Edit Tindakan";
$tbHeader[0][$counterHeader][TABLE_WIDTH] = "4%";
$counterHeader++;
...
for ($i = 0, $counter = 0, $n = count($dataTable); $i < $n; $i++, $counter = 0) {
  ...
  $sql = "select count(hasil_lab_id) as jumlah_hasil from  klinik.klinik_hasil_lab";
  ...
  $tbContent[$i][$counter][TABLE_ISI] = "&nbsp;&nbsp;" . $dataTable[$i]["tindakan_lab_urut"];
  $tbContent[$i][$counter][TABLE_ALIGN] = "left";
  $counter++;
  ...
  if ($dataTotalHasilLab['jumlah_hasil'] == '0') {
    $tbContent[$i][$counter][TABLE_ISI] = "Tidak";
  } else {
    $tbContent[$i][$counter][TABLE_ISI] = "Ada";
  }
  $tbContent[$i][$counter][TABLE_ALIGN] = "center";
  $counter++;

  $tbContent[$i][$counter][TABLE_ISI] = '<a href="' . $editPage1 . '?id=' . ($dataTable[$i]["biaya_id"]) . '"><img hspace="2" width="25" height="25" src="' . $ROOT . 'gambar/icon/edit.png" alt="Edit Tindakan" title="Edit Tindakan" border="0"></a>';
    $tbContent[$i][$counter][TABLE_ALIGN] = "center";
    $counter++;

  if ($isAllowedUpdate) {
    $tbContent[$i][$counter][TABLE_ISI] = '<a href="' . $detailPage . '?id=' . ($dataTable[$i]["biaya_id"]) . '"><img hspace="2" width="25" height="25" src="' . $ROOT . 'gambar/icon/cari.png" alt="Hasil Lab" title="Hasil Lab" border="0"></a>';
    $tbContent[$i][$counter][TABLE_ALIGN] = "center";
    $counter++;
  }
        ...
        <div class="">
          ...
          <div class="row">
            ...
            <select name="biaya_jenis" class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);" >
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                      <label class="control-label col-md-12 col-sm-12 col-xs-12">&nbsp;</label>
                      <a href="import_hasil_lab.php?kode=<?= date('YmdHis') ?>" class="btn btn-danger col-md-12">Import</a>
                    </div>
