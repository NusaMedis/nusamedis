<?php 
     ...
     function CekTracer() 
	 {
	  ...
	  $sql .=" where (reg_tracer is null or reg_tracer='n')  and reg_tracer_pending ='n' and ( reg_utama is null or reg_utama = '' ) ";
       ...
       // -- end paging config ---//      
        ...
        $sql_where[] = "DATE(reg_tanggal) <= ".QuoteValue(DPE_DATE,date_db($in_tglakh));
          ...
          $sql = "select b.cust_usr_nama,b.cust_usr_kode,b.cust_usr_tempat_lahir,b.cust_usr_tanggal_lahir,
                  ...
                  and a.id_dep like '".$depId."' and (reg_tracer is null or reg_tracer='n') 
...
function ProsesCetakBarcode(id_reg) {
  BukaWindow('cetak_tracer.php?id_reg='+id_reg+'','Cetak Tracer');
