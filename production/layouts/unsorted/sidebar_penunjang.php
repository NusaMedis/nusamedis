                ...
                <ul class="nav side-menu">           
                   ...
                   <li><a style="font-size:15px"><i class="glyphicon glyphicon-bed"></i>&nbsp;&nbsp; Proses <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">                      
                      <li><a href="<?php echo $ROOT; ?>pemeriksaan_hd/pemeriksaan_hd_view.php" target="_blank" style="font-size:15px">Pemeriksaan Hemodialisa</a></li>
                    </ul>
                  </li> 
                  <li><a style="font-size:15px"><i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;&nbsp; Informasi <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo $ROOT; ?>lap_kunjungan_penunjang/lap_kunjungan.php" target="_blank" style="font-size:15px">Laporan Kunjungan</a></li>
          					  <li><a href="<?php echo $ROOT; ?>lap_tindakan/lap_tindakan.php" target="_blank" style="font-size:15px">Laporan Tindakan</a></li>
          					  <li><a href="<?php echo $ROOT; ?>lap_waktu_tunggu_penunjang/rekap_waktu_tunggu.php" target="_blank" style="font-size:15px">Laporan Waktu Tunggu</a></li>
                    </ul>
                  </li>                   
