                ...
                <ul class="nav side-menu">           
                  <li><a style="font-size:15px"><i class="glyphicon glyphicon-th"></i>&nbsp;&nbsp; Master <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">  
                      <li><a href="<?php echo $ROOT; ?>master_jaspel/jenis_biaya_view.php" target="_blank" style="font-size:15px">Master Jaspel</a></li> 
                      <li><a href="<?php echo $ROOT; ?>master_remunerasi/remunerasi_view.php" target="_blank" style="font-size:15px">Master Remunerasi</a></li> 
                    </ul>
                   </li>                 
                  <li><a style="font-size:15px"><i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;&nbsp; Informasi <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo $ROOT; ?>lap_remunerasi/remunerasi_view.php" target="_blank" style="font-size:15px">Lap. Remunerasi</a></li>
                    </ul>
                  </li>                   
