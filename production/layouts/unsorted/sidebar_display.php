                ...
                <ul class="nav side-menu">           
                  <li><a style="font-size:15px"><i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;&nbsp; Informasi <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo $ROOT; ?>display_bor/antrian.php" target="_blank" style="font-size:15px">BOR</a></li>
                      <li><a href="<?php echo $ROOT; ?>display_rawat_inap/rawat_inap.php" target="_blank" style="font-size:15px">Pasien Ranap</a></li>
                      <li><a href="<?php echo $ROOT; ?>display_operasi/operasi.php" target="_blank" style="font-size:15px">Jadwal Operasi</a></li>
                      <li><a href="<?php echo $ROOT; ?>display_igd/ugd.php" target="_blank" style="font-size:15px">IGD</a></li>
                    </ul>
                  </li>                   
