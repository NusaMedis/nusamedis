                  ...
                  <li><a><i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp; LOKET <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        ...
                        <li><a><i class="glyphicon glyphicon-file"></i>&nbsp;Cetak Tracer<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li><a href="<?php echo $ROOT; ?>tracer_irj_lama/tracer_irj_lama_view.php" target="blank" style="font-size:15px">Cetak Tracer</a></li>
                            <li><a href="<?php echo $ROOT; ?>tracer_irj_lama_barcode/tracer_irj_lama_barcode_view.php" target="blank" style="font-size:15px">Cetak Barcode Kecil</a></li>
                            <li><a href="<?php echo $ROOT; ?>tracer_irj_lama_barcode_besar/tracer_irj_lama_barcode_view.php" target="blank" style="font-size:15px">Cetak Barcode Besar</a></li>
                            <li><a href="<?php echo $ROOT; ?>tracer_registrasi/tracer_registrasi_view.php" target="blank" style="font-size:15px">Cetak Registrasi</a></li>
                            <li><a href="<?php echo $ROOT; ?>tracer_riwayat/tracer_riwayat_view.php" target="blank" style="font-size:15px">Cetak Riwayat</a></li>
                            <!--<li><a href="<?php echo $ROOT; ?>tracer_status/tracer_status_view.php" target="blank" style="font-size:15px">Cetak Barcode Kecil</a></li>-->
                          </ul>
                        </li>
                        ...
                        <li><a style="font-size:15px"><i class="glyphicon glyphicon-refresh"></i>&nbsp;Koneksi <span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li><a href="<?php echo $ROOT; ?>../../antrian_pasien/index.php" target="blank" style="font-size:15px">Antrian Pasien</a></li>
                          </ul>
                        </li>
                  ...
                  <li><a><i class="glyphicon glyphicon-bed"></i>&nbsp;&nbsp; RAWAT INAP <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                       <li><a style="font-size:15px"><i class="glyphicon glyphicon-bed"></i>&nbsp;&nbsp; Proses <span class="fa fa-chevron-down"></span></a>
                        ...
                        <li><a style="font-size:15px"><i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;&nbsp; Informasi <span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <? if($auth->IsAllowed("rawat_inap_lap_pengunjung",PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>lap_pengunjung_irna/report_pasien.php" target="blank" style="font-size:15px">Laporan Pengunjung</a></li><? } ?>
                            <? if($auth->IsAllowed("rawat_inap_lap_penggunaan_bed",PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>lap_penggunaan_bed/penggunaan_bed.php" target="blank" style="font-size:15px">Laporan Penggunaan Bed</a></li><? } ?>
                  ...
                  <li><a><i class="glyphicon glyphicon-ice-lolly"></i>&nbsp;&nbsp; BPJS <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        ...
                        <li><a style="font-size:15px"><i class="glyphicon glyphicon-list-alt"></i>&nbsp&nbsp&nbsp Informasi <span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <? if($auth->IsAllowed("lap_kunjungan_bpjs",PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>lap_kunjungan_irj/lap_kunjungan.php" target="blank" style="font-size:15px">Laporan Kunjungan</a></li>  <? } ?>
                            <? if($auth->IsAllowed("lap_kunjungan_bpjs",PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>lap_pemb_jaminan/report_setoran_loket.php" target="blank" style="font-size:15px">Laporan Pendapatan</a></li>  <? } ?>
                            <? if($auth->IsAllowed("lap_kunjungan_bpjs",PRIV_READ)) { ?><li><a href="<?php echo $ROOT; ?>lap_jaminan/report_setoran_cicilan.php" target="blank" style="font-size:15px">Laporan Jaminan</a></li>  <? } ?>
                        ...
                        <li><a style="font-size:15px"><i class="glyphicon glyphicon-file"></i>&nbsp&nbsp&nbsp Dokumentasi <span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li><a href="<?php echo $ROOT; ?>user_guide/user_guide_bpjs.pdf" target="blank" style="font-size:15px">User Guide</a></li>
                          </ul>
                        </li>                   
