...
// atau misal sprintf("%03s", 1); maka akan dihasilkan string '001'
  ...
  $dbField[9] = "klinik_waktu_tunggu_create";
  // $dbField[10] = "klinik_waktu_tunggu_durasi";
  // $dbField[11] = "klinik_waktu_tunggu_durasi_detik";

  $dbField[10] = "who_update";
  ...
  $dbValue[9] = QuoteValue(DPE_DATE,$_POST['waktu_awal']);
  ...
  $sqlScreen="select id,id_reg from klinik.klinik_igd_serialize where id_cust_usr=". QuoteValue(DPE_CHAR,$custUsrId)." and diperbarui <= '$date' order by diperbarui desc  limit 1";
  $dataScreen= $dtaccess->Fetch($sqlScreen);
  echo $sqlScreen;
  /* Pengecekan Sudah Ada Screening */



  if (is_null($dataScreen["id_reg"]) ) {
    $sql="UPDATE klinik.klinik_igd_serialize set id_reg=".QuoteValue(DPE_CHAR,$regId)." where id =".QuoteValue(DPE_CHAR,$dataScreen['id']);
