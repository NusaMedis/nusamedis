<?php
  ...
  /* SQL TINDAKAN */      
  $sql = "select a.*,b.*, c.* from klinik.klinik_biaya_registrasi a left join klinik.klinik_biaya b on a.id_biaya = b.biaya_id left join klinik.klinik_biaya_tarif c on b.biaya_id = c.id_biaya where 1=1 and a.biaya_registrasi_tipe = 'L' and c.id_jenis_pasien = ".QuoteValue(DPE_NUMERICKEY,$_POST["reg_jenis_pasien"]); 
