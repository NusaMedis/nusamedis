<?php    
  ...
  if ($_POST["reg_jenis_layanan"]=='rj') $jnsPelayanan="2";
  else $jnsPelayanan="1";

  if ($_POST["reg_sebab_sakit"]=='4') $_POST["reg_lakalantas"] ='1';
  else $_POST["reg_lakalantas"] ='0';

  if (!$_POST["cob"]) $_POST["cob"] ='0';
  else $_POST["cob"] ='1';

  if (!$_POST["asal_faskes_rujuk"]) $_POST["asal_faskes_rujuk"] ='1';
  else $_POST["asal_faskes_rujuk"] ='2';
