...
if ($_POST["btn"]) {
	...
	$sql = "select cust_usr_id,cust_usr_kode,cust_usr_kode_tampilan, cust_usr_nama, cust_usr_tanggal_lahir, cust_usr_alamat,cust_usr_penanggung_jawab,id_dep
				from global.global_customer_user";
	$sql .= " WHERE 1=1 and id_dep = '$depId'";
	$sql .= " and " . $sql_where;
