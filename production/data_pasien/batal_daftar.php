...
$sql = "select count(reg_id) as rows from klinik.klinik_registrasi where id_cust_usr = ".QuoteValue(DPE_CHAR,$_GET['id']);
$RiwayatRegistrasi = $dtaccess->Fetch($sql);
if ($RiwayatRegistrasi['rows'] == '0') {
