<?php
     ...
     // PRIVILLAGE
    if(!$auth->IsAllowed("apo_re_lapretjual",PRIV_READ)){
          echo"<script>window.document.location.href='".$ROOT."expire.php'</script>";
          exit(1);
          
     } elseif($auth->IsAllowed("apo_re_lapretjual",PRIV_READ)===1){
...
<?php //echo $view->RenderBody("module.css",true,true,"LAP. RETUR PENJUALAN"); ?>
<br /><br /><br /><br />
