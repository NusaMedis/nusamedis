                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                              <select class="form-control" name="id_struk" id="id_struk" required="required" onKeyDown="return tabOnEnter(this, event);">								
                  ...
                  <div class="x_content">
					<div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <input name="btnUpdate" class="btn btn-default col-md-5 col-sm-5 col-xs-12 pull-left" type="submit" value="Simpan">
                            <input name="btnKembali" onClick="document.location.href='<?php echo $backPage;?>'" class="btn btn-default col-md-5 col-sm-5 col-xs-12 pull-right" type="button" value="Kembali"> 
                        </div>
                      </div>
                  </div>
