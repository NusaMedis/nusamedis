<?php
    ...
    $sql = "select a.*, b.*, c.*, d.*
        ...
        and a.fol_nama <> '' and a.id_poli <> '33' and a.id_biaya <> '9999999' and id_pembayaran =".QuoteValue(DPE_CHAR,$_POST["id_pembayaran"])." order by kategori_kassa_id, a.id_biaya, fol_nama asc" ;
        $dataFolio = $dtaccess->FetchAll($sql);
//echo $sql;
    $sql = "select a.*
        from klinik.klinik_folio a
        where a.id_biaya = '9999999' and id_pembayaran =".QuoteValue(DPE_CHAR,$_POST["id_pembayaran"]);
