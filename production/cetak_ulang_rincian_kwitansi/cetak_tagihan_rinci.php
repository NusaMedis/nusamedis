...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse; font-size:8px;">                                   
  ...
  <tr>
    <td width="35%" align="left" colspan='8'>JASA RS : <b><?php echo currency_format($dataPasien["pembayaran_det_service_cash"]);?></b></td>
    
  </tr>
  <tr>
    <td width="35%" align="left" colspan='8'>TOTAL TAGIHAN : <b><?php echo currency_format($dataPasien["pembayaran_det_hrs_bayar"]);?></b></td>
