...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse"> 
  ...
  <tr>
    ...
    <td width = "1%">:</td> 
    <td  align="center" width="1%"></td>  
    <td  align="left" width="20%">&nbsp;<?php if($dataDiskon["pembayaran_det_total"]<>$dataDiskon["pembayaran_det_dibayar"]) {echo terbilang($dataDiskon["pembayaran_det_dibayar"]);} else echo terbilang($dataDiskon["pembayaran_det_dibayar"]);?> Rupiah</td>  
  </tr>
</table>
<br>
