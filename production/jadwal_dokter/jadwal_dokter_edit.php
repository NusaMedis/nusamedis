	...
	elseif($_x_mode=="Edit") $privMode = PRIV_UPDATE;
     ...
     { 
          ...
          if($_POST["btnUpdate"])
          {
               ...
               $dbField[1] = "id_instalasi";  
               $dbField[2] = "id_sub_instalasi";
               $dbField[3] = "id_poli";
               $dbField[4] = "id_dokter";
               $dbField[5] = "jadwal_dokter_hari";
               $dbField[6] = "jadwal_dokter_jam_mulai";
               $dbField[7] = "jadwal_dokter_jam_selesai";


               if(!$jadwalDokterId) $jadwalDokterId = $dtaccess->GetTransId();   
               $dbValue[0] = QuoteValue(DPE_CHAR,$jadwalDokterId);
               $dbValue[1] = QuoteValue(DPE_CHAR,$_POST["id_instalasi"]);   
               $dbValue[2] = QuoteValue(DPE_CHAR,$_POST["id_sub_instalasi"]);   
               $dbValue[3] = QuoteValue(DPE_CHAR,$_POST["id_poli"]);
               $dbValue[4] = QuoteValue(DPE_CHAR,$_POST["id_dokter"]);
               $dbValue[5] = QuoteValue(DPE_NUMERIC,$_POST["jadwal_dokter_hari"]);
               $dbValue[6] = QuoteValue(DPE_CHAR,$_POST["jadwal_dokter_jam_mulai"]);
               $dbValue[7] = QuoteValue(DPE_CHAR,$_POST["jadwal_dokter_jam_selesai"]);
                  ...
                  <select name="jadwal_dokter_hari" class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);" >
                    ...
                    <option class="inputField" value="7" <?php if ($_POST["jadwal_dokter_hari"]=='7') echo"selected"?>>Minggu</option>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php echo $view->RenderTextBox("jadwal_dokter_jam_mulai","jadwal_dokter_jam_mulai","85","100",$_POST["jadwal_dokter_jam_mulai"],"inputField", null,false);?>
						</div>
					  </div> 
            <div class="form-group">
