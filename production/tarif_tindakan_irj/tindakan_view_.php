...
//	          $counter++;   
	  ...
	  //        $counter++;
        ...
        if($isAllowedUpdate)
        {
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$detailPage.'&biaya_id='.$dataTable[$i]["biaya_id"].'&id='.$enc->Encode($dataTable[$i]["biaya_tarif_id"]).'"><img hspace="2" width="25" height="25" src="'.$ROOT.'gambar/icon/cari.png" alt="Edit" title="Edit" border="0"></a>';
        } else {
               $tbContent[$i][$counter][TABLE_ISI] = '&nbsp;';                
        }
               $tbContent[$i][$counter][TABLE_ALIGN] = "center";
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <label class="control-label col-md-12 col-sm-12 col-xs-12">Nama Kategori Tindakan Header Instalasi</label>
						<select name="id_kategori_tindakan_header" id="id_kategori_tindakan_header_instalasi" class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);" >
                ...
                <option class="inputField" value="<?php echo $dataKategoriTindakanHeaderInstalasi[$i]["klinik_kategori_tindakan_header_instalasi_id"];?>">
                  <?php echo $dataKategoriTindakanHeaderInstalasi[$i]["klinik_kategori_tindakan_header_instalasi_nama"];?>&nbsp;
                </option>
            ...
            <label class="control-label col-md-12 col-sm-12 col-xs-12">Nama Kategori Tindakan Header</label>
						<select name="id_kategori_tindakan_header" id="id_kategori_tindakan_header"  class="select2_single form-control"  onKeyDown="return tabOnEnter_select_with_button(this, event);" >
				    ...
				    <div class="col-md-4 col-sm-6 col-xs-12">
						...
						<select name="biaya_kategori" id="biaya_kategori" class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);" >
            ...
            <select name="jenis_pasien" class="select2_single form-control" >
                ...
                <option class="inputField" value="<?php echo $dataJenisPasien[$i]["jenis_id"];?>"<?php if ($_POST["jenis_pasien"]==$dataJenisPasien[$i]["jenis_id"]) echo"selected"?>><?php echo $dataJenisPasien[$i]["jenis_nama"];?>&nbsp;</option>
                <?php } ?>
              </select> 
            </div>    -->
...
<?php if($_x_mode=="cetak"){ ?>	
  window.open('tindakan_cetak.php?id_kategori_tindakan_header_instalasi=<?php echo $_POST["id_kategori_tindakan_header_instalasi"];?>&id_kategori_tindakan_header=<?php echo $_POST["id_kategori_tindakan_header"];?>&biaya_kategori=<?php echo $_POST["biaya_kategori"];?>', '_blank');
<?php } ?>



  $('#id_kategori_tindakan_header_instalasi').on('change', function(event) {
    event.preventDefault();
    alert('test');
    $.ajax({
      url: 'tindakan_api.php',
      type: 'GET',
      dataType: 'html',
      data: {id_kategori_tindakan_header_instalasi: $(this).val()},
      success: function (res) {
        $('#id_kategori_tindakan_header').html(res);
        // alert(res);
      }
    })
  ...
  $('#id_kategori_tindakan_header').on('change', function(event) {
    event.preventDefault();
    ...
    $.ajax({
      ...
      type: 'GET',
      dataType: 'html',
      data: {id_kategori_tindakan_header: $(this).val()},
      success: function (res) {
        $('#biaya_kategori').html(res);
        // alert(res)
      }
    })
