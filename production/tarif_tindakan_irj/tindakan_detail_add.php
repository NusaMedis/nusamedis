           ...
           <div class="form-group">
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Jenis Pasien  <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select required name="id_jenis_pasien" id="id_jenis_pasien" class="select2_single form-control">
            ...
            <div class="form-group" id="id_jenis_kelas_container" style="display: none">
             ...
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tgl Awal Tarif Tindakan  <span class="required">*</span>
              ...
              <div class='input-group date' id='datepicker'>
                  <input required  name="biaya_tarif_tgl_awal"  id="biaya_tarif_tgl_awal" data-inputmask="'mask': '99-99-9999'" type='text' class="form-control" value="<?=$_POST['biaya_tarif_tgl_awal']?>">
