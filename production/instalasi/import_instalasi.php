<?php
    ...
    if(isset($_POST["btnImport"])){
      ...
      if ((!$myFile = @fopen(stripslashes($csvFile), "r")) || $err==true) {
        ...
        while ($data = fgetcsv($myFile, 500000, $delimiter))  {
          if($data[0]) {
            $dbTable = "temp.global_auth_instalasi";

            $dbField[] = "instalasi_id";   // PK
            $dbField[] = "instalasi_nama";
            $dbField[] = "instalasi_kode";
            $dbField[] = "id_dep";
            $dbField[] = "instalasi_flag";
            $dbField[] = "instalasi_urut";
            ...
            $dbValue[] = QuoteValue(DPE_CHAR, 'y');
            $dbValue[] = QuoteValue(DPE_CHAR, $dtaccess->GetNewID("global.global_auth_instalasi","instalasi_urut",DB_SCHEMA_GLOBAL));
        ...
        $sql = "SELECT * FROM temp.global_auth_instalasi ORDER BY instalasi_nama ASC";
  ...
  /* KLIK APPROVE */
    if(isset($_POST["btnApprove"])){
      $sql = "INSERT INTO global.global_auth_instalasi SELECT * FROM temp.global_auth_instalasi WHERE UPPER(instalasi_nama) NOT IN (SELECT UPPER(instalasi_nama) FROM global.global_auth_instalasi)";
      $dtaccess->Execute($sql);

      $sql = "DELETE FROM temp.global_auth_instalasi";
      $dtaccess->Execute($sql);

      header("Location: instalasi_view.php");
      exit();
    }
  /* KLIK APPROVE */
?>
                      ...
                      <div class="x_content">
                            ...
                            <table class="table table-bordered">
                              ...
                              <tr>
                                <td colspan="2" align="right">
                                  ...
                                  <a href="instalasi_view.php" class="btn btn-danger">Kembali</a>
                                </td>
                              </tr>
                            </table>
                          </form>
                        ...
                        <!-- Syarat Import -->
                          <font size="2" color="red">
                            ...
                            &nbsp;&nbsp;Kolom 1 &nbsp;&nbsp;: Kode Instalasi <br />
                            &nbsp;&nbsp;Kolom 2 &nbsp;&nbsp;: Nama Instalasi <br />
                            &nbsp;&nbsp;Untuk Contoh data silahkan klik 
                            <a href="import_instalasi.csv">disini</a> <br>
                          </font>
                        <!-- Syarat Import -->
                      </div>
                    <!-- Sebelum Import -->
