                  ...
                  <div class="x_content">
                    <br />
                     ...
                     <div class="item form-group">
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input id="cust_usr_nama" name="cust_usr_nama" value="<?php echo str_replace("*","'", $_POST["cust_usr_nama"]);?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="dua kata contoh:Moch Mansyur" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                     ...
                     <div class="item form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <div class="col-md-5 col-sm-5 col-xs-5">
                                <select class="form-control" name="cust_usr_gol_darah" id="cust_usr_gol_darah">   
                                    <option <?php if ($_POST['cust_usr_gol_darah'] = '-') { echo "selected"; } ?> value="-">Tidak Tahu</option>  
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dusun">Nama Desa/Kelurahan <span class="required">&nbsp;</span>
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          ...
                          <select class="form-control" name="id_prop" id="id_prop" onchange="pilih_kota(this.value)">
                            <?php for($i=0,$n=count($dataProvinsi);$i<$n;$i++) { ?>  
                              <option value="<?php echo $dataProvinsi[$i]['lokasi_propinsi'];?>" 
                                <?php if($dataProvinsi[$i]["lokasi_propinsi"]==$row_edit["id_prop"]) { echo "selected"; } elseif($dataProvinsi[$i]["lokasi_propinsi"]==$konf['dep_kode_prop']) echo "selected";?>><?php echo $dataProvinsi[$i]['lokasi_nama'];?>
                              </option>';
                            <? } ?>                                                                   
