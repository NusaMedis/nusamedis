<?php
   ...
   // LIBRARY
	 ...
	 echo json_encode(array(
				...
				"cust_usr_tanggal_lahir_penanggung_jawab"=> $row['cust_usr_tanggal_lahir_penanggung_jawab'],
				"cust_usr_umur_penanggung_jawab"=> $row['cust_usr_umur_penanggung_jawab'],
				"cust_usr_penanggung_jawab_pekerjaan"=> $row['cust_usr_penanggung_jawab_pekerjaan']
			));
