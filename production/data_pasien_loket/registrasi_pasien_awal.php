<?php    
    ...
    {                               
		...
		$sql = "select cust_usr_id,cust_usr_kode,cust_usr_kode_tampilan, cust_usr_nama, cust_usr_tanggal_lahir, cust_usr_alamat 
					...
					<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
						...
						<tr>
						  ...
						  <td><?php echo str_replace("*", "'", $row[$i]['cust_usr_nama']);?></td>
