...
if ($_POST['ref'] == 'irj') {
	$backPage = "../registrasi_irj/registrasi_irj_view.php?usr_id=";
} elseif ($_POST['ref'] == 'irj_bpjs') {
	$backPage = "../registrasi_irj_bpjs/registrasi_bpjs_view.php?usr_id=";
} elseif ($_POST['ref'] == 'igd') {
	$backPage = "../registrasi_igd/registrasi_igd_view.php?usr_id=";
} elseif ($_POST['ref'] == 'igd_bpjs') {
	$backPage = "../registrasi_igd_bpjs/registrasi_bpjs_view.php?usr_id=";
} elseif ($_POST['ref'] == 'irna') {
	$backPage = "../registrasi_irna/registrasi_irna_view.php?usr_id=";
} elseif ($_POST['ref'] == 'radiologi') {
	$backPage = "../registrasi_radiologi/registrasi_radiologi_view.php?usr_id=";
} elseif ($_POST['ref'] == 'radiologi_luar') {
	$backPage = "../radiologi_luar/registrasi_radiologi_view.php?usr_id=";
} else {
	$backPage = "data_pasien_view.php?usr_id=";
}
...
if ($_GET["id"]) {
  ...
  //echo $hitungUmur."-".floor($umurtahun)."-".floor($umurbulan)."-".floor($umurhari);
	...
	$umurtahun_pj = (strtotime(date("Y-m-d")) - strtotime(date_db($_POST["cust_usr_tanggal_lahir_penanggung_jawab"]))) / 86400 / 365;
	$umurbulan_pj = ($umurtahun_pj - floor($umurtahun_pj)) * 12;
	$umurhari_pj = ($umurbulan_pj - floor($umurbulan_pj)) * 31;
  //echo $hitungUmur."-".floor($umurtahun)."-".floor($umurbulan)."-".floor($umurhari);
	$_POST["tahun_pj"] = floor($umurtahun_pj);
	$_POST["bulan_pj"] = floor($umurbulan_pj);
	$_POST["hari_pj"] = floor($umurhari_pj);
...
// if (!$_POST["cust_usr_kode"]) $_POST["cust_usr_kode"] = $_POST["kode_pasien"];
  ...
  $usr_kode =substr( $_POST['kode_rm'],0,2);
  // $arr = str_split($usr_kode, "2");
  $_POST["cust_usr_kode_tampilan"] = $usr_kode.".".substr( $_POST['kode_rm'],2);


// echo $_POST["cust_usr_kode"]."---".$usr_kode_tampilan;
...
if ($_POST["btnSave"] || $_POST["btnUpdate"]) {
	...
	if($rmSama['rmsama']==1 && !$_POST["btnUpdate"]){?>
		<script type="text/javascript">
			alert('Pasien memiliki  No RM sama Mohon Cek Kembali');
  ...
  $dbField[30]="cust_usr_tanggal_lahir_penanggung_jawab";
  $dbField[31] = "cust_usr_umur_penanggung_jawab";
  $dbField[32]="cust_usr_penanggung_jawab_pekerjaan";
  $dbField[33]="cust_usr_penanggung_jawab_pendidikan";
  $dbField[34]="cust_usr_penanggung_jawab_no_hp";

  if (!$custUsrId) $custUsrId = $dtaccess->GetTransID();
  $dbValue[0] = QuoteValue(DPE_CHAR, $custUsrId);
  $dbValue[1] = QuoteValue(DPE_CHAR, STRTOUPPER(str_replace("'", "*", $_POST["cust_usr_nama"])));
  ...
  $dbValue[23] = QuoteValue(DPE_CHAR, $_POST["kode_rm"]);
  $dbValue[24] = QuoteValue(DPE_CHAR, $_POST["cust_usr_kode_tampilan"]);
  $dbValue[25] = QuoteValue(DPE_CHAR, str_replace("'", "*", $_POST["cust_usr_penanggung_jawab"]));
  ...
  $dbValue[30] = QuoteValue(DPE_DATE, date_db($_POST["cust_usr_tanggal_lahir_penanggung_jawab"]));
  $dbValue[31] = QuoteValue(DPE_CHAR, $_POST["tahun_penanggung_jawab"] . "~" . $_POST["bulan_penanggung_jawab"] . "~" . $_POST["hari_penanggung_jawab"]);
  $dbValue[32] = QuoteValue(DPE_CHAR, $_POST["cust_usr_penanggung_jawab_pekerjaan"]);
  $dbValue[33] = QuoteValue(DPE_CHAR, $_POST["cust_usr_penanggung_jawab_pendidikan"]);
  $dbValue[34] = QuoteValue(DPE_CHAR, $_POST["cust_usr_penanggung_jawab_no_hp"]);
...
<script>
  ...
  function TanggalLahir(tanggal) {
    ...
    var month=bulan;
    var tahunlahir = thn;
    var bulanlahir = 12-bulan;
    var harilahir = 30-hari;
    //  n =skrbln+bulan;

    if(bulanlahir < 10 ){
    	var bln = "0"+bulanlahir;
    }
    else{
    	var bln=bulanlahir;
    }
    ...
    document.getElementById("cust_usr_tanggal_lahir").value = hr+"-"+ bln+"-" + Math.floor(tahunlahir);
    // document.getElementById("cust_usr_tanggal_lahir").value = "01-"+ Math.floor(bulanlahir)+ Math.floor(tahunlahir);
    // document.getElementById("cust_usr_tanggal_lahir").value =  Math.floor(harilahir) + Math.floor(bulanlahir)+ Math.floor(tahunlahir);

}

function TanggalLahir_penanggung_jawab(tanggal) {
	umur = document.getElementById("tahun_penanggung_jawab").value;
	bulan = document.getElementById("bulan_penanggung_jawab").value;
	hari = document.getElementById("hari_penanggung_jawab").value;
    ...
    document.getElementById("cust_usr_tanggal_lahir_penanggung_jawab").value = hr+"-"+ bln+"-" + Math.floor(tahunlahir);
    // document.getElementById("cust_usr_tanggal_lahir").value = "01-"+ Math.floor(bulanlahir)+ Math.floor(tahunlahir);
    // document.getElementById("cust_usr_tanggal_lahir").value =  Math.floor(harilahir) + Math.floor(bulanlahir)+ Math.floor(tahunlahir);
...
<body class="nav-md">
	<div class="container body">
		<div class="main_container">
								...
								<div class="x_content">
									...
									<div class="item form-group">
										...
										<div class="col-md-3 col-sm-3 col-xs-3">
											<input id="kode_rm" name="kode_rm" readonly="readonly" value="<?php echo $_POST["cust_usr_kode"]; ?>" class="form-control col-md-5 col-xs-5" required="required" type="text">
										</div>
										<div class="col-md-6 col-sm-6 col-xs-6">
											...
											<script type="text/javascript">
												$(function() {
													...
													$('#RMM').change(function() {
														if ($(this).is(':checked')) {
															$("#kode_rm").removeAttr("readonly")
														} else {
															$("#kode_rm").attr("readonly", "readonly")
														}
													});
												});
                          //cek ketersediaan no rm
                          // $('#kode_rm').blur(function() {
                          //   //alert($(this).val());
                          //   $.post('cek_noRM.php', {
                          //     cust_usr_kode: $(this).val()
                          //   }, function(result) {
                          //     if (result.success) {
                      ...
                      <script type="text/javascript">
                      	$('#find_rm').select2({
                            ...
                            function(data) {
                                ...
                                $('#cust_usr_umur_penanggung_jawab').val(data.cust_usr_umur_penanggung_jawab);
                                $('#cust_usr_tanggal_lahir_penanggung_jawab').val(data.cust_usr_tanggal_lahir_penanggung_jawab);
                                $('#cust_usr_pekerjaan_penanggung_jawab_status').val(data.cust_usr_pekerjaan_penanggung_jawab_status);
            ...
            <div class="item form-group">
            	...
            	<div class="col-md-8 col-sm-8 col-xs-12">
            		<input id="cust_usr_nama" oninput="limitchar(this.value)" name="cust_usr_nama" value="<?php echo str_replace("*", "'", $_POST["cust_usr_nama"]); ?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="dua kata contoh:Moch Mansyur" required="required" type="text">
            	</div>
            </div>
            <div class="item form-group">
            	...
            	<div class="col-md-4 col-sm-4  col-xs-12">
                	...
                	<div class="item form-group">
                		...
                		<div class="col-md-8 col-sm-8 col-xs-12">
                			<select id="cust_usr_jenis_kelamin" class="form-control" name="cust_usr_jenis_kelamin" onKeyDown="return tabOnEnter(this, event);">
                				...
                				<option value="A" <?php if ($_POST["cust_usr_jenis_kelamin"] == "A") echo "selected"; ?>>Sex Ambigu</option>
                			</select>
                		</div>
                	</div>
                	<div class="item form-group">
                		...
                		<div class="col-md-8 col-sm-8 col-xs-12">
                			<div class="col-md-5 col-sm-5 col-xs-5">
                				<select class="form-control" name="cust_usr_gol_darah" id="cust_usr_gol_darah">
                					<option <?php if ($_POST['cust_usr_gol_darah'] = '-') {
                						echo "selected";
                					} ?> value="-">Tidak Tahu</option>
                					<option <?php if ($_POST['cust_usr_gol_darah'] = 'A') {
                						echo "selected";
                					} ?> value="A">A</option>
                					<option <?php if ($_POST['cust_usr_gol_darah'] = 'AB') {
                						echo "selected";
                					} ?> value="AB">AB</option>
                					<option <?php if ($_POST['cust_usr_gol_darah'] = 'B') {
                						echo "selected";
                					} ?> value="B">B</option>
                					<option <?php if ($_POST['cust_usr_gol_darah'] = 'O') {
                						echo "selected";
                					} ?> value="O">O</option>
                				</select>
                			</div>
                			<div class="col-md-7 col-sm-7 col-xs-7">
                				...
                				<div class="col-md-8 col-sm-8 col-xs-8">
                					<select class="form-control" name="cust_usr_gol_darah_resus" id="cust_usr_gol_darah_resus">
                						<option <?php if ($_POST['cust_usr_gol_darah_resus'] = 'Positif') {
                							echo "selected";
                						} ?> value="Positif">Positif</option>
                						<option <?php if ($_POST['cust_usr_gol_darah_resus'] = 'Negatif') {
                							echo "selected";
                	...
                	<div class="item form-group">
                		...
                		<div class="col-md-8 col-sm-8 col-xs-12">
		          		...
		          		<div class="item form-group">
		          			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nik">No. KTP / NIK <span class="required">*</span>
		          			</label>
		          			<div class="col-md-8 col-sm-8 col-xs-12">
		          				<input type="text" class="form-control" name="cust_usr_no_identitas" id="cust_usr_no_identitas" size="30" maxlength="65" value="<?php echo $_POST["cust_usr_no_identitas"]; ?>" onKeyUp="funLocation(this.value)" /></font>
		          				<!-- &nbsp;Jenis :
                		...
                		<div class="col-md-8 col-sm-8 col-xs-12">
                			<select class="form-control" name="id_prop" id="id_prop" onchange="pilih_kota(this.value)">
                				<?php for ($i = 0, $n = count($dataProvinsi); $i < $n; $i++) { ?>
                					<option value="<?php echo $dataProvinsi[$i]['lokasi_propinsi']; ?>" <?php if ($dataProvinsi[$i]["lokasi_propinsi"] == $row_edit["id_prop"]) {
                						echo "selected";
          		...
          		<div class="item form-group">
            		...
            		<div class="item form-group">
            			...
            			<div class="col-md-3 col-sm-3  col-xs-12">
            				<input type="text" class="form-control" id="cust_usr_tanggal_lahir_penanggung_jawab" name="cust_usr_tanggal_lahir_penanggung_jawab" value="<?php echo format_date($row_edit["cust_usr_tanggal_lahir_penanggung_jawab"]); ?>" data-inputmask="'alias': 'dd-mm-yyyy'" onChange="Umur_penanggung_jawab(this.value);" required="required" />
            			</div>
            		</div>
            		...
            		<div class="item form-group">
            			...
            			<div class="col-md-8 col-sm-8 col-xs-12">
            				<input type="text" name="tahun_penanggung_jawab" id="tahun_penanggung_jawab" size="3" maxlength="3" value="<?php echo $_POST["tahun_pj"]; ?>" onKeyDown="return tabOnEnter_select_with_button(this, event);" onChange="TanggalLahir_penanggung_jawab(this.value);" /> tahun
            				<input type="text" name="bulan_penanggung_jawab" id="bulan_penanggung_jawab" size="3" maxlength="3" value="<?php echo $_POST["bulan_pj"]; ?>" onKeyDown="return tabOnEnter_select_with_button(this, event);" onChange="TanggalLahir_penanggung_jawab(this.value);" /> bulan
            				<input type="text" name="hari_penanggung_jawab" id="hari_penanggung_jawab" size="3" maxlength="3" value="<?php echo $_POST["hari_pj"]; ?>" onKeyDown="return tabOnEnter_select_with_button(this, event);" onChange="TanggalLahir_penanggung_jawab(this.value);" /> hari
            			</div>
            		</div>
            			...
            			<div class="col-md-8 col-sm-8 col-xs-12">
            				<select class="form-control" name="cust_usr_penanggung_jawab_pekerjaan" id="cust_usr_penanggung_jawab_pekerjaan" onKeyDown="return tabOnEnter(this, event);">
            					...
            					<?php for ($i = 0, $n = count($dataPekerjaan); $i < $n; $i++) { ?>
            						<option value="<?php echo $dataPekerjaan[$i]["pekerjaan_id"]; ?>" <?php if ($dataPekerjaan[$i]["pekerjaan_id"] == $_POST["cust_usr_penanggung_jawab_pekerjaan"]) echo "selected"; ?>><?php echo ($i + 1) . ". " . $dataPekerjaan[$i]["pekerjaan_nama"]; ?></option>
            					<?php } ?>
            				</select>
            			</div>
            		</div>
						...
						<div class="col-md-8 col-sm-8 col-xs-12">
							<select class="form-control" name="cust_usr_penanggung_jawab_pendidikan" id="cust_usr_penanggung_jawab_pendidikan" onKeyDown="return tabOnEnter(this, event);">
								...
								<?php for ($i = 0, $n = count($dataPendidikan); $i < $n; $i++) { ?>
									<option value="<?php echo $dataPendidikan[$i]["pendidikan_id"]; ?>" <?php if ($dataPendidikan[$i]["pendidikan_id"] == $_POST["cust_usr_penanggung_jawab_pendidikan"]) echo "selected"; ?>><?php echo ($i + 1) . ". " . $dataPendidikan[$i]["pendidikan_nama"]; ?></option>
								<?php } ?>
							</select>
						</div>
					</div>
          ...
          <div class="x_panel">
          	...
          	<div class="x_content">
          		...
          		<!-- <div class="item form-group">
          			...
          			<div class="col-md-8 col-sm-8 col-xs-12">
          				<input type="text" class="form-control" name="cust_usr_penanggung_jawab" id="cust_usr_penanggung_jawab" size="30" maxlength="65" value="<?php echo str_replace("*", "'", $_POST["cust_usr_penanggung_jawab"]); ?>" onKeyDown="return tabOnEnter_select_with_button(this, event);" /></font>
          				&nbsp;Status :
          				<select class="form-control" name="cust_usr_penanggung_jawab_status" id="cust_usr_penanggung_jawab_status" onKeyDown="return tabOnEnter(this, event);">
          					<option value="">- Pilih Hubungan -</option>
          					<?php for ($i = 0, $n = count($dataStatusPJ); $i < $n; $i++) { ?>
          		...
          		<input type="hidden" name="<? if ($_x_mode == "Edit") echo "btnUpdate";
          		else echo "btnSave"; ?>" value="<? if ($_x_mode == "Edit") echo "Update";
          		else echo "Simpan"; ?>" />
        ...
        <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
        	...
        	else echo "Simpan"; ?>" class="btn col-md-5 btn-success"><? if ($_x_mode == "Edit") echo "Update";
