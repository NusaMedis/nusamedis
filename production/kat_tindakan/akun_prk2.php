...
function sendValue(nama,no,id) {
	self.parent.document.getElementById('nama_prk_biaya').value = nama;
  self.parent.document.getElementById('no_prk_biaya').value = no;
	self.parent.document.getElementById('id_prk_biaya').value = id;
