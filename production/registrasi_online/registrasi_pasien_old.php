...
$sql = "select count(reg_id) as jkn_irna from klinik.klinik_registrasi a WHERE id_cust_usr = " . QuoteValue(DPE_CHAR, $_GET['usr_id']) . " and reg_status = 'I2' and reg_tanggal <= '" . date('Y-m-d') . "' and id_poli IN (select poli_id from global.global_auth_poli where poli_tipe= 'I')  ";
...
<script type="text/javascript">
  ...
  <?php if ($sep_sameday['sep_sameday'] > 0) { ?>
    swal({
      title: '',
