<?php
  ...
  $backPage = "jadwal_dokter.php?id_instalasi=".$_POST["id_instalasi"]."&id_sub_instalasi=".$_POST["id_sub_instalasi"]."&id_poli=".$_POST["id_poli"];
	...
	elseif($_x_mode=="Edit") $privMode = PRIV_UPDATE;
     ...
     { 
          ...
          if($_POST["btnUpdate"])
          {
               ...
               $dbField[1] = "jadwal_dokter_kuota";  
               $dbField[2] = "jadwal_dokter_status";  
               $dbField[3] = "jadwal_dokter_jam_mulai_android";  
               $dbField[4] = "jadwal_dokter_jam_selesai_android";  
             


               if(!$jadwalDokterId) $jadwalDokterId = $dtaccess->GetTransId();   
               $dbValue[0] = QuoteValue(DPE_CHAR,$jadwalDokterId);
               $dbValue[1] = QuoteValue(DPE_CHAR,$_POST["jadwal_dokter_kuota"]);   
               $dbValue[2] = QuoteValue(DPE_CHAR,$_POST["jadwal_dokter_status"]);   
               $dbValue[3] = QuoteValue(DPE_CHAR,$_POST["jadwal_dokter_jam_mulai"]);   
               $dbValue[4] = QuoteValue(DPE_CHAR,$_POST["jadwal_dokter_jam_selesai"]);   
        ...
        <div class="right_col" role="main">
          <div class="">
                  ...
                  <select name="jadwal_dokter_hari" class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);" >
                    ...
                    <option class="inputField" value="7" <?php if ($_POST["jadwal_dokter_hari"]=='7') echo"selected"?>>Minggu</option>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php echo $view->RenderTextBox("jadwal_dokter_jam_mulai","jadwal_dokter_jam_mulai","85","100",$_POST["jadwal_dokter_jam_mulai_android"],"inputField","disable", null,false);?>
						</div>
					  </div> 
            <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php echo $view->RenderTextBox("jadwal_dokter_jam_selesai","jadwal_dokter_jam_selesai","85","100",$_POST["jadwal_dokter_jam_selesai_android"],"inputField", null,false);?>
						</div>
					  </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">      
                  <select name="jadwal_dokter_status" class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);" >
                    <option class="inputField" value="" >- Pilih Status -</option>
                    <option class="inputField" value="PRAKTEK" <?php if ($_POST["jadwal_dokter_status"]=='PRAKTEK') echo"selected"?>>Praktek</option>
                    <option class="inputField" value="LIBUR" <?php if ($_POST["jadwal_dokter_status"]=='LIBUR') echo"selected"?>>Libur</option>
