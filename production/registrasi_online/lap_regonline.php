...
where   reg_buffer_flag <>' ' and reg_buffer_flag <> ' ' and reg_buffer_flag <> 'W' and (reg_buffer_utama='' or reg_buffer_utama is null) and
".$sql_where."
...
if ($_GET['excel']=="y"){
  ...
  header('Content-Disposition: attachment; filename=laporan_registrasi_online.xls');?>
