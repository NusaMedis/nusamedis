<?php
    ...
    || $_GET["pembul"] || $_GET["total"]) {
		$sql = "select reg_keterangan,b.cust_usr_nama,b.cust_usr_kode,b.cust_usr_no_hp,b.cust_usr_jenis_kelamin, a.reg_status,
    ...
    $sql = "select * from klinik.klinik_pembayaran_det where id_pembayaran = ".QuoteValue(DPE_CHAR,$dataPasien['id_pembayaran']);
    $PembayaranDet = $dtaccess->Fetch($sql);
    ...
    $_POST["kwitansi_nomor"] = $PembayaranDet["pembayaran_det_kwitansi"];
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse"> 
  ...
  <tr>
    ...
    <td align="center" width="1%"></td>  
	<?php 
	if (!empty($dataPasien["reg_keterangan"])) { 
       $pasien = explode('(', $dataPasien["reg_keterangan"]);
    ?>
  ...
  <tr> 
    ...
    <td align="left" width="20%">&nbsp;<?php echo $pasien[0];?></td>  
    <?php } else {?>
	<td align="left" width="20%">&nbsp;<?php echo $dataPasien["cust_usr_nama"];?></td>  
	<?php } ?>  
  </tr>
  ...
  <?php } ?>
    <tr>
      ...
      <td width = "1%">:</td>  
      <td  align="center" width="1%"></td>  
       <td  align="left" width="20%"> &nbsp;Rp. <?php echo currency_format($PembayaranDet["pembayaran_det_total"]);?></td>
    </tr>
<!--     <?php if($dataDiskon["pembayaran_det_total"]<>$dataDiskon["pembayaran_det_dibayar"]) {?>
  ...
  <tr>
    ...
    <td  align="left" width="20%">&nbsp;<?php echo terbilang($PembayaranDet["pembayaran_det_total"]);?> Rupiah</td> 
  </tr>
</table>
<br>
...
$mpdf->Output("".$_POST["kwitansi_nomor"]."-".date('d-F-Y H:i:s').".pdf" ,'D');
$db1->close();
?>