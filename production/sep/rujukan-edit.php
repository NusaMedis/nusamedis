...
<?php 
  ...
  $sql = "select * FROM klinik.klinik_sep a";
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <form id="form_sep" class="form-horizontal form-label-left input_mask" method="POST">
                  ...
                  <input type="hidden" name="no_rujukan" id="no_rujukan" value="<?= $exist['no_rujukan'] ?>">
                  <input type="hidden" name="sep_rujukan_id" id="sep_rujukan_id" value="<?= $exist['sep_rujukan_id'] ?>">
                  <div class="x_panel" id="panelB">
                    ...
                    <div class="x_content">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control tgl" name="tgl_rujukan" id="tgl_rujukan" value="<?= date_db($exist['tgl_rujukan']) ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <select class="form-control" name="rujukan_asalRujukan" id="rujukan_asalRujukan" onchange="asal(this.value)">
                               ...
                               <option <?php if ($exist['faskes_rujukan'] == "1" || $exist['faskes_rujukan'] == "1") {
                                      echo "selected";
                                    } ?> value="1">Faskes</option>

                                 <option <?php if ($exist['faskes_rujukan']== "2") {
                                      echo "selected";
                                    } ?> value="2">Faskes 2</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="ppk_dirujuk_txt" id="ppk_dirujuk_txt" value="<?= $exist['ppk_dirujuk_txt'] ?>">
                          <input type="hidden" class="form-control" name="ppk_dirujuk" id="ppk_dirujuk" value="<?= $exist['ppk_dirujuk'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea id="message" class="form-control" name="catatan" id="catatan" ><?= $exist['catatan'] ?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Diagnosa Rujukan</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="diag_rujukan_txt" id="diag_rujukan_txt" value="<?= $exist['diag_rujukan_txt'] ?>">
                          <input type="hidden" class="form-control" name="diag_rujukan" id="diag_rujukan" value="<?= $exist['diag_rujukan'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="tipe_rujukan" id="tipe_rujukan">
                            <option <?php if ($exist['tipe_rujukan']== "0") {
                                      echo "selected";
                                    } ?>  value="0">Penuh</option>
                            <option  <?php if ($exist['tipe_rujukan']== "1") {
                                      echo "selected";
                                    } ?> value="1">Partial</option>
                            <option  <?php if ($exist['tipe_rujukan']== "2") {
                                      echo "selected";
                                    } ?> value="2">Rujuk Balik</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="poli_rujukan_txt" id="poli_rujukan_txt" value="<?= $exist['poli_rujukan_txt'] ?>" >
                          <input type="hidden" class="form-control" name="poli_rujukan" id="poli_rujukan"  value="<?= $exist['poli_rujukan_txt'] ?>" >
                        </div>
                      </div>
                    </div>
                    <!-- /.x_content -->
