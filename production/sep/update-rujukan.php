<?php
	...
	if ($dc->metaData->code == 200) {
		...
		$dbField[13] = "created_at";
		$dbField[14] = "no_rujukan";
		
		$id = $dtaccess->GetTransID(); 
		$dbValue[0] = QuoteValue(DPE_CHAR, $_POST["sep_rujukan_id"]);
		...
		$dbValue[13] = QuoteValue(DPE_CHAR, date('Y-m-d H:i:s'));
		$dbValue[14] = QuoteValue(DPE_CHAR, $dc->response);
