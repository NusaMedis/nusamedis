...
<html>
  ...
  <body onload="window.print(); window.close();">
    <table style="height: 6cm; width: 100%">
      <tbody> 
        <tr>
        ...
        <tr>
          ...
          <td valign="center" width="1%" class="isi"> : </td>
          <td valign="center" width="35%" class="isi"><b><?php echo $conf['dep_tipe_rs'];?></b></td>
        </tr>
        <tr>
          ...
          <td valign="center" width="1%" class="isi"> : </td>
          <td valign="center" width="35%" class="isi"><b><?php echo $row['cust_usr_kode'];?><b></td>
        </tr>
        <tr>
          ...
          <td valign="center" width="1%" class="isi"> : </td>
          <td valign="center" width="35%" class="isi"><?php echo $row['reg_kode_trans'];?></td>
        </tr>
        <tr>
          ...
          <td valign="center" width="1%" class="isi"> : </td>
          <td valign="center" width="35%" class="isi"><?php echo $row['jenis_peserta_txt']; ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td valign="center" width="1%" class="isi"> : </td>
          <td valign="center" width="35%" class="isi"><?php echo ($row['cob'] == '1') ? 'Ya' : 'Tidak';?></td>
        </tr>
        <tr>
          ...
          <td valign="center" width="1%" class="isi"> : </td>
          <td valign="center" width="35%" class="isi"><?php if($row['jns_pelayanan'] == '1') { echo "Rawat Inap"; } else { echo "Rawat Jalan"; } ?></td>
        </tr>
        <tr>
          ...
          <td valign="center" width="1%" class="isi"> : </td>
          <td valign="center" width="35%" class="isi"><?php echo $row['kls_rawat_txt'];?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="center" class="isi">Pasien/ Keluarga Pasien</td>
        </tr>
        <tr>
          <td valign="center" width="14%" class="isi">Catatan</td>
          <td valign="center" width="1%" class="isi"> : </td>
          <td valign="center" width="35%" class="isi"><?php echo $row['catatan'];?></td>
          <td valign="center" colspan="3"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td valign="center" colspan="5" class="isi"><sub><i>* SEP bukan sebagai bukti penjaminan peserta.</i></sub></td>
          <td align="center" class="isi">___________________</td>
        </tr>
      </tbody>
    </table>
  </body>
