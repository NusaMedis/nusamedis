    ...
    <table width="100%" border='0'>
      <tbody> 
        <tr>
          ...
          <td align="left" colspan="6" class="judul">SURAT RUJUKAN RSIA MUSLIMAT JOMBANG</td>
        ...
        <tr>
          ...
          <td valign="left" width="1%" class="isi"> : </td>
          <td valign="left" width="20%" class="isi"><?= $data['laka_penjamin'] ?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td valign="left" width="14%" class="isi">DPJP Yg Melayani</td>
          <td valign="left" width="1%" class="isi"> : </td>
          <td>
         <?php 
