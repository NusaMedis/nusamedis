		...
		$.ajax({
			...
			success: function(rspns) {
		        ...
		        if (rspns.metaData.code != 200) {
		          ...
		          new PNotify({
		            title: 'Sukses',
		            text: 'Rujukan SEP '+rspns.response.rujukan.noRujukan+' berhasil',
		            type: 'success',
		            styling: 'bootstrap3',
		            addclass: 'dark'
		          });
		          // window.open('rujukan-sep-cetak.php?reg_id='+rspns.rujukan.noRujukan+'','_blank');
		          window.location.replace('rujukan-index.php');
		        }
			}
		})
