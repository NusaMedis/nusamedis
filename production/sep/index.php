...
<?php 
  ...
  $sql .= " WHERE reg_jenis_pasien = 5 and reg_status <> 'I9' and (d.no_sep = '' or d.no_sep IS NULL) and (c.poli_tipe ='J' or c.poli_tipe ='G'  or c.poli_tipe ='I') ";  
  $sql .= " and ".$sql_where;
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo str_replace("*", "'", $value['cust_usr_nama']);?></td>
