				    ...
				    for($j = 1; $j <= 10; $j++){
						...
						<?php 
							if ($obj) {
								...
								<span style="font-size:10px;font-family:sans-serif;font-weight:bold;text-align: center;">No RM : <?php echo $dataPasien["cust_usr_kode"];?></span><br/>

								<span style="font-size:10px;font-family:sans-serif;font-weight:bold;text-align: center;">
									<?php echo substr(($dataPasien["cust_usr_nama"]),0,14).' ('.$dataPasien["cust_usr_jenis_kelamin"].')'; ?> | <?php echo format_date($dataPasien["cust_usr_tanggal_lahir"]);?></span>
