  ...
  <body class="nav-md">
    <div class="container body">
                  ...
                  <div class="x_content">
                    ...
                    <td align="center" width="47%" class="tablecontent" rowspan="6"><font color='red' size='10'><span id=txtIsi ><?php echo currency_format($totalHarga);?></span></font></td>      
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<a href="<?php echo $findPasien;?>?TB_iframe=true&height=550&width=800&modal=true" class="thickbox" title="Cari Pasien"><input  type="text" name="cust_usr_kode" id="cust_usr_kode" size="25" maxlength="25" value="<?php echo $_POST["cust_usr_kode"];?>" readonly="readonly" /></a>
						<a href="<?php echo $findPasien;?>?TB_iframe=true&height=550&width=800&modal=true" class="thickbox" title="Cari Pasien"><img src="<?php echo($ROOT);?>gambar/finder.png" border="0" align="top" style="cursor:pointer" title="Cari Pasien" alt="Cari Pasien" /></a>
     ...
     <tr>
        ...
        <?php }else{ ?>
<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
     <tr><td> Data OBAT / ALKES belum ada </td></tr>
     </table>
        <?} ?> 
