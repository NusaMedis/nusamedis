...
if ($_GET["id"]) {
  $sql = "select item_racikan, a.* , b.* ,c.item_nama , c.item_tipe_jenis,d.cust_usr_kode,d.cust_usr_alamat,d.cust_usr_tanggal_lahir,d.cust_usr_jenis_kelamin, 
            e.jenis_nama, f.poli_nama, h.jam_aturan_pakai_awal, h.jam_aturan_pakai_akhir, i.usr_name, c.item_id
            ...
            left join apotik.apotik_aturan_pakai g on g.aturan_pakai_id = b.id_aturan_pakai
            left join apotik.apotik_jam_aturan_pakai h on h.jam_aturan_pakai_id = g.id_jam_aturan_pakai
            left join global.global_auth_user i on a.who_update = i.usr_id
      ...
      <td width="100%">
        <table border="0" style="font-size:10px;" width="100%" valign="top">
          ...
          <tr>
            ...
            <td width="1%" align="center">:</td>
            <td><?php echo format_date(date_db($dataTable[0]["cust_usr_tanggal_lahir"])); ?></td>
          </tr>
          <tr>
            <td width="30%">Jenis Kelamin</td>
            <td width="1%" align="center">:</td>
            <td><?php
                if($dataTable[0]["cust_usr_jenis_kelamin"]) {
          ...
          <tr valign="top">
            ...
            <td align="center">:</td>
            <td><?php 
              echo ($dataTable[0]["cust_usr_alamat"]) ? $dataTable[0]["cust_usr_alamat"] : $dataTable[0]["penjualan_alamat"]; 
            ?></td>
          </tr>
          ...
          <?php if ($konfigurasi["dep_konf_jam_aturan_pakai"] == 'y') { ?>
            <!--<tr>
          <td width="40%">Jam Aturan Pakai</td>
          <td align="center">:</td>
          <td><?php echo $dataTable[0]["jam_aturan_pakai_awal"]; ?> - <?php echo $dataTable[0]["jam_aturan_pakai_akhir"]; ?></td>
        </tr>-->
          <?php } ?>
        </table>
      </td>
                ...
                <td align="center">
                  <?php
                    ...
                    if($dataTable[$i]['item_racikan'] == 'y  '){
                        $sql = "SELECT item_nama, detail_racikan_jumlah from apotik.apotik_detail_racikan where id_nama_racikan = '".$dataTable[$i]['item_id']."'";
                        $dataRacikan = $dtaccess->FetchAll($sql); ?>

                      <b><?=$dataTable[$i]["item_nama"];?></b><br>
      ...
      <td colspan="2" width="100%">
        <table border="0" width="100%" style="font-size:10px;border-collapse:collapse;">
          ...
          <tr>
            ...
            <td colspan="5" align="right">Yang Menerima,<br><br><br><br><br>(<?php echo $dataTable[0]["usr_name"]; ?>)</td>
          </tr>
          <tr>
            <td colspan="5">&nbsp;</td>
          </tr>
