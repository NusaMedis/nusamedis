<?php
     if (!$_POST['id_dokter']) $_POST['id_dokter'] = '1';
...
//die();   
 ...
 // Masuk Kassa Rawat Jalan
     ...
     //    if($medrec["e_medrec"]=='n'){
          ...
          $dbField[22] = "fol_keterangan";
          $dbField[23] = "tipe_rawat";
...
//         $dataObat = $dtaccess->Fetch($sqltdk);
         ...
         $sql = "select * from apotik.apotik_penjualan where penjualan_id = ".QuoteValue(DPE_CHAR,$penjualanId);
         $dataPenjualan = $dtaccess->Fetch($sql);
               ...
               $dbValue[22] = QuoteValue(DPE_CHAR,$dataPenjualan["cust_usr_nama"]);
               $dbValue[23] = QuoteValue(DPE_CHAR,'A');
