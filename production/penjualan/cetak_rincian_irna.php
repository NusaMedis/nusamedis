  ...
  <body>
    <table>
      <thead>
        ...
        <tr>
          <td colspan="3"> <?php echo "&nbsp;".FormatTimestamp($dataPasien["reg_tanggal"]);?></td>
        </tr>
      </thead>
    </table>
    <table>
          ...
          for($a = 0, $s = count($dataFolio); $a < $s; $a++){
            if($dataFolio[$a]['biaya_jenis_sem'] == 'OA'){
              ...
              if ($dataFolio[$a]['tindakan_tanggal'] == $dataFolio[$a+1]['tindakan_tanggal'] && $dataFolio[$a]['fol_nama'] == $dataFolio[$a+1]['fol_nama']) {
                ...
                $tot_nominal = $dataFolio[$a]['fol_nominal'];
                ...
                <tr>
                  ...
                  <td class="nom nor"><?php echo currency_format($dataFolio[$a]['fol_nominal']+$tot_nominal) ;?></td>
