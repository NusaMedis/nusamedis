...
//INSERT KLINIK REGISTRASI            
               ...
               // $dbField[8] = "id_pembayaran";
                ...
                $dbValue[8] = QuoteValue(DPE_CHAR,$_POST['reg_jenis_pasien']);
                ...
                $dbValue[18] = QuoteValue(DPE_CHAR,date("Y-m-d"));
                $dbValue[19] = QuoteValue(DPE_CHAR,$_POST['pgw_id']);
          ...
          $dbValue[7] = QuoteValue(DPE_CHAR,$_POST["poli"]);
