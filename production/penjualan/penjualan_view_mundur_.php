...
//	   $poli = $auth->GetPoli();
   ...
   if(!$auth->IsAllowed("man_ganti_password",PRIV_CREATE)){
     ...
     $sql = "select a.*, b.cust_usr_kode, b.cust_usr_tanggal_lahir, c.jenis_nama, d.id_pembayaran,e.poli_nama, e.poli_tipe, d.reg_utama, a.id_resep
             ...
             where (penjualan_id in(select id_penjualan from apotik.apotik_penjualan_detail) or id_resep is not null) and a.is_terima!='y' and cust_usr_id <> '100' and penjualan_flag<>'R' and d.reg_jenis_pasien = '2' and a.id_dep =".QuoteValue(DPE_CHAR,$depId)." 
