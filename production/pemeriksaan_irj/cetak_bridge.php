...
$reg_data = $dtaccess->Fetch($sql);
     ...
     $sql = "select diagnosa_nama, diagnosa_nomor, a.* from klinik.klinik_perawatan_diagnosa a 
     left join klinik.klinik_diagnosa b on b.diagnosa_id = a.id_diagnosa where id_rawat = ".QuoteValue(DPE_CHAR,$dataRawat['rawat_id'])." and rawat_diagnosa_status <> 'Primer' limit 4";
				...
				<td colspan="3">
					<table style="width: 100%">
						...
						<tr>
							...
							<td align="center">
								<br>
								<img height="100" src="<?=$lokasiPasien?>">
								<br>
