<?php
  ...
  if($_GET["id_reg"] || $_GET["jenis"]  || $_GET["ket"] || $_GET["dis"] || $_GET["disper"] || $_GET["pembul"] || $_GET["total"]) {
    $sql = "select cust_usr_nama,cust_usr_kode,cust_usr_kode_tampilan,cust_usr_tanggal_lahir,cust_usr_no_hp,b.cust_usr_jenis_kelamin,cust_usr_alamat, d.poli_nama,
            ((current_date - cust_usr_tanggal_lahir)/365) as umur,  a.id_poli,a.id_cust_usr ,a.reg_jenis_pasien , id_poli_asal,
            ...
            c.usr_name,e.jenis_nama,f.rujukan_nama,g.fol_id, i.usr_name as petugas_nama
            ...
            left join klinik.klinik_folio g on a.reg_id = g.id_reg
            ...
            where a.reg_id = ".QuoteValue(DPE_CHAR,$_GET["id_reg"])." and g.fol_lunas='n' and a.id_dep=".QuoteValue(DPE_CHAR,$depId);
    //echo $sql;      
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" style="border-collapse:collapse"> 
  ...
  <tr>
    ...
    <td align="center" width="1%">:</td>  
    <td align="left" width="20%"><?php echo ( $dataPasien["id_poli"]==$dataPasien["id_poli_asal"] ? "Poli Pertama" : $dataPasien["poli_nama"] ) ?></td> 
  </tr>
  <tr>
  ...
  <tr>
    ...
    <?php for($i=0,$n=count($dataFolio);$i<$n;$i++) {?>
     <tr>
         ...
         <td align="left" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $dataPasien[$i]["usr_name"];?></td>
     </tr>
...
<div style="position:fixed;top:510px;left:630px;">
