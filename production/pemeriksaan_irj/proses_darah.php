<?php
	...
	# simpan klinik folio	
	  ...
	  $dbValue[15] = QuoteValue(DPE_CHAR,$pel1);
	  $dbValue[16] = QuoteValue(DPE_CHAR,"LD");
	  $dbValue[17] = QuoteValue(DPE_CHAR,$_POST["biaya_tarif_id"]);
	  $dbValue[18] = QuoteValue(DPE_CHAR,$tanggal." ".$waktu);
	  $dbValue[19] = QuoteValue(DPE_CHAR,$waktu);
	  $dbValue[20] = QuoteValue(DPE_CHAR,$tanggal);
	...
	// die();	 
		...
		unset($dbKey);	
		 ...
		 # simpan di pelaksana
		for ( $n = 0 ; $n < 2 ; $n++ ) { #ulang 3 x dengan fol tipe berbeda
		  ...
		  $a = array(PELAKSANA_TIPE_DPJP,PELAKSANA_TIPE_PELAKSANA); #data tipe pelaksana
		  $b = array($dpjp,$pel1); #data pelaksana
