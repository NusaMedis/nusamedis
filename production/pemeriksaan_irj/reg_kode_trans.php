<?php    
          ...
          //ambil kode poli
          $sql = "select poli_kode, id_instalasi, poli_tipe, id_sub_instalasi from global.global_auth_poli where poli_id=".QuoteValue(DPE_CHAR,$_POST['poli_id']);
          ...
          and id_poli = ".QuoteValue(DPE_CHAR,$_POST['poli_id'])." and id_dep = ".QuoteValue(DPE_CHAR,$depId);   
