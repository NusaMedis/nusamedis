...
<body>
	<div class="wrapper" style="width: 18cm; margin : auto;">
		...
		<?php if($dataPemeriksaan['diagnosa'] || $dataPemeriksaan['penjelasan_penyakit'] || $dataPemeriksaan['pemeriksaan_penunjang'] || $dataPemeriksaan['terapi_edukasi'] || $dataPemeriksaan['terapi_alter'] || $dataPemeriksaan['tindakan_medis'] || $dataPemeriksaan['prognosa'] || $dataPemeriksaan['perkiraan_hari_rawat'] || $dataPemeriksaan['penjelasan_komplikasi'] || $dataPemeriksaan['informed_concent'] || $dataPemeriksaan['kondisi'] || $dataPemeriksaan['konsul'] || $_GET['edukasi_pulang'] || $dataPemeriksaan['edukasi_lain'] ){ ?>
			...
			<div style="width: 50%; ">
				...
				<div>
					<ol>
						...
						<?php if($dataPemeriksaan['terapi_edukasi']){?><li>Terapi</li><?php }?>
						
						<?php if($dataPemeriksaan['prognosa']){?><li>Prognosa</li><?php }?>
						<?php if($dataPemeriksaan['tindakan_medis']){?><li>Tindakan Medis</li><?php }?>
						<?php if($dataPemeriksaan['terapi_alter']){?><li>Terapi alternative</li><?php }?>
