...
for ($i = 0; $i < count($dataBHP); $i++) {
	$item_hpp = ($dataBHP[$i]['obat_flag'] == 'g' && $dataBHP[$i]['item_harga_diskon'] != 0) ? $dataBHP[$i]['item_harga_diskon'] : $dataBHP[$i]['item_hpp'];
...
//INSERT REMUNERASI PASIEN
// $sql = "select biaya_remunerasi_prosentase from klinik.klinik_biaya_remunerasi where id_biaya_tarif =" . QuoteValue(DPE_CHAR, $folio["id_biaya_tarif"]);
