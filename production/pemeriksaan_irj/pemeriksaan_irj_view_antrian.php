          ...
          <div class="">
            ...
            <div class="row">             
              <div class="col-md-12 col-sm-12 col-xs-12">
					...
					toolbar="#toolbar"
							data-options=" url:'get_antrian.php', pagination:false,
						...
						<thead>
							<tr>
								...
								<th field="reg_no_antrian" width="50">No Antrian</th>
...
<?php require_once($LAY."js.php") ?>
	...
	$("select#dokterr").change(function(){
		var val_id = $(this).val();
		$("input#dokterr").val(val_id);
	});
	...
	$("select#reg_rujukan_id").change(function(){
		...
		function editUser(){
			...
			if (row){
				$.get('get_antrian.php',{reg_id:row.reg_id},function(r){
					...
					$('#dokterr').val(r[0].id_dokter);
					$('input#dokterr').val(r[0].id_dokter);
					...
					$('#reg_no_antrian').val(r[0].reg_no_antrian);
					$('#reg_status').val(r[0].reg_status);
					...
					if(stats != '0'){
						...
						$("select#dokterr").attr("disabled", "true");
						...
						$("select#dokterr").removeAttr("disabled");
