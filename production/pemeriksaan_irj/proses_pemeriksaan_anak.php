...
// if(count($dataDiagnosa) > 0){
	...
	$sql = "UPDATE klinik.klinik_perawatan SET rawat_anak = " . QuoteValue(DPE_CHAR, serialize($form));
	$sql .= ", rawat_anamnesa =" . QuoteValue(DPE_CHAR, $form['anamnesa']);
	$sql .= ", rawat_pemeriksaan_fisik =" . QuoteValue(DPE_CHAR, $form['pemeriksaan_umum']);
