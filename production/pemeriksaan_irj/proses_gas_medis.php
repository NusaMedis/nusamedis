<?php
	...
	# simpan klinik folio	
	  ...
	  $dbField[19] = "fol_waktu";
	  $dbField[20] = "tindakan_waktu";
	  $dbField[21] = "tindakan_tanggal";
	  ...
	  $dbValue[19] = QuoteValue(DPE_CHAR,$tanggal." ".$waktu);
	  $dbValue[20] = QuoteValue(DPE_DATE,$waktu);
	  $dbValue[21] = QuoteValue(DPE_DATE,$tanggal);
