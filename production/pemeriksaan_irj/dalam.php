...
<script type="text/javascript" src="dalam.js"></script>
<script>
  ...
  <div class="form-horizontal form-label-left">
    ...
    <form id="form_dalam" method="POST" class="form-horizontal form-label-left" action="<?php echo $_SERVER["PHP_SELF"] ?>">
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="col-md-4">
                  <label style="float: left;">Saturasi</label>
                </div>
                <div class="col-md-6">
                  <input type="text" name="saturasi" id="saturasi" value="" placeholder="" class="form-control">
                </div>
                <div class="col-md-1">
                  <label>%</label>
                </div>
         ...
         <!--  <br>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-2 col-sm-2 col-xs-12">
              <button type="button" id="cetak-resume-dalam" class="btn btn-success">Cetak Asmed</button>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-top: 10px">
              <button type="button" id="cetak-resume-med-dalam" class="btn btn-success">Cetak Resume</button>
            </div>
          </div>
        </div>
...
<script>
  ...
  $('#cetak-resume-dalam').click(function() {
    var id_rawat = $('#form_dalam').find("#asd").val();
    // BukaWindow('cetak_usg.php?' + data, 'cetak usg');
    window.open('cetak_resume_poli_dalam.php?asd=' + id_rawat, '_blank');
  });
  $('#cetak-resume-med-dalam').click(function() {
     var id_rawat = $('#form_dalam').find("#asd").val();
    BukaWindow('cetak_bpjs.php?id=' + id_rawat, "Resume");
  });

  $("form#form_dalam").find("input#lain_lainEdukasi").click(function(){
  ...
  $("form#form_dalam").find("input#konsul").click(function(){
    var check = $(this).is(":checked");
    if(check == true){
  ...
  $("form#form_dalam").find("input#edukasi_lain").click(function(){
    var check = $(this).is(":checked");
    if(check == true){
