...
<div title="Pemeriksaan" style="padding:5px">
	<div class="form-horizontal form-label-left">
		<div class="item form-group">
			<button id="showHistoryObgyn" style="width: 30%;margin: 10px 33%;" class="btn btn-primary" data-idcust="" data-idpoli="">Tampilkan Semua History</button>
		</div>
		<div class="item form-group">
			...
			<form id="form_obgynn" method="POST" target="_blank" class="form-horizontal form-label-left" action="cetak_usg.php">
				...
				<div class="form-group">
		            <div class="col-md-6">
		              ...
		              <div class="col-md-10">
		                ...
		                <div class="col-md-2">
		                  <input type="text" class="form-control" name="janin_kembar_det" id="janin_kembarl_det" style="display: none;" disabled>
		                </div>
		                <div class="col-md-2">
				...
				<div class="form-group">
		            <div class="col-md-6">
		              ...
		              <div class="col-md-10">
		                <div class="col-md-2">
		                  <input type="checkbox" value="true" name="ketubah_cukup" id="ketuban_cukupl"> <i style="color: black;">Cukup</i>
		                </div>
		                <div class="col-md-2">
		                  <input type="checkbox" value="true" name="ketuban_kurang" id="ketuban_kurangl"> <i style="color: black;">Kurang</i>
		                </div>
		                <div class="col-md-2">
		                  <input type="checkbox" value="true" name="ketuban_banyak" id="ketuban_banyakl"> <i style="color: black;">Banyak</i>
		                </div>
		                <div class="col-md-6">
		                	<div class="col-md-2" style="padding: 0">
		              		...
		              		<div class="col-md-7" style="padding: 0">
		                  		<input type="text" name="afi" id="afil" class="form-control">
		              		</div>
				...
				<div class="form-group">
		            <div class="col-md-6">
		              <div class="col-md-3">
		                ...
		                <div class="col-md-6">
		                  <input type="text" name="usia_kehamilan_minggu1" id="usia_kehamilan_minggu1l" class="form-control">
		                </div>
		                <div class="col-md-2">
		                  <label>Minggu</label>
		                </div>
		              ...
		              <div class="col-md-3">
		                ...
		                <div class="col-md-9">
		                  <input type="text" name="usia_kehamilan_hari1" id="usia_kehamilan_hari1l" class="form-control">
		                </div>
		                <div class="col-md-2">
		                  <label>Hari</label>
		                </div>
				...
				if (row.reg_status == 'E0') {
					...
					$.get('get_irj.php', {
						...
						if(result[0].form_asmed == "obgyn"){
							...
							$("button#showHistoryObgyn").attr("data-idcust", result[0].cust_usr_id);
							$("button#showHistoryObgyn").attr("data-idpoli", result[0].id_poli);
						...
						if(result[0].janin_tunggalSkg == null && result[0].janin_kembarSkg == null){
							...
							if (result[0].janin_kembarSkg != null) {
								...
								$("input#janin_kembarl_det").css("display", "block");
						        $("input#janin_kembarl_det").attr("disabled", false);
						        $('input#janin_kembarl_det').val(result[0].janin_kembar_det);
							}
						}

						var jumlah = result[0].janin_kembar_det;
					    var countD = $("form#form_obgynn div#divJenkel div#detJenkel").length - 1;

					    if(countD >= 1){
					        $("form#form_obgynn div#divJenkel div#detJenkel").slice(-countD).remove();
					    }
						...
						for(var x = 1; x < jumlah; x++){
					        $("form#form_obgynn select[name='jenis_kelamin_"+x+"']").val(result[0]['jenis_kelamin_'+x]);
					    }
						...
						// $('select#jenis_kelaminl').val(result[0].JenisKelaminSkg);
