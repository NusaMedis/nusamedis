									...
									<div class="x_content">
										<div class="col-md-4 col-sm-12">
											<span class="control-label">						
												...
												<img  hspace="2" height="100" name="original" id="foto_pasien" style="cursor:pointer; margin-bottom:15px; " src="" 
												valign="middle">
											</span>
...
<input name="btn" id="btn" class="btn btn-default col-md-2 pull-right" type="submit" value="Selesai">
<input id="btnReset" class="btn btn-default col-md-1 pull-right" style="display:none;" value="Batal" onclick="window.location.reload()">
<input class="btn btn-default col-md-1 pull-right" type="submit" value="Kembali" onclick="history.back()">
</div>
</div>
</form>
...
<!-- tab 4 -->
<div title="Diagnosa" style="padding:5px">
	<table id="tb_diagnose" style="width:100%;" toolbar="#toolbar_diag" idField="rawat_diagnosa_id" rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
...
<!-- tab 5 -->
<div title="Procedure" style="padding:5px">
	<table id="tb_procedures"  style="width:100%;" toolbar="#toolbar_pro" idField="rawat_procedure_id" rownumbers="true" fitColumns="true" singleSelect="true">
            	<thead>
            		<tr>
...
<!-- tab 6 -->
<div title="Perawatan Terapi" style="padding:5px">
	<input type="hidden" name="terapi_check" id="terapi_check">
	<table id="tb_terapi" style="width:100%;" toolbar="#toolbar_terapi" idField="rawat_item_id" rownumbers="true" fitColumns="true" singleSelect="true" >
		<thead>
			<tr>
...
<!-- tab 7 -->
<div title="Perawatan Terapi Racikan" style="padding:5px">
	<table id="tb_terapi_racikan" style="width:100%;" toolbar="#toolbar_terapi_racikan" idField="rawat_terapi_racikan_id" rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
...
<!-- tab 10 -->
<div title="Set Pelaksana" style="padding:5px">
	<table id="dg_pelaksana"  style="width:100%;" toolbar="#t_pelaksana" idField="fol_id" data-options="pagination:false, rownumbers:true, fitColumns:true, singleSelect:true">
			<thead>
				<tr>
...
<!-- tab 12 -->
<div title="Bahan Habis Pakai" style="padding:5px">
	<table id="tb_bhp"  style="width:100%;" toolbar="#toolbar_bhp" idField="fol_pemakaian_id" rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>
			...
			if (id) {
				if (status == 'E0') {
					...
					$.get('get_irj.php', {
						...
						if (result[0].cust_usr_foto != '') {
							var fotoPasien = '<?php echo $lokTakeFoto . "/"; ?>' + result[0].cust_usr_foto;
						} else {
							var fotoPasien = '<?php echo $lokTakeFoto . "/default.jpg"; ?>';
						}
						console.log(result[0].cust_usr_foto+ 'as');
						...
						document.getElementById("foto_pasien").src = fotoPasien;
...
function resetAll() {
	...
	document.getElementById("foto_pasien").src = "";
