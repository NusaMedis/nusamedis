      ...
      <div class="col-md-12">
        <div class="col-md-6">
          ...
          <div class="form-group">
            <div class="col-md-12">
              ...
              <div class="col-md-10">
                ...
                <div class="col-md-2">
                  <input type="text" class="form-control" name="janin_kembar_det" id="janin_kembara_det" style="display: none;" disabled>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-6">
                	<div class="col-md-2" style="padding: 0">
              		...
              		<div class="col-md-7" style="padding: 0">
                  		<input type="text" name="afi" id="afi" class="form-control">
              		</div>
          ...
          <div class="form-group">
            <div class="col-md-12">
              ...
              <div class="col-md-3">
                ...
                <div class="col-md-6">
                 <div class='input-group date col-md-12' id='datepicker8'>
          ...
          <div class="form-group">
            <div class="col-md-12">
              ...
              <div class="col-md-10" id="divJenkel">

                <div class="col-md-12" id="detJenkel">
          ...
          <div class="col-md-12">
            <table width="100%">
              <tr>
                <td><h4>USG Tambahan</h4></td>
              </tr>
              <tr>
                <td width="45%">
                  <textarea class="form-control" id="USGTambahan" name="USGTambahan"></textarea>
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="col-md-12">
            <table width="100%">
              <tr>
                <td><h4>Pemeriksaan Penunjang (Laboratorium, Radiologi)</h4></td>
              </tr>
              <tr>
                <td width="45%">
          ...
          <h2><b>V. PLANNING</b></h2>
           <h4><b>(Pemeriksaan Penunjang, Tindakan)</b></h4>
          <div class="col-md-8 col-sm-8 col-xs-12">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            <div class="col-md-12">
              <div class="col-md-4">
                <h2><b>IV. PLANNING (Pemeriksaan Penunjang, Tindakan)</b></h2>
              </div>
              <div class="col-md-6 col-sm-8 col-xs-12">
...
<script>
  ...
  $("input#janin_kembara").click(function(){
  ...
  $("input#janin_kembara_det").focusout(function(){
  	var jumlah = parseInt($(this).val());
  	jumlah = (jumlah == 0 || jumlah == null || Number.isInteger(jumlah) === false) ? 1 : jumlah;
  	var html = "";
  	var count = $("form#form_obgyn div#divJenkel div#detJenkel").length;
  	...
  	if(tambahan > 0){
  		...
  		$("form#form_obgyn div#divJenkel div#detJenkel").slice(tambahan).remove();
  	}
  ...
  $("input#diagnosa").click(function(){
    var check = $(this).is(":checked");
    if(check == true){

      document.getElementById('bisaMengulang').checked = true;
      
      document.getElementById('memahamiMateri').checked = true;
      document.getElementById('penjelasan_penyakit').checked = true;
      document.getElementById('pemeriksaan_penunjang').checked = true;
      document.getElementById('terapi_edukasi').checked = true;
      document.getElementById('prognosa').checked = true;
  ...
  $("input#diagnosa_g").click(function(){
    var check = $(this).is(":checked");
    if(check == true){

      document.getElementById('bisaMengulang_g').checked = true;
      
      document.getElementById('memahamiMateri_g').checked = true;
      document.getElementById('penjelasan_penyakit_g').checked = true;
      document.getElementById('pemeriksaan_penunjang_g').checked = true;
      document.getElementById('terapi_edukasi_g').checked = true;
      document.getElementById('prognosa_g').checked = true;
