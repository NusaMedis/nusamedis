...
if (isset($_GET['reg_id'])) {
  ...
  $g_analisa = $dataRawatObgynSekarang['g_analisa'];
  $p_analisa = $dataRawatObgynSekarang['p_analisa'];
  $a_analisa = $dataRawatObgynSekarang['a_analisa'];
  $ket_diagnosa_satu = $dataRawatObgynSekarang['ket_diagnosa_satu'];
  $ket_diagnosa_dua = $dataRawatObgynSekarang['ket_diagnosa_dua'];
  $ket_diagnosa_tiga = $dataRawatObgynSekarang['ket_diagnosa_tiga'];
  $ket_diagnosa_empat = $dataRawatObgynSekarang['ket_diagnosa_empat'];
  $ket_diagnosa_lima = $dataRawatObgynSekarang['ket_diagnosa_lima'];
