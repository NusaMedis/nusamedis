...
$sql = "select a.*, b.cust_usr_nama from klinik.klinik_registrasi a
left join global.global_customer_user b on a.id_cust_usr = b.cust_usr_id
where reg_id = '$_POST[regId]'";
...
$dbTable = "klinik.klinik_registrasi";
    ...
    $dbField[24] = "reg_no_sep";
    $dbField[25] = "reg_tipe_jkn";
    $dbField[26] = "reg_keterangan";
    ...
    $dbValue[20] = QuoteValue(DPE_CHAR,$_POST['usr_id']);
    ...
    $dbValue[24] = QuoteValue(DPE_CHAR,$dataPasien[0]['reg_no_sep']);
    $dbValue[25] = QuoteValue(DPE_CHAR,$dataPasien[0]['reg_tipe_jkn']);
    $dbValue[26] = QuoteValue(DPE_CHAR,$_POST['reg_keterangan']);
    ...
    if ($dataPoli[0]["poli_tipe"]=='G' || $dataPoli[0]["poli_tipe"]=='J') {
      // code...
      $regUtama=$regId;
      ...
      $dbValue[1] = QuoteValue(DPE_CHAR,strtoupper($dataPasien[0]["cust_usr_nama"]));
      $dbValue[2] = QuoteValue(DPE_CHAR,$dataPasien[0]['id_cust_usr']);
      $dbValue[3] = QuoteValue(DPE_CHAR,$dataPasien[0]['id_pembayaran']);
      ...
      where id_reg = ".QuoteValue(DPE_CHAR,$regUtama)." 
      ...
      if(!$dataPerawat){
        ...
        $dbTable = " klinik.klinik_perawatan";
         ...
         // require_once "insert_inacbg.php";
        ...
        // insert ke klinik.klinik_inacbg
         exit();        
       ?>