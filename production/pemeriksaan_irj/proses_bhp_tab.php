...
/* regist apotik */
  ...
  /* Insert apotek Detail */
      ...
      $dbField[13]  = "id_aturan_minum";
      $dbField[14]  = "id_aturan_pakai";
      $dbField[15]  = "item_nama";
      $dbField[16]  = "id_jam_aturan_pakai";
        ...
        if(!$ApJualDet['id_penjualan']){
          ...
          $dbValue[12] = QuoteValue(DPE_CHAR,$_POST["penjualan_detail_dosis_obat"]);
          $dbValue[13] = QuoteValue(DPE_CHAR,$_POST["id_aturan_minum"]);
          $dbValue[14] = QuoteValue(DPE_CHAR,$_POST["id_aturan_pakai"]);
          $dbValue[15] = QuoteValue(DPE_CHAR,$obat["item_nama"]);
