...
if($_GET["id_reg"] || $_GET["pembayaran_id"]) {
  ...
  $sql = "select a.*, b.*, c.*, d.*
      ...
      where id_pembayaran =".QuoteValue(DPE_CHAR,$_POST["id_pembayaran"])." order by kategori_kassa_id, a.id_biaya, fol_nama asc" ;
...
<body onload="window.print();window.close();">
  <center><span style="font-size: 14px;">RINGKASAN BIAYA PERAWATAN RAWAT DARURAT</span></center>
  <table id="table1"> 
    <tr>
  ...
  <table id="table2">
    <tr>
      ...
      <td width="10%" align="center" class="bord-top">JML</td>
