<?php
  ...
  # simpan klinik folio 
    ...
    $dbField[18] = "id_biaya_tarif";
    $dbField[19] = "tindakan_tanggal";
    $dbField[20] = "tindakan_waktu";
    ...
    $dbValue[18] = QuoteValue(DPE_CHAR,$_POST["biaya_tarif_id"]);
    $dbValue[19] = QuoteValue(DPE_CHAR,$_POST["tindakan_tanggal"]);
    $dbValue[20] = QuoteValue(DPE_CHAR,$_POST["tindakan_waktu"]);
  ...
  # simpan klinik perawatan tindakan  
    ...
    $dbField[11] = "rawat_tindakan_flag"; 
    $dbField[12] = "rawat_tindakan_gol_darah"; 
    ...
    $dbValue[11] = QuoteValue(DPE_CHAR,"I");
    $dbValue[12] = QuoteValue(DPE_CHAR,$_POST["gol_darah"]);
    ...
    /*# simpan di pelaksana
    for ( $n = 0 ; $n < 3 ; $n++ ) { #ulang 3 x dengan fol tipe berbeda
      ...
      $a = array(PELAKSANA_TIPE_DPJP,PELAKSANA_TIPE_PELAKSANA,PELAKSANA_TIPE_DOKTER_INSTRUKSI); #data tipe pelaksana
      $b = array($dpjp,$pel1,$dokter_ins); #data pelaksana
