<?php
     ...
     switch ($_GET['func']) {
          ...
          case 'update':
               ...
               $dbField[0] = 'rawat_diagnosa_id';
               $dbField[1] = 'rawat_diagnosa_tindakan_nama';
               $dbField[2] = 'id_diagnosa';
               $dbField[3] = 'rawat_diagnosa_kode';

               $dbValue[0] = QuoteValue(DPE_CHAR, $_POST['rawat_diagnosa_id']);   // PK
               $dbValue[1] = QuoteValue(DPE_CHAR, $diagnosa['diagnosa_nama']);
               $dbValue[2] = QuoteValue(DPE_CHAR, $_POST['diagnosa_id']);
               $dbValue[3] = QuoteValue(DPE_CHAR, trim($diagnosa['diagnosa_nomor']));
               ...
               $rs = [];
               if ($a) {
                   $rs['rawat_diagnosa_id'] = $_POST['rawat_diagnosa_id'];
                   $rs['diagnosa_id'] = $_POST['diagnosa_id'];
                   $rs['diagnosa_nomor'] = $diagnosa['diagnosa_nomor'];
                   $rs['diagnosa_nama'] = $diagnosa['diagnosa_nama'];
                   $rs['diagnosa_deskripsi'] = $diagnosa['diagnosa_deskripsi'];
          ...
          default:
               $sql = 'SELECT rawat_diagnosa_id, diagnosa_nomor, diagnosa_nama, diagnosa_id, diagnosa_short_desc as diagnosa_deskripsi from klinik.klinik_perawatan_diagnosa a';
