      ...
      //INSERT REG BARU
               ...
               /* if($_POST["btnSave"]) $statusPasien =$_POST["reg_status_pasien"];
                ...
                if ($_POST["dep_konf_loket_antrian_poli"]=='n') //apabila cetak antrian tidak per klinik
                   ...
                   $sql = "select max(reg_no_antrian) as nomore from klinik.klinik_registrasi 
                          where reg_tanggal = ".QuoteValue(DPE_DATE,date("Y-m-d"))." and id_poli = ".QuoteValue(DPE_CHAR,$_POST['apotik'])." 
                ...
                $dbValue[3] = QuoteValue(DPE_CHAR,$regLama["id_cust_usr"]);
                ...
                $dbValue[9] = QuoteValue(DPE_CHAR,$_POST['kosong']);
                ...
                $dbValue[25] = QuoteValue(DPE_CHAR,$regLama["id_pembayaran"]);
