              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				  ...
				  <!-- tab-->
					...
					<table id="dg" title="Pasien Terdaftar <?php echo $tglSekarang;?>" class="easyui-datagrid" class="col-md-12 col-sm-12 col-xs-12" style="width:100%;height:350px"
							toolbar="#toolbar"
							data-options=" url:'get_igd2.php', pagination:false,
							rownumbers:true, fitColumns:true, singleSelect:true,
		...
		function layani(){
			...
			if (row){
			  if(row.reg_status == 'G0'){
				...
				$.get('get_igd.php',{reg_id:row.reg_id},function(result){
          ...
          document.getElementById('id_jenis_pasien').value = result[0].reg_jenis_pasien;
					...
					//$('#tingkat_kegawatan').combobox().attr('required','true');
					//$('#tingkat_kegawatan').combobox('reload');
