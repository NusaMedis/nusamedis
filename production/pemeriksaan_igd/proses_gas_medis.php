<?php
	...
	# simpan klinik folio	
	  ...
	  $dbValue[17] = QuoteValue(DPE_CHAR,"GM");
	  $dbValue[18] = QuoteValue(DPE_CHAR,$_POST["biaya_tarif_id"]);
	  $dbValue[19] = QuoteValue(DPE_DATE,date_db($_POST["tindakan_tanggal"]));
	  $dbValue[20] = QuoteValue(DPE_DATE,$_POST["tindakan_waktu"]);
	...
	# simpan klinik perawatan tindakan  
	  ...
	  $dbValue[9] = QuoteValue(DPE_CHAR,"I");
