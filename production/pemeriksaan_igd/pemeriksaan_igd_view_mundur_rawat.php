...
">Waktu Akhir Pemakaian</th>
						...
						<div class="clearfix"><br></div>
						<table id="dg" title="Pasien Terdaftar <?php echo $tglKemarin . " s/d " . $tglSekarang; ?>" class="easyui-datagrid" class="col-md-12 col-sm-12 col-xs-12" style="width:100%;height:350px" toolbar="#toolbar" data-options=" url:'get_igd_rawat.php', pagination:false,
