<?php
	...
	if($_GET["kab"]) $_POST["lokasi_kabupatenkota"] = $_GET["kab"];
      ...
      $thisPage = "kecamatan_edit.php?klinik=".$_POST["klinik"];
      $editPage = "kecamatan_edit.php";
      $viewpage = "kabupaten_detail.php?id=".$_GET["id"]."&prop=".$_GET["prop"]."&kab=".$_GET["kab"];
     ...
     if ($_GET["id"]) {     	
          ...
          $sql = "select * from global.global_lokasi where lokasi_id = ".QuoteValue(DPE_CHAR,$kecId);
     ...
     if ($_POST["btnUpdate"]) { 
              ...
              $dataKabupatenBack = $dtaccess->Fetch($rs);               
               ...
               $dbValue[0] = QuoteValue(DPE_NUMERIC,$kecId);
               ...
               //print_r($dbValue); die();
                ...
                $backpage = "kabupaten_detail.php?id=".$enc->Encode($dataKabupatenBack["lokasi_id"])."&prop=".$propId."&kab=".$kabId;
					...
					<form id="demo-form2" method="POST" class="form-horizontal form-label-left" action="<?php echo $_SERVER["PHP_SELF"]?>">
                     ...
                     <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      	<input  type="text" class="form-control" name="lokasi_nama" id="lokasi_nama" size="30" maxlength="50" value="<?php echo $_POST["lokasi_nama"];?>" onKeyDown="return tabOnEnter(this, event);"/>
						</div>
