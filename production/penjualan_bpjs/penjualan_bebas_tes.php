<?php
  ...
  {  //Jika ditekan Tombol Lanjut atau keyboard F2s
    ...
    $sql = "select a.cust_usr_kode, b.*,f.*, c.reg_jenis_pasien , c.reg_status , c.reg_tanggal, c.reg_id, c.id_poli, d.rawat_terapi, c.id_dokter, g.jenis_nama, h.jkn_nama, i.perusahaan_nama,  
            c.id_pembayaran from apotik.apotik_penjualan b
            left join global.global_customer_user a on b.id_cust_usr = a.cust_usr_id
  ...
  //JIKA MELAKUKAN PEMESANAN OBAT 
     ...
     $sql = "select a.*,b.item_nama,b.item_kode,b.item_racikan,c.jenis_nama,d.petunjuk_nama, f.batch_no, f.batch_tgl_jatuh_tempo, g.aturan_minum_nama, h.aturan_pakai_nama
...
function CekDataTambah()
{
    ...
    <!-- /top navigation -->
        ...
        <div class="right_col" role="main">
          ...
          <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
            <input type="text" id="penjualan_alamat" name="penjualan_alamat" value="<?php echo $_POST["penjualan_alamat"];?>" required="required" class="form-control col-md-7 col-xs-12">                                                     
            </div>
                      </div>
                      <div class="form-group">
 ...
 <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <td align="left" width="3%">Jumlah</td>
              ...
              <?php for($i=0,$n=count($dataTable);$i<$n;$i++) {  $grandtotal += $dataTable[$i]["penjualan_detail_total"]; 
                    if($dataTable[$i]["penjualan_detail_nama_racikan"] || $dataTable[$i]["id_jenis_racikan"]) 
                     ...
                     // echo $sql;
                      $editRacikan = "racikan_new_bebas.php?q=".$batchId."&item=".$dataTable[$i]["id_item"]."&kode=".$enc->Encode($_POST["cust_usr_kode"])."&transaksi=".$enc->Encode($penjualanId)."&id_reg=".$enc->Encode($_POST["id_reg"])."&id_pembayaran=".$_POST["id_pembayaran"]."&jenis_id=".$_POST['reg_jenis_pasien'];
            ...
            <?php echo $view->RenderComboBox("id_aturan_pakai","id_aturan_pakai",$opt_pakai,"inputfield",null); ?>
                      ...
                      <td align="left" width="2%" colspan="6"><?php echo currency_format($grandtotal);?></td>
                      </tr>
                      ...
                      <td align="left" width="2%" colspan="6">
