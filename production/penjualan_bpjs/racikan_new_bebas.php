...
if($_POST["id_petunjuk"]){
          ...
          $dbField[12]  = "penjualan_detail_dosis_obat";
          ...
          $dbValue[12] = QuoteValue(DPE_CHAR,$_POST["id_petunjuk"]);
          $dbValue[13] = QuoteValue(DPE_CHAR,$_POST["id_aturan_pakai"]);
  ...
  $sql = "update apotik.apotik_nama_racikan set nama_racikan_nama = ".QuoteValue(DPE_CHAR,$_POST['racikan_nama'])." where nama_racikan_id = ".QuoteValue(DPE_CHAR,$_POST['id_racikan']);
  $rs = $dtaccess->Execute($sql);

  $sql = "update logistik.logistik_item set item_nama = ".QuoteValue(DPE_CHAR,$_POST['racikan_nama'])." where item_id = ".QuoteValue(DPE_CHAR,$_POST['id_racikan']);
  $rs = $dtaccess->Execute($sql);
  //echo $sql; die();            
...
$addDetailPage = "racikan_pilih.php?q=".$batchId."&item=".$itemId."&kode=".$enc->Encode($kode)."&transaksi=".$enc->Encode($penjualanId)."&idreg=".$enc->Encode($idReg)."&id_pembayaran=".$pembayaranId."&id_penjualan_detail=".$_POST["id_penjualan_detail"];
header('location:'.$addDetailPage);
}
