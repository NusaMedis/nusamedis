...
//	   $poli = $auth->GetPoli();
   ...
   if(!$auth->IsAllowed("man_ganti_password",PRIV_CREATE)){
     ...
     $sql = "select a.*, b.cust_usr_kode, c.jenis_nama from apotik.apotik_penjualan a
             ...
             where a.is_terima='n' and cust_usr_id = '100' and penjualan_flag<>'R' 
        ...
        /*  if($isAllowedDel) {
          ...
          if($dataTable[$i]["penjualan_terbayar"]=='n'){
           if($dataTable[$i]["penjualan_flag"]=='L'){
              $sellPage = "penjualan_bebas_tes.php?";
                ...
                <div class="x_panel">
				  ...
				  <form  name="frmFind" action="<?php echo $_SERVER["PHP_SELF"]?>" method="POST" >
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						...
						<input type="button" name="btnTambah" value="Tambah Penjualan Bebas" class="pull-right col-md-12 col-sm-12 col-xs-12 btn btn-primary" onClick="document.location.href='penjualan_bebas_tes.php'" />
					</div>
					<div class="col-md-4 col-sm-6 col-xs-12">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12">&nbsp;</label>
