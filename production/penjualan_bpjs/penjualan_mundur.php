...
where reg_id =" . QuoteValue(DPE_CHAR, $_POST["id_reg"]) . " order by c.reg_tanggal desc,c.reg_waktu desc";
  ...
  $sql = "SELECT rawat_terapi from klinik.klinik_perawatan where id_reg = ".QuoteValue(DPE_CHAR, $dataPasien["reg_utama"]);
...
// VIEW PENJUALAN OBAT
$tableHeader = "Penjualan Obat Pasien Jaminan";
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Penjualan Obat Pasien Jaminan</h2>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <?php if ($_x_mode == 'New') { ?>
                    ...
                    <form name="frmFind" id="demo-form2" method="POST" class="form-horizontal form-label-left" action="<?php echo $_SERVER["PHP_SELF"] ?>">
                      ...
                      ?>
                        ...
                        <div class="control-label col-md-6 col-sm-6 col-xs-12">
                          ...
                          <!--           <div class="form-group">
            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Poli <span class="required">*</span>
          </label>
          <div class="col-md-4 col-sm-4 col-xs-12">
            <select class="form-control" name="poli" id="poli">
              ...
              <?php } ?>
                        ...
                        <div class="control-label col-md-6 col-sm-6 col-xs-12">
                         ...
                         <?php if($catatanResep['rawat_terapi']){ ?>
                        <div class="control-label col-md-6 col-sm-6 col-xs-12">
                          <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <td align="left" width="11%">Exp. Date</td> -->
                          ...
                          <?php for ($i = 0, $n = count($dataTable); $i < $n; $i++) {
                            ...
                            $grandtotal += $dataTable[$i]["penjualan_detail_harga_pokok"] + $dataTable[$i]['penjualan_detail_ppn'] + $dataTable[$i]['penjualan_detail_tuslag'];
