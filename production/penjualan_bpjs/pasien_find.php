...
function GetData($in_nama,$in_kode,$in_tipe){
 ...
 if ($in_tipe=="J" )
  ...
  $sql_where[] = "date(b.reg_tanggal) >= '$tglKemarin'";
  ...
  $sql_where[] = "(b.reg_status = 'I2' or reg_status = 'I3')";
	...
	$sql = "select a.cust_usr_id, b.reg_id,a.cust_usr_nama, a.cust_usr_kode , a.cust_usr_alamat, c.jenis_nama, b.id_pembayaran, d.poli_nama ,
          ...
          where b.reg_jenis_pasien <> '2' and reg_status != 'I9' 
          and b.id_pembayaran not in (select b.id_pembayaran from klinik.klinik_pembayaran_det x where b.id_pembayaran = x.id_pembayaran) ";                   //DIPATEN PASIEN BPJS
        //$sql .= " b.reg_status = 'E0' ";		 
