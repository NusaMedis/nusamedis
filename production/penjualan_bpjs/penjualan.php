...
// SECURITY CHECKER
$sql = "select penjualan_terbayar, id_fol, id_resep, tipe_resep, tipe_resep from apotik.apotik_penjualan where penjualan_id = ".QuoteValue(DPE_CHAR,$penjualanId);
...
if ($_x_mode == "Edit"  || $_POST["tombol_f2"]) {  //Jika ditekan Tombol Lanjut atau keyboard F2s
  ...
  $sql = "SELECT rawat_terapi, rawat_anak, rawat_neo from klinik.klinik_perawatan where rawat_id = ".QuoteValue(DPE_CHAR, $dataPenjualan["id_resep"]);
  ...
  $asmedAnak = ($catatanResep['rawat_neo']) ? unserialize($catatanResep['rawat_neo']) : [] ;
...
$sql = "select a.*,b.item_nama,b.item_kode,b.item_racikan,c.jenis_nama,d.petunjuk_nama, f.batch_no, f.batch_tgl_jatuh_tempo, g.aturan_minum_nama, h.aturan_pakai_nama, i.jam_aturan_pakai_nama, a.penjualan_detail_create, j.id_gudang, j.penjualan_grandtotal, b.item_id, j.id_pembayaran
  ...
  <? } ?>
                    ...
                    <form name="frmFind" id="demo-form2" method="POST" class="form-horizontal form-label-left" action="<?php echo $_SERVER["PHP_SELF"] ?>">
                      <?php if ($_x_mode == 'Edit') { //JIKA MEMASUKKAN OBAT
                        ...
                        <!-- <button type="button" id="btnBayar" onclick="javascript:return CekData();">Simpan Penjualan</button> -->
                        ...
                        <td align="left" width="2%">
                            ...
                            // untuk mengambil id_racikan buat dilempar ke cetak etiket
                              ...
                              <td align="left"><?php echo $dataTable[$i]["penjualan_detail_ket"]; ?></td>
                              </tr>
