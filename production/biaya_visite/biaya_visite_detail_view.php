<?php
     ...
     $addPage = "biaya_visite_detail_add.php?biaya_id=".$_POST["biaya_id"]."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"]."&tambah=1";
     $kembaliPage = "biaya_visite_view.php?id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"];
     $editPage = "biaya_visite_detail_edit.php?biaya_id=".$_POST["biaya_id"]."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"];
     $cetakPage = "cetak.php?biaya_id=".$_POST["biaya_id"]."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"];
     ...
     $tombolCetak = '<input type="button" name="btnCetak" value="Cetak" class="pull-right col-md-12 col-sm-12 col-xs-12 btn btn-primary" onClick="document.location.href=\''.$cetakPage.'\'"></button>';
...
//              left join gl.gl_perkiraan f on f.id_prk = a.id_prk_beban
      ...
      $detailPage = "tindakan_split_detail_view.php?biaya_id=".$_GET["biaya_id"];
...
//	          $counter++;   
	  ...
	  //        $counter++;
       ...
       // } else {
        ...
        if($isAllowedUpdate)
        {
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$detailPage.'&biaya_tarif_id='.$dataTable[$i]["biaya_tarif_id"].'"><img hspace="2" width="25" height="25" src="'.$ROOT.'gambar/icon/cari.png" alt="Edit" title="Edit" border="0"></a>';
        } else {
               $tbContent[$i][$counter][TABLE_ISI] = '&nbsp;';                
        }
               $tbContent[$i][$counter][TABLE_ALIGN] = "center";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><?= $tableHeader.' - '. $dataTable[0]['biaya_nama'];?></h3>
              </div>
            </div>
