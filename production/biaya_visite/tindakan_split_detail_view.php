<?php
	...
	$backPage = "tindakan_detail_view.php"; 
    ...
    $sql = "select h.klinik_kategori_tindakan_header_instalasi_id,g.kategori_tindakan_header_id,
     ...
     $addPage = "tindakan_split_detail_edit.php?biaya_tarif_id=".$biayaTarifId."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"]."&tambah=1";
     $kembaliPage = "tindakan_detail_view.php?id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"]."&biaya_id=".$varBack;
     $editPage = "tindakan_split_detail_edit.php?biaya_tarif_id=".$biayaTarifId."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"];
     $thisPage = "tindakan_split_detail_view.php";
     $detailPage = "tindakan_split_detail_remun_view.php?biaya_tarif_id=".$biayaTarifId."&biaya_id=".$_GET['biaya_id'];
     ...
     $tombolKembali = '<input type="button" name="btnKembali" value="Kembali" class="pull-right col-md-12 col-sm-12 col-xs-12 btn btn-primary" onClick="document.location.href=\''.$kembaliPage.'\'"></button>';
	   ...
	   $sql_where[] = "1=1"; 
     if($biayaTarifId && $biayaTarifId!="--") $sql_where[] = "h.biaya_tarif_id = ".QuoteValue(DPE_CHAR,$biayaTarifId);    
     $sql_where = implode(" and ",$sql_where);

    
   	  $sql = "select b.split_id,b.split_nama,j.bea_split_nominal,j.bea_split_id
              from  
              klinik.klinik_biaya_split j 
   ...
   // echo $sql ; die();
	 ...
	 $counterHeader = 0;
     $tableHeader = "Manajemen - Biaya Split Tarif Tindakan";
     ...
     $tbHeader[0][$counterHeader][TABLE_ISI] = "Split Nama";
     $tbHeader[0][$counterHeader][TABLE_WIDTH] = "5%";
     $counterHeader++;
     ...
     $tbHeader[0][$counterHeader][TABLE_ISI] = "Posisi";
     $tbHeader[0][$counterHeader][TABLE_WIDTH] = "5%";
     $counterHeader++; 
     ...
     for($i=0,$counter=0,$n=count($dataTable);$i<$n;$i++,$counter=0){
      ...
      $tbContent[$i][$counter][TABLE_ISI] = currency_format($dataTable[$i]["bea_split_nominal"]);
      $tbContent[$i][$counter][TABLE_ALIGN] = "left";
      $counter++;
...
//	          $counter++;   
	  ...
	  //        $counter++;
       ...
       // } else {
        ...
        if($isAllowedUpdate)
        {
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$detailPage.'&split_id='.$dataTable[$i]["split_id"]."&biaya_id=".$_GET['biaya_id'].'"><img hspace="2" width="25" height="25" src="'.$ROOT.'gambar/icon/cari.png" alt="Edit" title="Edit" border="0"></a>';
        } else {
               $tbContent[$i][$counter][TABLE_ISI] = '&nbsp;';                
        }
               $tbContent[$i][$counter][TABLE_ALIGN] = "center";
        ...
        if($isAllowedUpdate)
        {
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'&id='.$enc->Encode($dataTable[$i]["bea_split_id"]).'"><img hspace="2" width="25" height="25" src="'.$ROOT.'gambar/icon/edit.png" alt="Edit" title="Edit" border="0"></a>';
        } else {
               $tbContent[$i][$counter][TABLE_ISI] = '&nbsp;';                
        }
               $tbContent[$i][$counter][TABLE_ALIGN] = "center";
          ...
          if($isAllowedDel){
               $tbContent[$i][$counter][TABLE_ISI] = '<a href="'.$editPage.'&id_del='.$dataTable[$i]["bea_split_id"].'&del=1"><img hspace="2" width="25" height="25" src="'.$ROOT.'gambar/icon/hapus.png" alt="Hapus" title="Hapus" border="0" onclick="javascript: return Hapus();"></a>';
               $tbContent[$i][$counter][TABLE_ALIGN] = "center";
               $counter++;
          }			    
    }
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <form action="<?php echo $_SERVER["PHP_SELF"]?>" method="POST" >          
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-4">
                        <label class="control-label col-md-4 col-sm-4 col-xs-4">Total Split : </label>
                        <label class="control-label col-md-4 col-sm-4 col-xs-4"><?php echo currency_format($dataSplitNominal["jumlah"]);?></label>
				      </div>
...
href="tindakan_split_detail_view.php?
biaya_id=991f008671762fc719998f380f13ce74&biaya_tarif_id=25dcde04ba98b02b93da086c24cbb6c5"