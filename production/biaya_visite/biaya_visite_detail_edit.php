<?php
  ...
  $backPage = "biaya_visite_detail_view.php?biaya_id=".$_POST["biaya_id"]."&id_kategori_tindakan_header_instalasi=".$_POST["id_kategori_tindakan_header_instalasi"]."&id_kategori_tindakan_header=".$_POST["id_kategori_tindakan_header"]."&biaya_kategori=".$_POST["biaya_kategori"];
     ...
     if($_GET["id"] || $_GET["id_dep"]) 
     {
      ...
      if ($_POST["btnDelete"]) { 
          ...
          $_POST['id_jenis_pasien'] = $row_edit['id_jenis_pasien'];
  ...
  elseif($_x_mode=="Edit") $privMode = PRIV_UPDATE;
     ...
     { 
               ...
               $dbValue[8] = QuoteValue(DPE_NUMERIC,$_POST["id_jenis_pasien"]);
...
//       var_dump($dataDbLog);
  ...
  if ($_GET["del"]) 
  {
   ...
   // Data Kategori Tindakan Header Instalasi//
     ...
     $tableHeader = "Manajemen - Tambah Biaya Visite";
          ...
          <form id="demo-form2" method="POST" class="form-horizontal form-label-left" action="<?php echo $_SERVER["PHP_SELF"]?>">         
            <div class="form-group">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <select required name="id_kelas" id="id_kelas" class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <select required name="id_jenis_kelas" id="id_jenis_kelas" class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);">
            ...
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Jenis Pasien <span class="required">*</span></label>
              <div class="col-md-4 col-sm-4 col-xs-12">
                <select required name="id_jenis_pasien"  class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);">
                <option class="inputField" value="" >- Pilih Jenis Pasien -</option>
                <?php for($i=0,$n=count($dataJenis);$i<$n;$i++){ ?>
                <option class="inputField" value="<?php echo $dataJenis[$i]["jenis_id"];?>"
                <?php if ($_POST["id_jenis_pasien"]==$dataJenis[$i]["jenis_id"])
                 echo"selected"?>><?php echo $dataJenis[$i]["jenis_nama"];?>&nbsp;</option>
                <?php } ?>
              </select>
             </div>
            </div>
             ...
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tgl Awal Tarif Tindakan  <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
               <div class='input-group date' id='datepicker'>
                 <input required  name="biaya_tarif_tgl_awal" id="biaya_tarif_tgl_awal"  type='text' data-inputmask="'mask': '99-99-9999'" class="form-control" value="<?=$_POST['biaya_tarif_tgl_awal']?>">
             ...
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tgl Akhir Tarif Tindakan  <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class='input-group date' id='datepicker2'>
                  <input required  name="biaya_tarif_tgl_akhir"id="biaya_tarif_tgl_akhir" data-inputmask="'mask': '99-99-9999'" type='text' class="form-control" value="<?=$_POST['biaya_tarif_tgl_akhir']?>">
                  <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                </div>
            </div>
            </div>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Jasa Pelayanan  <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <?php echo $view->RenderTextBox("biaya_split_jaspel","biaya_split_jaspel","85","100",currency_format($_POST["biaya_split_jaspel"]),"inputField", "",false);?>
            ...
            <div class="form-group">
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Jasa Sarana  <span class="required">*</span>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <?php echo $view->RenderTextBox("biaya_split_sarana","biaya_split_sarana","85","100",currency_format($_POST["biaya_split_sarana"]),"inputField", "",false);?>
                  <font color="red">Otomatis berubah jika biaya total berubah setelah klik simpan</font>
            </div>
            </div>
            <!--
