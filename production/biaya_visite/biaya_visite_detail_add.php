<?php
  ...
  $backPage = "biaya_visite_detail_view.php?biaya_id=".$_POST["biaya_id"];
            ...
            <div class="form-group">
             ...
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tgl Awal Tarif Tindakan  <span class="required">*</span>
              ...
              <div class='input-group date' id='datepicker'>
                 <input required  name="biaya_tarif_tgl_awal"  type='text' class="form-control"  data-inputmask="'mask': '99-99-9999'" value="<?=$_POST['biaya_tarif_tgl_awal']?>">
            ...
            <div class="form-group">
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tgl Akhir Tarif Tindakan  <span class="required">*</span>
              ...
              <div class='input-group date' id='datepicker2'>
                 <input required  name="biaya_tarif_tgl_akhir"  type='text' class="form-control"   data-inputmask="'mask': '99-99-9999'" value="<?=$_POST['biaya_tarif_tgl_akhir']?>">
                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                </div>
						</div>
					  </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
               <select name="is_cito" class="select2_single form-control" onKeyDown="return tabOnEnter_select_with_button(this, event);" >
				   ...
				   <div class="form-group">
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tarif Tindakan                
             </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
