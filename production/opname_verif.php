<?php
  ...
  if($_POST['item']){
    ...
    $sql = "SELECT a.*, d.*, c.opname_tanggal, c.opname_waktu, c.opname_id, c.id_periode, c.id_gudang from logistik.logistik_opname_detail a 
  ...
  if($_POST["btnLanjut"] || $_POST["btnExcel"] || $_POST["id_periode"])   {
     ...
     $sql .= " where a.is_verified = 'n' and ".$sql_where;
...
<div class="x_panel">
  <div class="x_content">
      ...
      <?php if(count($dataTable) > 0 && ($userData["rol"] == '1' || $userData["rol"] == '35')) { ?>
