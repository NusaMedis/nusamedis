 ...
 */
 ...
 if (!defined('_ADODB_LAYER')) {
	...
	*/
		...
		// logistik.php's version scheme makes converting to numbers difficult - workaround
		$_adodb_ver = (float) logistik.php_VERSION;
		if ($_adodb_ver >= 5.0) {
	...
	*/
	...
	var $readOnly = false; 			/// this is a readonly database - used by logistik.phpLens
	...
	*/
	...
	Usage in oracle
		...
		@param $var logistik.php variable to bind to
	...
	* @return		the recordset ($rs->databaseType == 'array')
	*
	* NOTE: logistik.phpLens uses a different algorithm and does not use PageExecute().
	*
	*/
	...
	global $ADODB_EXTENSION;
		...
		if (!$first2cols && ($cols > 2 || $force_array)) {
			...
			if ($ADODB_EXTENSION) {
				...
				if ($numIndex) {
					while (!$this->EOF) {
					// some bug in mssql logistik.php 4.02 -- doesn't handle references properly so we FORCE creating a new string
   ...
   */
	...
	*/
	...
	static $typeMap = array(
		...
		'BIGINT' => 'N', // this is bigger than logistik.php 32-bit integers
		'DECIMAL' => 'N',
		'DEC' => 'N',
		'REAL' => 'N',
		'DOUBLE' => 'N',
