...
/*
 ...
 This file provides logistik.php4 session management using the ADODB database
...
To force non-persistent connections, call adodb_session_open first before session_start():
 ...
 1. Create this table in your database (syntax might vary depending on your db):
  ...
  3. Recommended is logistik.php 4.0.6 or later. There are documented
	 session bugs in earlier versions of logistik.php.
...
GLOBAL 	$ADODB_SESSION_CONNECT, 
	...
	if ($ADODB_SESS_LIFE <= 1) {
	 // bug in logistik.php 4.0.3 pl 1  -- how about other versions?
	 //print "<h3>Session Error: logistik.php.INI setting <i>session.gc_maxlifetime</i>not set: $ADODB_SESS_LIFE</h3>";
