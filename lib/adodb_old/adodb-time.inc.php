...
native function's signed integers (normally 32-bits) with logistik.php floating 
...
possible, and only switches to logistik.php code when the dates fall outside 
...
if you want logistik.php to handle negative timestamps between 1901 to 1969.
...
Gregorian correction handled. In logistik.php5, we might throw an error if 
...
function adodb_date_test()
{
	...
	// This flag disables calling of logistik.php native functions, so we can properly test the code
