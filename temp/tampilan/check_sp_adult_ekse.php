<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../poli_sp_adult_ekse/menu_sp_adult_ekse.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==62){
     ...
     elseif(!$login)
       {
         header("Location:../sub_adult_ekse.php?ref=46&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
