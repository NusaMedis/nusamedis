<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../rehab_hidroterapi_ekse/menu_hidroterapi.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==82){
     ...
     elseif(!$login)
       {
         header("Location:../login.php?ref=52&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
