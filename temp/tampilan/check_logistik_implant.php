<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../logistik_implant/menu_logistik_implant.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==85){
     ...
     elseif(!$login)
       {
         header("Location:../index.php?ref=85&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
