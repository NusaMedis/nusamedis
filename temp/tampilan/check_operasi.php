<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../operasi/menu_operasi.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==28){
         //echo 'login true';//"<script>top.location.href='menu_direksi.php'</script>";    
         echo header("Location:../menu_direksi.php");   
			exit();         
     ...
     elseif(!$login)
       {
         header("Location:../index.php?ref=9&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
        // header("Location:login.php?msg=kode_eror02&user=".$_POST["txtUser"]);
         ...
         //echo 'Login True';
         echo header("Location:../menu_operasi.php");
         exit();
       }
