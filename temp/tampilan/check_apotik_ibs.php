<?php
      ...
      $login = $auth->IsLoginOk($_POST["txtUser"],$_POST["txtPass"],4);
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../apotik_ibs/menu_apotik_ibs.php");
         exit();
     }
     ...
     elseif(!$login)
       {
         header("Location:../apotik_ibs.php?ref=5&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
