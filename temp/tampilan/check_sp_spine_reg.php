<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../poli_sp_spine_reg/menu_sp_spine_reg.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==35){
     ...
     elseif(!$login)
       {
         header("Location:../sub_spine_reg.php?ref=79&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
