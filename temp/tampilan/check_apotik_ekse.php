<?php
      ...
      $login = $auth->IsLoginOk($_POST["txtUser"],$_POST["txtPass"],3);
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../apotik_ekse/menu_apotik_ekse.php");
         exit();
     }
     ...
     elseif(!$login)
       {
         header("Location:../apotik_ekse.php?ref=21&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
