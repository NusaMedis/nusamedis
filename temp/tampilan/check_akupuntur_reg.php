<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../poli_akupuntur_reg/menu_akupuntur_reg.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==39){
     ...
     elseif(!$login)
       {
         header("Location:../akupuntur_reg.php?ref=41&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
