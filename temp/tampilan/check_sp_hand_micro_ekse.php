<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../poli_sp_hand_micro_ekse/menu_sp_hand_micro_ekse.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==68){
     ...
     elseif(!$login)
       {
         header("Location:../sub_hand_micro_ekse.php?ref=88&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
