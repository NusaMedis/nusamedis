<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../logistik_farmasi/menu_logistik_farmasi.php");
         exit();
     }
     ...
     if($login && $dataTable) {
        ...
        if($_POST["cmbSystem"]==1){
         ...
         echo header("Location:../menu_logistik_farmasi.php");   
			exit();         
     ...
     elseif(!$login)
       {
         header("Location:../login.php?&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
