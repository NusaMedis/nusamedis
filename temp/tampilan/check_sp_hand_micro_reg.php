<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../poli_sp_hand_micro_reg/menu_sp_hand_micro_reg.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==67){
     ...
     elseif(!$login)
       {
         header("Location:../sub_hand_micro_reg.php?ref=82&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
