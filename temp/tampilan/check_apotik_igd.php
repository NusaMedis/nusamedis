<?php
      ...
      $login = $auth->IsLoginOk($_POST["txtUser"],$_POST["txtPass"],8);
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../apotik_igd/menu_apotik.php");
         exit();
     }
     ...
     elseif(!$login)
       {
         header("Location:../apotik_igd.php?ref=21&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
