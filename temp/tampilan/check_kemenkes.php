<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../kemenkes/menu_kemenkes.php");
         exit();
     }
     ...
     if($login && $dataTable) {
        ...
        if($_POST["cmbSystem"]==1){
         //echo 'login true';//"<script>top.location.href='menu_kemenkes.php'</script>";    
         echo header("Location:../menu_kemenkes.php");   
			exit();         
