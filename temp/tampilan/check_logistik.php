<?php
      ...
      $login = $auth->IsLoginOk($_POST["txtUser"],$_POST["txtPass"],1);
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../logistik/menu_logistik.php");
         exit();
     }
     ...
     elseif(!$login)
       {
         header("Location:../index.php?ref=16&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
        // header("Location:login.php?msg=kode_eror02&user=".$_POST["txtUser"]);
         ...
         //echo 'Login True';
         echo header("Location:../antrian/menu_logistik.php");
         exit();
       }
