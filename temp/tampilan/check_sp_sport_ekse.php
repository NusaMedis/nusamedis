<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../poli_sp_sport_ekse/menu_sp_sport_ekse.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==70){
     ...
     elseif(!$login)
       {
         header("Location:../sub_sp_sport_ekse.php?ref=89&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
