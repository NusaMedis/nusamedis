<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../logistik_umum/menu_logistik_umum.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==24){
     ...
     elseif(!$login)
       {
         header("Location:../index.php?ref=24&msg=kode_eror01&user=".$_POST["txtUser"]."&poli=".$_POST["txtPoli"]);
       } 
     elseif(!$dataTable)
       {
