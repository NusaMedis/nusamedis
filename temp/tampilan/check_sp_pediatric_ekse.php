<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../poli_sp_pediatric_ekse/menu_sp_pediatric_ekse.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==64){
     ...
     elseif(!$login)
       {
         header("Location:../sub_pediatric_ekse.php?ref=86&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
