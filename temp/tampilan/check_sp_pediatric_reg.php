<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../poli_sp_pediatric_reg/menu_sp_pediatric_reg.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==63){
     ...
     elseif(!$login)
       {
         header("Location:../sub_pediatric_reg.php?ref=80&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
