<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../rawat_jalan/menu_rawat_jalan.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==2){
     ...
     elseif(!$login)
       {
         ...
         header("Location:../index.php?ref=2&msg=kode_eror01&user=".$_POST["txtUser"]."&poli=".$_POST["txtPoli"]);
       } 
     elseif(!$dataTable)
       {
