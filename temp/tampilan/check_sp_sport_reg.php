<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../poli_sp_sport_reg/menu_sp_sport_reg.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==69){
     ...
     elseif(!$login)
       {
         header("Location:../sub_sp_sport_reg.php?ref=83&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
