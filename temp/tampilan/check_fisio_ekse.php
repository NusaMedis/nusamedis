<?php
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../rehab_medik/menu_rehab.php");
         exit();
     }
     
     if($login && $dataTable) {

        if($_POST["cmbSystem"]==54){
     ...
     elseif(!$login)
       {
         header("Location:../rehab_medik.php?ref=71&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
        // header("Location:login.php?msg=kode_eror02&user=".$_POST["txtUser"]);
         ...
         //echo 'Login True';
         echo header("Location:../rehab_medik/menu_rehab.php.php");
         exit();
       }
