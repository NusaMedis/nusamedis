<?php
      ...
      $sql = "select id_gudang from global.global_auth_poli where poli_id=".QuoteValue(DPE_CHAR,$_POST["txtPoli"]);
      $rs = $dtaccess->Execute($sql);
      $gudang = $dtaccess->Fetch($rs);
      
      $login = $auth->IsLoginOk($_POST["txtUser"],$_POST["txtPass"],$_POST["txtPoli"],$gudang["id_gudang"]);
     ...
     if($login && !$dataTable)
     {
      ...
      //echo 'Login True';
      echo header("Location:../apotik/menu_apotik.php");
         exit();
     }
     ...
     elseif(!$login)
       {
         header("Location:../index.php?ref=93&msg=kode_eror01&user=".$_POST["txtUser"]);
       } 
     elseif(!$dataTable)
       {
        // header("Location:login.php?msg=kode_eror02&user=".$_POST["txtUser"]);
         ...
         //echo 'Login True';
         echo header("Location:../antrian/menu_apotik.php");
         exit();
       }
